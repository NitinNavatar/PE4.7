...
public class PartnershipsPageBusinessLayer extends PartnershipsPage {
	...
	public boolean clickOnCreatedPartnership(String projectName,String partnershipLegalName){
		if(CommonVariables.mode.equalsIgnoreCase(Mode.Classic.toString())){
		...
		if(clickOnAlreadyCreatedItem(projectName, TabName.Object6Tab, partnershipLegalName, 20)){
			appLog.info("Clicked on partnership name" + partnershipLegalName + "successfully.");
			return true;
		}else{
