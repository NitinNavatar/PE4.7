...
public class SetupPage extends BasePageBusinessLayer {
	...
	public WebElement getEditButtonOfProfileUser(String userProfile, int timeOut) {
		String xpath = "//div[@class='bRelatedList']//a[text()='"+userProfile+"']/ancestor::tr/td[@class='actionColumn']/a[text()='Edit']";
	...
	public WebElement getReadcheckbox(String objectName, int timeOut) {
		String xpath = "//th[@class=\"labelCol\" and text()='"+objectName+"']/..//td[@class='dataCol col02']//tr[@class='crudTableEdit']/td[1]/input";
	...
	public WebElement getCreatecheckbox(String objectName, int timeOut) {
		String xpath = "//th[@class=\"labelCol\" and text()='"+objectName+"']/..//td[@class='dataCol col02']//tr[@class='crudTableEdit']/td[2]/input";
	...
	public WebElement getEditcheckbox(String objectName, int timeOut) {
		String xpath = "//th[@class=\"labelCol\" and text()='"+objectName+"']/..//td[@class='dataCol col02']//tr[@class='crudTableEdit']/td[3]/input";
	...
	public WebElement getDeleteCheckbox(String objectName, int timeOut) {
		String xpath = "//th[@class=\"labelCol\" and text()='"+objectName+"']/..//td[@class='dataCol col02']//tr[@class='crudTableEdit']/td[4]/input";
