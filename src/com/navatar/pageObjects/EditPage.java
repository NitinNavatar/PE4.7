...
//	@FindBy(xpath="//span[text()='My Record filter']/preceding-sibling::span")
	...
	public WebElement tabNameElementInEditPage(String tabName, int timeOut) {
		...
		try {
			return FindElement(driver, "//span[text()=\"" + tabName + "\" and contains(@class,\"uiOutputText\")]/ancestor::a",
					"Tab Name: " + tabName, action.SCROLLANDBOOLEAN, timeOut);
		} catch (StaleElementReferenceException e) {
			return FindElement(driver, "//span[text()=\"" + tabName + "\" and contains(@class,\"uiOutputText\")]/ancestor::a",
					"Tab Name: " + tabName, action.SCROLLANDBOOLEAN, timeOut);
	...
	@FindBy(xpath = "(//span[text()='Details' and contains(@class,'uiOutputText')])[2]/ancestor::a")
	...
	@FindBy(xpath = "//span[text()='Changes saved.']/ancestor::div[@class='notification showMessage']")
