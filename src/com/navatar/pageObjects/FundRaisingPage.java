...
public class FundRaisingPage extends BasePage {
	...
	public WebElement getTestCheckboxFCheckbox(String TestCheckboxFCheckboxFieldLabel,int timeOut){
		WebElement ele =null;
		ele=isDisplayed(driver, FindElement(driver, "//label[text()='"+TestCheckboxFCheckboxFieldLabel+"']/../..//input", "Test Checkbox F field label", action.SCROLLANDBOOLEAN, timeOut), "Visibility", timeOut, "Test Checkbox F  Field Label");
		return ele;
	}
	...
	public WebElement getTestEmailTextbox(String TestEmailFieldLabel,int timeOut){
		WebElement ele =null;
		ele=isDisplayed(driver, FindElement(driver, "//label[text()='"+TestEmailFieldLabel+"']/../..//input", "Test Email Field Label", action.SCROLLANDBOOLEAN, timeOut), "Visibility", timeOut, "Test Email Field Label");
		return ele;
	}
	...
	public WebElement getInvestmenthighAmountTestBox(int timeOut) {
		return isDisplayed(driver, investmenthighAmountTestBox, "Visibility", timeOut, "Investment High Amount TextBox");
	}
	...
	public WebElement getPotentialManagementFeeTextBox(int timeOut ) {
		return isDisplayed(driver, potentialManagementFeeTextBox, "Visibility", timeOut, "Potential Managemnet Fee Text Box");
	}
	...
	public WebElement getTestTextArea(String TestTextAreaFieldLabel,int timeOut){
		WebElement ele =null;
		ele=isDisplayed(driver, FindElement(driver, "//label[text()='"+TestTextAreaFieldLabel+"']/../..//textarea", "Test Text Area Field Label", action.SCROLLANDBOOLEAN, timeOut), "Visibility", timeOut, "Test Text Area Field Label");
		return ele;
	}
