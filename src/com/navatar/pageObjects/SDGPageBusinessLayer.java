...
public class SDGPageBusinessLayer extends SDGPage implements SDGPageErrorMessage {
	...
	public boolean verifyEditOrLockedIconOnSDGData(String sdgName,String recordName,IconType icon)
	{
		...
		if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, recordName))
		{
			if(mouseOverOperation(driver, ele))
			{
				...
				if(icon.toString().equals("Edit"))
				{
					xPath="(//a[text()='"+sdgName+"']/ancestor::article//td[@data-label='"+recordName+": ']//span[text()='Edit']/preceding-sibling::lightning-primitive-icon)[1]";
					ele=CommonLib.FindElement(driver, xPath, "Edit icon on "+recordName, action.BOOLEAN, 50);
				...
				{
					xPath="(//a[text()='"+sdgName+"']/ancestor::article//td[@data-label='"+recordName+": ']//span[text()='Locked']/preceding-sibling::lightning-primitive-icon)[1]";
					ele=CommonLib.FindElement(driver, xPath, "Locked icon on "+recordName, action.BOOLEAN, 50);
	...
	public boolean CheckedOrUncheckedCheckox(String sdgGridName, Condition condition)
	{
		...
		if(condition.toString().equals("SelectCheckbox"))	
		{
			...
			{
				if (click(driver, getsdgGridCheckbox(sdgGridName, 50), sdgGridName+" checkbox Button", action.SCROLLANDBOOLEAN)) {
	...
	public int CheckedOrUncheckedCheckboxCountOnSDGGrid(String sdgGridName, Condition condition)
	{
		...
		if(condition.toString().equals("SelectCheckbox"))	
		{
			xPath="//a[text()='"+sdgGridName+"']/ancestor::article//lightning-input[@class='checkrow slds-form-element']//input[@type='checkbox']";
	...
	public boolean removeRecordAndVerifyErrorMessage(String sdgName,String recordName)
	{
		...
		if(mouseOverOperation(driver, ele))
		{
			...
			{
				log(LogStatus.INFO, "Mouse has been moved to "+recordName, YesNo.No);
				xPath="(//td[@data-label='"+recordName+": ']//span[text()='Edit']/preceding-sibling::lightning-primitive-icon/parent::button)[1]";
				...
				if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+recordName, action.BOOLEAN)) {
					...
					xPath="//a[text()='"+sdgName+"']//ancestor::article//td[@data-label='"+recordName+": ']//input";
					ele=FindElement(driver, xPath, "Edit icon on "+recordName, action.BOOLEAN, 50);
					if(sendKeys(driver, ele, "", recordName, action.BOOLEAN))
					{
						...
						if(CommonLib.doubleClickUsingAction(driver, ele)) {
							...
							if(click(driver, ele, "Clicked on the Save button", action.BOOLEAN)) {
								log(LogStatus.INFO,"Clicked on the save button",YesNo.Yes);	
								if(CommonLib.checkElementVisibility(driver, geterrorMessageAfterSaveBlankRecord(50), "Error Message", 50))
								{
									log(LogStatus.INFO,"\"1 record has error. Kindly resolve them and try again.\" Error Message is visible",YesNo.Yes);
									flag=true;
								}
								else
								{
									log(LogStatus.INFO,"\"1 record has error. Kindly resolve them and try again.\" Error Message is not visible",YesNo.Yes);
								}
							}
							else
							{
	...
	public boolean verifyErrorMessage(String sdgName,String recordName)
	{
		...
		if(mouseOverOperation(driver, ele))
		{
			...
			if(checkElementVisibility(driver, gettriangleErrorIcon(50), "Error Message", 50))
			{
				...
				String text=CommonLib.getText(driver, gettriangleErrorIcon(50), "Triangle  error message", action.BOOLEAN);
				...
				{
					log(LogStatus.ERROR, "Error message is not verified visible on the hover of trianlge icon", YesNo.Yes);
				}
					...
					if(sendKeys(driver, ele, value, recordName, action.BOOLEAN))
					{
						...
						if(CommonLib.doubleClickUsingAction(driver, ele)) {
							...
							if(click(driver, ele, "Save button", action.BOOLEAN)) {
								log(LogStatus.INFO,"Clicked on the save button",YesNo.Yes);	
								if(CommonLib.checkElementVisibility(driver, getUpdateMessageAfterSaveRecord(50), "Update Message", 50))
								{
									log(LogStatus.INFO,"\"Your changes are saved.\" Update Message is visible",YesNo.Yes);
									flag=true;
								}
								else
								{
									log(LogStatus.INFO,"\"Your changes are saved.\" Update Message is not visible",YesNo.Yes);
								}
							}
							else
							{
	...
	public boolean updateSDGRecordAndVerifySaveCancelButton(String sdgGridName,String firstSDGRowName,String recordName,String value,String inputType,ArrayList<String> multiPiclistValue)
	{
		...
		xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGRowName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']";
		ele=FindElement(driver, xPath, recordName+" Record Name", action.BOOLEAN, 50);
		if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
		{
			...
			{
				log(LogStatus.INFO, "Mouse has been moved to "+recordName, YesNo.No);		
				xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGRowName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']//button";
				...
				if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+recordName, action.BOOLEAN)) {
					...
					{
						xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGRowName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']//input[@type='text']";
						...
						if(sendKeys(driver, ele, value, recordName, action.BOOLEAN))
						{
							...
							if(CommonLib.doubleClickUsingAction(driver, ele)) {
								...
								WebElement	cancelBtnElement=FindElement(driver, xPath, "Cancel button of "+sdgGridName, action.BOOLEAN, 50);								
								...
								if(click(driver, saveBtnElement, "Save Button", action.BOOLEAN)) {
									...
									{
										log(LogStatus.ERROR,"\"Your changes are saved.\" Update Message is not visible",YesNo.Yes);
									}
						...
						{
							log(LogStatus.ERROR, "Could not enter the "+value+" in the field of "+recordName, YesNo.Yes);
						}
					}
					...
					{
						xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGRowName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']//lightning-base-combobox//button";
						...
						{							
							...
							CommonLib.ThreadSleep(3000);
							xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGRowName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']//lightning-base-combobox-item";
							elements=CommonLib.FindElements(driver, xPath, recordName+" record dropdown list");
							if(getSelectedOptionOfDropDown(driver, elements, recordName+" record dropdown list", value))
							{
							...
							{
								log(LogStatus.ERROR,"Could not select the "+value+" from the drop down of "+recordName+" record",YesNo.No);
							}
					...
					{
						xPath="//a[text()='"+sdgGridName+"']//ancestor::article//div[span[text()='Available']]//li//span[text()='"+multiPiclistValue.get(0)+"']";
						...
						{
							xPath= "//a[text()='"+sdgGridName+"']//ancestor::article//div[span[text()='Available']]//li//span[text()='"+multiPiclistValue.get(i)+"']";
						...
						xPath="//a[text()='"+sdgGridName+"']//ancestor::article//button[@title='Move selection to Chosen']";
						...
						{							
							...
							ThreadSleep(3000);
							xPath="//a[text()='"+sdgGridName+"']//ancestor::article//div[span[text()='Chosen']]//li//span[text()='"+multiPiclistValue.get(0)+"']";
							...
							if(CommonLib.isElementPresent(ele))
							{
								...
								{
									log(LogStatus.ERROR,"Could not click on the "+sdgGridName+" page size text",YesNo.No);
								}	
							}
							else
							{
					...
					{
						xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGRowName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']//textarea";
						ele=FindElement(driver, xPath, recordName+" Textbox", action.BOOLEAN, 50);
	...
	public boolean upadateLegalNameWebsiteRevenueAndVerifyErrorMessageSaveCancelButton(String sdgGridName,String firstSDGColumnName,String legalfieldName,String legalfieldValue,  String websiteFieldName,String websiteFieldValue ,String revenueFieldName,String revenueFieldValue)
	{
		...
		xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']";
		...
		if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
		{
			...
			if(mouseOverOperation(driver, ele))
			{
				...
				xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']//button";
				ele=FindElement(driver, xPath, "Value", action.BOOLEAN, 50);
				...
				if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+websiteFieldName, action.BOOLEAN)) {
					...
					xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']//input[@type='text']";
						...
						if(CommonLib.doubleClickUsingAction(driver, ele)) {
							...
							if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
							{
								...
								if(mouseOverOperation(driver, ele))
								{
									...
									xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+revenueFieldName+": ']//button";
									ele=FindElement(driver, xPath, "Value", action.BOOLEAN, 50);

									if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+revenueFieldName, action.BOOLEAN)) {
										log(LogStatus.INFO,"Clicked on the Edit icon of "+revenueFieldName,YesNo.Yes);
										CommonLib.ThreadSleep(3000);

										xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+revenueFieldName+": ']//input[@type='text']";
										...
										if(sendKeys(driver, ele, revenueFieldValue, revenueFieldName, action.BOOLEAN))
										{
											...
											if(CommonLib.doubleClickUsingAction(driver, ele)) {
												...
												{
													ThreadSleep(2000);
													log(LogStatus.INFO, "Window has been scrolled to "+legalfieldName, YesNo.No);
													if(mouseOverOperation(driver, ele))
													{
														log(LogStatus.INFO, "Mouse has been moved to "+legalfieldName, YesNo.No);		
														xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//button";
														ele=FindElement(driver, xPath, "Value", action.BOOLEAN, 50);

														if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+legalfieldName, action.BOOLEAN)) {
															log(LogStatus.INFO,"Clicked on the Edit icon of "+legalfieldName,YesNo.Yes);
															CommonLib.ThreadSleep(3000);

															xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//input[@type='text']";
															ele=FindElement(driver, xPath, legalfieldName+" Textbox", action.BOOLEAN, 50);
															if(sendKeys(driver, ele, legalfieldValue, legalfieldName, action.BOOLEAN))
															{
																...
																if(CommonLib.doubleClickUsingAction(driver, ele)) {
																	...
																	xPath="//a[text()='"+sdgGridName+"']//ancestor::article//button[text()='Cancel']";
																	WebElement	cancelBtnElement=FindElement(driver, xPath, "Cancel button of "+sdgGridName, action.BOOLEAN, 50);								
																	CommonLib.scrollDownThroughWebelementInCenter(driver, saveBtnElement, revenueFieldName);
																	if(CommonLib.checkElementVisibility(driver,saveBtnElement , "Save Button", 50))
																	{
																		log(LogStatus.PASS,"Save button is visible after updating the record",YesNo.No);
																		sa.assertTrue(true, "Save button is visible after updating the record");
																	...
																	if(click(driver, saveBtnElement, "Save Button", action.BOOLEAN)) {
																		...
																		if(CommonLib.checkElementVisibility(driver, geterrorMessageAfterSaveBlankRecord(50), "Error Message", 50))
																		{
																			log(LogStatus.INFO,"\"1 record has error. Kindly resolve them and try again.']\" Update Message is visible",YesNo.Yes);
																			flag= true;

																		}
																		else
																		{
																			log(LogStatus.ERROR,"\"1 record has error. Kindly resolve them and try again.']\" Update Message is not visible",YesNo.Yes);
																		}
															...
															{
																log(LogStatus.ERROR, "Could not enter the "+legalfieldValue+" in the inputox", YesNo.Yes);
															}
														}

														else
														{
															log(LogStatus.ERROR, "Could not click on the edit icon "+legalfieldName, YesNo.Yes);
														}

													}
													else
													{
														log(LogStatus.ERROR, "Not able to move to "+legalfieldName, YesNo.Yes);
													}
												}
												else
												{
									...
									{
										log(LogStatus.ERROR, "Could not click on the edit icon "+revenueFieldName, YesNo.Yes);
									}
											...
											if(CommonLib.doubleClickUsingAction(driver, ele)) {
												...
												if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
												{
													...
													if(mouseOverOperation(driver, ele))
													{
														...
														xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+phoneFieldName+": ']//button";
														...
														if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+phoneFieldName, action.BOOLEAN)) {
															...
															xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+phoneFieldName+": ']//input[@type='text']";
	...
	public boolean clickTwoCheckboxupadatePhoneWebsiteRevenueAndVerifyErrorMessageSaveCancelButton(String sdgGridName,String firstSDGColumnNamerow1,String firstSDGColumnNamerow2,String phoneFieldName,String phoneFieldValue,  String websiteFieldName,String websiteFieldValue ,String revenueFieldName,String revenueFieldValue)
	{
		...
		xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::tr//input";
		if(selectCheckbox(xPath,firstSDGColumnNamerow1))
		{
			...
			xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow2+"']//ancestor::tr//input";
			...
			if(selectCheckbox(xPath,firstSDGColumnNamerow2))
			{
				...
				xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']";
				ele=FindElement(driver, xPath, websiteFieldName+" Record Name", action.BOOLEAN, 50);
				if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
				{
					ThreadSleep(2000);
					...
					{
						log(LogStatus.INFO, "Mouse has been moved to "+websiteFieldName, YesNo.No);		
						xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']//button";
						ele=FindElement(driver, xPath, "Value", action.BOOLEAN, 50);
						...
						if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+websiteFieldName, action.BOOLEAN)) {
							...
							xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']//input[@type='text']";
							ele=FindElement(driver, xPath, websiteFieldName+" Textbox", action.BOOLEAN, 50);
							if(sendKeys(driver, ele, websiteFieldValue, websiteFieldName, action.BOOLEAN))
							{
								log(LogStatus.INFO,websiteFieldValue+ " has been passed in "+websiteFieldName,YesNo.No);
								...
								xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::tr//span[label[span[text()='Update 2 selected items']]]/input";
								if(selectCheckbox(xPath,firstSDGColumnNamerow1))
								{					
									log(LogStatus.INFO, firstSDGColumnNamerow1+" Update 2 selected items checkbox has been selected", YesNo.No);
									xPath="//a[text()='"+sdgGridName+"']/ancestor::article//button[text()='Apply']";
									ele=FindElement(driver, xPath, "Checkbox button of Update 2 selected items", action.BOOLEAN, 50);
									if(click(driver, ele, "Checkbox button of Update 2 selected items", action.BOOLEAN)) {
										...
										if(CommonLib.doubleClickUsingAction(driver, ele)) {
											...
											xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::td//following-sibling::td[@data-Label='"+revenueFieldName+": ']";
											ele=FindElement(driver, xPath, revenueFieldName+" Record Name", action.BOOLEAN, 50);
											if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
											{
												ThreadSleep(2000);
												...
												{
													log(LogStatus.INFO, "Mouse has been moved to "+revenueFieldName, YesNo.No);		
													xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::td//following-sibling::td[@data-Label='"+revenueFieldName+": ']//button";
													ele=FindElement(driver, xPath, "Value", action.BOOLEAN, 50);
													...
													if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+revenueFieldName, action.BOOLEAN)) {
														...
														xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::td//following-sibling::td[@data-Label='"+revenueFieldName+": ']//input[@type='text']";
														ele=FindElement(driver, xPath, revenueFieldName+" Textbox", action.BOOLEAN, 50);
														if(sendKeys(driver, ele, revenueFieldValue, revenueFieldName, action.BOOLEAN))
														{
															log(LogStatus.INFO,revenueFieldValue+ " has been passed in "+revenueFieldName,YesNo.No);
																...
																if(click(driver, ele, "Checkbox button of Update 2 selected items", action.BOOLEAN)) {
																	...
																	if(CommonLib.doubleClickUsingAction(driver, ele)) {
																		...
																		if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
																		{
																			...
																			{
																				log(LogStatus.INFO, "Mouse has been moved to "+phoneFieldName, YesNo.No);		
																				xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::td//following-sibling::td[@data-Label='"+phoneFieldName+": ']//button";
																				...
																				if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+phoneFieldName, action.BOOLEAN)) {
																					...
																					xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::td//following-sibling::td[@data-Label='"+phoneFieldName+": ']//input[@type='text']";
																					...
																					if(sendKeys(driver, ele, phoneFieldValue, phoneFieldName, action.BOOLEAN))
																					{
																							...
																							if(click(driver, ele, "Checkbox button of Update 2 selected items", action.BOOLEAN)) {
																								...
																								if(CommonLib.doubleClickUsingAction(driver, ele)) {
																									...
																									if(click(driver, saveBtnElement, "Save Button", action.BOOLEAN)) {
																										...
																										if(CommonLib.checkElementVisibility(driver, geterrorMessageAfterSaveTwoRecord(50), "Error Message", 50))
																										{
																											log(LogStatus.INFO,"\"2 record has error. Kindly resolve them and try again.']\" Update Message is visible",YesNo.Yes);
																											flag= true;

																										}
																										else
																										{
																											log(LogStatus.ERROR,"\"2 record has error. Kindly resolve them and try again.']\" Update Message is not visible",YesNo.Yes);
																										}
																						...
																						{
																							log(LogStatus.ERROR,"Could not click on checkbox button of Update 2 selected items",YesNo.No);
																						}
																					}
																					else
																					{
																		...
																		{
																			log(LogStatus.ERROR, "Window has been scrolled to "+firstSDGColumnNamerow1, YesNo.Yes);
																		}
	...
	public ArrayList<String> clickCancelBtnAndVerifyRecord(String sdgName,String firstSDGColumnName,ArrayList<String> fieldName,ArrayList<String> fieldValue)
	{
		String xPath="";
		WebElement ele=null;
		boolean flag=false;
...

	{
		...
		if(mouseOverOperation(driver, ele))
		{
			...
			{
				log(LogStatus.INFO, "Error Message is visible", YesNo.No);
				String text=CommonLib.getText(driver, gettriangleIconPermissionError(50), "Triangle Permission error message", action.BOOLEAN);
				System.out.println("text "+test);
				if(text.contains("permission to edit"))
				{
					log(LogStatus.INFO, "Permission error message has been verified on the hover of trianlge icon", YesNo.No);
					flag=true;
				}
				else
				{
					log(LogStatus.ERROR, "Permission error message is not verified visible on the hover of trianlge icon", YesNo.Yes);
				}
	...
	public boolean updatePhoneOnSDGRecordAndVerifyErrorMessage(String sdgGridName,String firstSDGColumnName,String phoneFieldName,String phoneFieldValue)
	{
		WebElement ele=null;
		boolean flag=false;
		String xPath;
	...
	public boolean verifyMultipleFieldWillNotEditOnDifferentPage(String sdgName,String firstSDGColumnNamerow1,String firstSDGColumnNamerow2,String firstSDGColumnNamerow3,String firstSDGColumnNamerow4)
	{
		...
		xPath="//a[text()='"+sdgName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow1+"']//ancestor::tr//input";
		if(selectCheckbox(xPath,firstSDGColumnNamerow1))
		{
			log(LogStatus.INFO,"checkbox has been selected against "+firstSDGColumnNamerow1,YesNo.No);

			xPath="//a[text()='"+sdgName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow2+"']//ancestor::tr//input";
			if(selectCheckbox(xPath,firstSDGColumnNamerow2))
			{
				...
				if(appBuilder.pageSelect(sdgName, "2"))
				{
					...
					xPath="//a[text()='"+sdgName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow3+"']//ancestor::tr//input";
					if(selectCheckbox(xPath,firstSDGColumnNamerow3))
					{
						...
						xPath="//a[text()='"+sdgName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow4+"']//ancestor::tr//input";
						if(selectCheckbox(xPath,firstSDGColumnNamerow4))
						{
							log(LogStatus.INFO,"checkbox has been selected against "+firstSDGColumnNamerow4,YesNo.No);
							...
							if(appBuilder.pageSelect(sdgName, "1"))
							{
								...
								{
									log(LogStatus.INFO,"Checkbox is Unselected against the "+firstSDGColumnNamerow1+" and "+firstSDGColumnNamerow2+"",YesNo.No);
									flag=true;
								}
								else
								{
									log(LogStatus.INFO,"Checkbox is selected against the "+firstSDGColumnNamerow1+" and "+firstSDGColumnNamerow2+"",YesNo.No);
						...
						{
							log(LogStatus.ERROR,"Could not select the checkbox against the "+firstSDGColumnNamerow4,YesNo.Yes);
						}

					}
					else
					{
						log(LogStatus.ERROR,"Could not select the checkbox against the "+firstSDGColumnNamerow3,YesNo.Yes);
					}
	...
	public boolean VerifyValidationUpdateSDGRecordButValueshouldnotUpdate(String sdgGridName,String firstSDGRowName,String recordName,String value)
	{
		...
		if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
		{
			...
			if(mouseOverOperation(driver, ele))
			{
				xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGRowName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']//span[@class='slds-truncate']";
				ele=FindElement(driver, xPath,  recordName, action.BOOLEAN, 50);
				...
				if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+recordName, action.BOOLEAN)) {
					...
					if(sendKeys(driver, ele, value, recordName, action.BOOLEAN))
					{
						...
						if(CommonLib.doubleClickUsingAction(driver, ele)) {
							...
							{
								log(LogStatus.ERROR,"Value has been changed. So we are able to enter the character",YesNo.No);
	...
	public boolean upadateSingleRecordVerifyErrorMessageSaveCancelButton(String sdgGridName,String firstSDGColumnName,String recordName,String recordValue)
	{
		String xPath="";
		WebElement ele=null;
		boolean flag=false;
		...
		xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']";
		ele=FindElement(driver, xPath, recordName+" Record Name", action.BOOLEAN, 50);
		if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
		{
			ThreadSleep(2000);
			...
			{
				log(LogStatus.INFO, "Mouse has been moved to "+recordName, YesNo.No);		
				xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']//button";
				ele=FindElement(driver, xPath, "Value", action.BOOLEAN, 50);
				...
				if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+recordName, action.BOOLEAN)) {
					...
					xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnName+"']//ancestor::td//following-sibling::td[@data-Label='"+recordName+": ']//input[@type='text']";
					ele=FindElement(driver, xPath, recordName+" Textbox", action.BOOLEAN, 50);
...

	{
		...
		if(mouseOverOperation(driver, ele))
		{
			...
			{
				log(LogStatus.INFO, "Error Message is visible", YesNo.No);
				String text=CommonLib.getText(driver, gettriangleIconOutsideRangeError(50), "Triangle outside range message", action.BOOLEAN);

				if(text.contains("value outside of valid range"))
				{
					log(LogStatus.INFO, "outside range message has been verified on the hover of trianlge icon", YesNo.No);
					flag=true;
				}
				else
				{
					log(LogStatus.ERROR, "outside range message is not verified visible on the hover of trianlge icon", YesNo.Yes);
				}
	...
	public boolean verifyAllFieldEditAtSameTimeInWebsiteRevenue(String sdgGridName,String firstSDGColumnNamerow,String websiteFieldName,String websiteFieldValue,String revenueFieldName,String revenueFieldValue)
	{
		String xPath="";
		WebElement ele=null;
		boolean flag=false;
		...
		if(selectCheckbox(xPath,sdgGridName+" checkbox"))
		{
			...
			xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']";
			ele=FindElement(driver, xPath, websiteFieldName+" Record Name", action.BOOLEAN, 50);
			if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
			{
				ThreadSleep(2000);
				...
				{
					log(LogStatus.INFO, "Mouse has been moved to "+websiteFieldName, YesNo.No);		
					xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']//button";
					ele=FindElement(driver, xPath, "Value", action.BOOLEAN, 50);
					...
					if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+websiteFieldName, action.BOOLEAN)) {
						...
						xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow+"']//ancestor::td//following-sibling::td[@data-Label='"+websiteFieldName+": ']//input[@type='text']";
						ele=FindElement(driver, xPath, websiteFieldName+" Textbox", action.BOOLEAN, 50);
						if(sendKeys(driver, ele, websiteFieldValue, websiteFieldName, action.BOOLEAN))
						{
							log(LogStatus.INFO,websiteFieldValue+ " has been passed in "+websiteFieldName,YesNo.No);
							...
							xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow+"']//ancestor::tr//span[label[span[text()='Update 10 selected items']]]/input";
							if(selectCheckbox(xPath,firstSDGColumnNamerow))
							{					
								log(LogStatus.INFO, firstSDGColumnNamerow+" Update 10 selected items checkbox has been selected", YesNo.No);
								xPath="//a[text()='"+sdgGridName+"']/ancestor::article//button[text()='Apply']";
								ele=FindElement(driver, xPath, "Checkbox button of Update 10 selected items", action.BOOLEAN, 50);
								if(click(driver, ele, "Checkbox button of Update 10 selected items", action.BOOLEAN)) {
									...
									if(CommonLib.doubleClickUsingAction(driver, ele)) {
										...
										xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow+"']//ancestor::td//following-sibling::td[@data-Label='"+revenueFieldName+": ']";
										ele=FindElement(driver, xPath, revenueFieldName+" Record Name", action.BOOLEAN, 50);
										if(CommonLib.scrollDownThroughWebelementInCenter(driver, ele, "Element"))
										{
											ThreadSleep(2000);
											...
											{
												log(LogStatus.INFO, "Mouse has been moved to "+revenueFieldName, YesNo.No);		
												xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow+"']//ancestor::td//following-sibling::td[@data-Label='"+revenueFieldName+": ']//button";
												ele=FindElement(driver, xPath, "Value", action.BOOLEAN, 50);
												...
												if(CommonLib.clickUsingJavaScript(driver, ele, "Edit icon of "+revenueFieldName, action.BOOLEAN)) {
													...
													xPath="//a[text()='"+sdgGridName+"']//ancestor::article//td//a[text()='"+firstSDGColumnNamerow+"']//ancestor::td//following-sibling::td[@data-Label='"+revenueFieldName+": ']//input[@type='text']";
													ele=FindElement(driver, xPath, revenueFieldName+" Textbox", action.BOOLEAN, 50);
													if(sendKeys(driver, ele, revenueFieldValue, revenueFieldName, action.BOOLEAN))
													{
														log(LogStatus.INFO,revenueFieldValue+ " has been passed in "+revenueFieldName,YesNo.No);
										...
										{
											log(LogStatus.ERROR, "Window has been scrolled to "+firstSDGColumnNamerow, YesNo.Yes);
										}
									}
									else
									{
