...
public class SDGPage extends BasePageBusinessLayer {
	...
	@FindBy(xpath = "//label[text()='Filter Sequence']/parent::div//following-sibling::div//button")
	...
	@FindBy(xpath = "//label[text()='Filter Sequence']/parent::div//following-sibling::div//lightning-base-combobox-item//span[@class='slds-truncate']")
