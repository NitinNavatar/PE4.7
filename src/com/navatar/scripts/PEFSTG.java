...
public class PEFSTG extends BaseLib{
	...
	public void PEFSTGTc002_VerifyAppsOrLightningPages(String projectName) {
		...
		{
			log(LogStatus.PASS, "PE Cloud is availale on the home page", YesNo.Yes);
			sa.assertTrue(true, "PE Cloud is availale on the home page");	
		}
		else
		{
			log(LogStatus.PASS, "PE Cloud is not availale on the home page", YesNo.Yes);
			sa.assertTrue(true, "PE Cloud is not availale on the home page");	
		}
