...
public class RGAcuityTaskAndEvent extends BaseLib {
	...
	public void RGATETc001_CreateCRMUser(String projectName) {
		...
		for (int k = 0; k < 6; k++) {
			...
			String[] firstName = { RGcrmUser1FirstName, RGcrmUser2FirstName, RGcrmUser3FirstName, RGcrmUser4FirstName,
					RGcrmUser5FirstName, RGcrmUser6FirstName };
			String[] lastName = { RGcrmUser1LastName, RGcrmUser2LastName, RGcrmUser3LastName, RGcrmUser4LastName,
					RGcrmUser5LastName, RGcrmUser6LastName };
			String[] userLicence = { RGcrmUser1Lience, RGcrmUser2Lience, RGcrmUser3Lience, RGcrmUser4Lience,
					RGcrmUser5Lience, RGcrmUser6Lience, };
			String[] userProfile = { RGcrmUser1Profile, RGcrmUser2Profile, RGcrmUser3Profile, RGcrmUser4Profile,
					RGcrmUser5Profile, RGcrmUser6Profile, };
				...
				try {
					if (home.clickOnSetUpLink()) {
						...
						if (setup.createPEUser(firstName[k], UserLastName, emailId, userLicence[k], userProfile[k],
								userTitle[k])) {
							log(LogStatus.INFO,
									"CRM User is created Successfully: " + firstName[k] + " " + UserLastName, YesNo.No);
							ExcelUtils.writeData(testCasesFilePath, emailId, "Users", excelLabel.Variable_Name,
									"RGUser" + (k + 1), excelLabel.User_Email);
	...
	public void RGATETc003_1_CreateSomeRevenueInboxEvents(String projectName) {
		...
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_StartDay1));
	...
	public void RGATETc003_2_CreateSomeRevenueInboxEvents(String projectName) {
		...
		String startDate1 = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_StartDay2));
	...
	public void RGATETc003_3_CreateSomeRevenueInboxEvents(String projectName) {
		...
		String startDate2 = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_StartDay3));
	...
	public void RGATETc003_4_CreateSomeRevenueInboxEvents(String projectName) {
		...
		String startDate3 = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_StartDay4));
		...
		log(LogStatus.INFO, "---------Now Going to Create Event: " + eventTitle3 + " through Outlook---------",
				YesNo.No);
		if (op.loginAndCreateEventThroughOutLookWithoutForceSyncUp(rgOutLookUser1Email, rgOutLookUser1Password,
				eventTitle3, eventAttendees3, startDate3, endDate3, startTime3, endTime3, descriptionBox3, false,
				eventRepeat)) {
			log(LogStatus.INFO,
	...
	public void RGATETc003_5_CreateSomeRevenueInboxEvents(String projectName) {
		...
		String startDate4 = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_StartDay5));
	...
	public void RGATETc003_6_CreateSomeRevenueInboxEvents(String projectName) {
		...
		String startDate5 = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_StartDay6));
	...
	public void RGATETc003_7_CreateSomeRevenueInboxEvents(String projectName) {
		...
		String startDate6 = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_StartDay7));
	...
	@Parameters({ "projectName" })
	@Test
	public void RGATETc004_GoToAccountAcuityTabAndVerifyRevenueEventOnInteractionsAndContactAccountInCompanyReferenceAndContactInPeopleTaggedSection(
			String projectName) {
		...
		String[] companiesTaggedTimeReference = { RGATE_TaggedCompanyReferenceCount1,
				RGATE_TaggedCompanyReferenceCount2, RGATE_TaggedCompanyReferenceCount3 };

		String[] peopleTagedName = { RGATE_TaggedPeople1, RGATE_TaggedPeople2, RGATE_TaggedPeople3 };
		String[] peopleTaggedTimeReference = { RGATE_TaggedPeopleReferenceCount1, RGATE_TaggedPeopleReferenceCount2,
				RGATE_TaggedPeopleReferenceCount3 };
		...
		String[] iconType = { RGATE_ActivityType1, RGATE_ActivityType3, RGATE_ActivityType5, RGATE_ActivityType6,
				RGATE_ActivityType7 };
		...
		String[] date = { RGATE_AdvanceStartDate1, RGATE_AdvanceStartDate3, RGATE_AdvanceStartDate5,
				RGATE_AdvanceStartDate6, RGATE_AdvanceStartDate7 };

		String[][] participant = { bp.getParticipantDataRG(RGATE_Participant1),
				bp.getParticipantDataRG(RGATE_Participant3), bp.getParticipantDataRG(RGATE_Participant5),
				bp.getParticipantDataRG(RGATE_Participant6), bp.getParticipantDataRG(RGATE_Participant7) };
		...
		if (lp.clickOnTab(projectName, tabObj1)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					ArrayList<String> result = bp.verifyRecordAndReferencedTypeOnTagged(companiesTaggedName,
							companiesTaggedTimeReference, peopleTagedName, peopleTaggedTimeReference, null, null,
							isInstitutionRecord, null, null);
					if (result.isEmpty()) {
					...
					ArrayList<String> result1 = bp.verifyRecordOnContactSectionAcuity(contactSectionName,
							contactSectionTitle, contactSectionDeal, contactSectionMeetingAndCall, contactSectionEmail);
					if (result1.isEmpty()) {
						log(LogStatus.INFO, "The records have been verified on contact section in Acuity contact",
								YesNo.No);
					} else {
						log(LogStatus.ERROR,
								"The records are not verified on contact section in Acuity for contact : " + result1,
								YesNo.No);
						sa.assertTrue(false,
								"The records are not verified on contact section in Acuity for contact :  " + result1);
					}
					...
					if (click(driver, bp.getTaggedRecordName("Firms", 30), "Firms tab", action.SCROLLANDBOOLEAN)) {
						...
						if (click(
								driver, bp.getTaggedRecordTimeReference("Firms", companyTagName,
										companyTagTimeReferenceCount, 30),
								companyTagName + " on firm Tagged", action.SCROLLANDBOOLEAN)) {
							log(LogStatus.INFO, "Clicked on Time reference count of " + companyTagName, YesNo.No);

							ArrayList<String> result2 = bp.verifyRecordsonInteractionsViewAllPopup(companyTagName,
									iconType, date, subjectName, details, subjectName, participant, null);
							if (result2.isEmpty()) {
								log(LogStatus.INFO, "All records on Interaction card have been verified for "
										+ companyTagName + " record", YesNo.No);
							} else {
								log(LogStatus.ERROR, "All records on Interaction card are not verified for "
										+ companyTagName + " record " + result2, YesNo.No);
								sa.assertTrue(false, "All records on Interaction card are not verified for "
										+ companyTagName + " record " + result2);
							}

						} else {
							log(LogStatus.ERROR, "Not able to click on Time reference count of " + companyTagName,
									YesNo.No);
						...
						if (click(
							...
							ArrayList<String> result5 = bp
									.verifyDescriptionShouldNotVisibleUnderDetailsOnInteractionSection(subjectName,
											details1);
							if (result5.isEmpty()) {
								log(LogStatus.INFO,
										"Description message is not showing under details on view all interaction popup",
										YesNo.No);
							} else {
								log(LogStatus.ERROR,
										"Description message is showing under details on view all interaction popup. "
												+ result5,
										YesNo.No);
								sa.assertTrue(false,
										"Description message is showing under details on view all interaction popup. "
					...
					if (click(driver, bp.getTaggedRecordName("People", 30), "People tab", action.SCROLLANDBOOLEAN)) {
						...
						if (click(
								driver, bp.getTaggedRecordTimeReference("People", peopleTagName,
										peopleTagTimeReferenceCount, 30),
								peopleTagName + " on Company Tagged", action.SCROLLANDBOOLEAN)) {
							log(LogStatus.INFO, "Clicked on Time reference count of " + peopleTagName, YesNo.No);

							ArrayList<String> result3 = bp.verifyRecordsonInteractionsViewAllPopup(peopleTagName,
									iconType, date, subjectName, details, subjectName, participant, null);
							if (result3.isEmpty()) {
								log(LogStatus.INFO, "All records on Interaction card have been verified for "
										+ peopleTagName + " record", YesNo.No);
							} else {
								log(LogStatus.ERROR, "All records on Interaction card are not verified for "
										+ peopleTagName + " record " + result3, YesNo.No);
								sa.assertTrue(false, "All records on Interaction card are not verified for "
										+ peopleTagName + " record " + result3);
							}

						} else {
							log(LogStatus.ERROR, "Not able to click on Time reference count of " + peopleTagName,
									YesNo.No);
					...
					if (CommonLib.clickUsingJavaScript(driver, bp.getViewAllBtnOnIntration(20), "View All button")) {
						...
						ArrayList<String> result2 = bp.verifyRecordsonInteractionsViewAllPopup(recordName, iconType,
								date, subjectName, details, subjectName, participant, null);
						if (result2.isEmpty()) {
							log(LogStatus.INFO, "The records have been verified on interaction popup in Acuity",
									YesNo.No);
						} else {
							log(LogStatus.ERROR,
									"The records are not verified on interaction popup in Acuity : " + result2,
									YesNo.No);
							sa.assertTrue(false,
									"The records are not verified on interaction popup in Acuity :  " + result2);
						}
					...
					if (lp.clickOnTab(projectName, tabObj1)) {
						...
						log(LogStatus.INFO, "Clicked on Tab : " + tabObj1, YesNo.No);
						if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName1,
								30)) {
							...
							if (bp.clicktabOnPage(TabName.Acuity.toString())) {
								...
								ArrayList<String> result2 = bp.verifyRecordOnContactSectionAcuity(contactSectionName1,
										contactSectionTitle1, contactSectionDeal1, contactSectionMeetingAndCall1,
										contactSectionEmail1);
								if (result2.isEmpty()) {
									log(LogStatus.INFO,
											"The records have been verified on contact section in Acuity contact",
											YesNo.No);
								} else {
									log(LogStatus.ERROR,
											"The records are not verified on contact section in Acuity for contact : "
													+ result2,
											YesNo.No);
									sa.assertTrue(false,
											"The records are not verified on contact section in Acuity for contact :  "
	...
	public void RGATETc005_VerifyRevenueEventsInSalesforce(String projectName) {
		...
		if (hp.globalSearchAndNavigate(globalEventSubjectName, globalActivityName, true, projectName)) {
		...
		if (hp.globalSearchAndNavigate(globalEventSubjectName1, globalActivityName1, true, projectName)) {
		...
		String updateEventStartDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "MM/dd/yyyy",
				Integer.parseInt(RGATE_UStartDay1));
		ExcelUtils.writeData(AcuityDataSheetFilePath, updateEventStartDate, "Activity Timeline",
				excelLabel.Variable_Name, "RGATE_U001", excelLabel.Advance_Start_Date);

		String updateEventEndDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "MM/dd/yyyy",
				Integer.parseInt(RGATE_UEndDay1));
		...
		if (lp.clickOnTab(projectName, tabObj1)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					ArrayList<String> result = bp.verifyRecordOnInteractionCard(eventDueDate, IconType.Meeting,
							eventSubjectName, eventNotes, false, true, eventRelatedTo, eventRelatedAssociation);

					if (result.isEmpty()) {
						log(LogStatus.INFO, eventSubjectName + " Event has been verified on interaction section",
								YesNo.No);
					} else {
						log(LogStatus.ERROR,
								eventSubjectName + " Event is not verified on interaction section. " + result,
								YesNo.No);
						sa.assertTrue(false,
								eventSubjectName + " Event is not verified on interaction section. " + result);
					}
					...
					if (bp.verifyDescriptionShouldNotVisibleOnInteractionCard(eventSubjectName, eventNotes1)) {
						log(LogStatus.INFO, "Description message : \" " + eventNotes1
								+ " \" is not available on interaction card" + eventSubjectName, YesNo.No);
					} else {
						log(LogStatus.INFO, "Description message : \" " + eventNotes1
								+ " \" is available on interaction card" + eventSubjectName, YesNo.No);
						sa.assertTrue(false, "Description message : \" " + eventNotes1
								+ " \" is available on interaction card" + eventSubjectName);
					}

					ArrayList<String> result2 = bp.verifySubjectLinkPopUpOnIntraction(driver, eventSubjectName,
							basicsection, advanceSection, IconType.Event, PageName.AcuityDetails);

					if (result2.isEmpty()) {
						log(LogStatus.PASS,
								"The details on popup of subject " + eventSubjectName + " has been verified", YesNo.No);
						sa.assertTrue(true,
								"The details on popup of subject " + eventSubjectName + " has been verified");
					} else {
						log(LogStatus.FAIL,
								"The details on popup of subject " + eventSubjectName + " are not verified. " + result2,
								YesNo.No);
						sa.assertTrue(false, "The details on popup of subject " + eventSubjectName
								+ " are not verified. " + result2);
					...
					if (CommonLib.clickUsingJavaScript(driver, bp.addButtonOnInteractionCard(eventSubjectName, 20),
							"Edit button of " + eventSubjectName)) {
						log(LogStatus.INFO,
								"Clicked on Edit button on interaction section of subject name " + eventSubjectName,
								YesNo.No);
						ArrayList<String> NotesPopUpPrefilledNegativeResult = bp
								.verifyNotesPopupWithPrefilledValueAndOnSameUrl(currentUrl, basicsection,
										advanceSection, null);
						...
						log(LogStatus.ERROR, "Not able to click on Edit button on interaction section of subject name "
								+ eventSubjectName, YesNo.No);
						sa.assertTrue(false, "Not able to click on Edit button on interaction section of subject name "
								+ eventSubjectName);
					}
					refresh(driver);
	...
	public void RGATETc006_UpdateTheDescriptionOfRevenueEventAndVerify(String projectName) {
		...
		String[][] basicsection = { { "Subject", RGATE_Subject1 }, { "Notes", updateEventNotes },
		...
		if (lp.clickOnTab(projectName, tabObj1)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					if (click(driver, bp.addButtonOnInteractionCard(eventSubjectName, 20), "Add note button",
							action.SCROLLANDBOOLEAN)) {
						log(LogStatus.INFO, "clicked on Add Note button of " + eventSubjectName, YesNo.No);

						if (bp.updateActivityTimelineRecord(projectName, updateBasicSection, null, null, null, null,
							...
							if (result.isEmpty()) {
								log(LogStatus.INFO,
										eventSubjectName + " Event has been verified on interaction section", YesNo.No);
							} else {
								log(LogStatus.ERROR,
										eventSubjectName + " Event is not verified on interaction section. " + result,
										YesNo.No);
							...
							if (result2.isEmpty()) {
								...
								log(LogStatus.FAIL, "The details on popup of subject " + eventSubjectName
										+ " are not verified. " + result2, YesNo.No);
								sa.assertTrue(false, "The details on popup of subject " + eventSubjectName
										+ " are not verified. " + result2);
							...
							if (CommonLib.clickUsingJavaScript(driver,
									bp.addButtonOnInteractionCard(eventSubjectName, 20),
									"Edit button of " + eventSubjectName)) {
								log(LogStatus.INFO, "Clicked on Edit button on interaction section of subject name "
										+ eventSubjectName, YesNo.No);
								ArrayList<String> NotesPopUpPrefilledNegativeResult = bp
										.verifyNotesPopupWithPrefilledValueAndOnSameUrl(currentUrl, basicsection,
												advanceSection, null);
								...
								log(LogStatus.ERROR,
										"Not able to click on Edit button on interaction section of subject name "
												+ eventSubjectName,
										YesNo.No);
								sa.assertTrue(false,
										"Not able to click on Edit button on interaction section of subject name "
	...
	@Parameters({ "projectName" })
	@Test
	public void RGATETc007_VerifyEventsOnContactSectionOfAccountPageAlsoVerifyEventsOnConnectionPopup(
			String projectName) {
		...
		String[] icon = { RGATE_ActivityType1, RGATE_ActivityType3, RGATE_ActivityType5, RGATE_ActivityType6,
				RGATE_ActivityType7 };
		...
		String[][] participant1 = { bp.getParticipantDataRG(RGATE_Participant1),
				bp.getParticipantDataRG(RGATE_Participant5), bp.getParticipantDataRG(RGATE_Participant7) };
		...
		String[][] participant2 = { bp.getParticipantDataRG(RGATE_Participant1),
				bp.getParticipantDataRG(RGATE_Participant7) };
		...
		if (lp.clickOnTab(projectName, tabObj1)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					if (CommonLib.clickUsingJavaScript(driver, bp.getMeetingAndCallCount(RGATE_ContactSectionName1, 20),
							"Count of " + RGATE_ContactSectionName1 + " on contact section", action.SCROLLANDBOOLEAN)) {
						log(LogStatus.INFO, "clicked on count of " + RGATE_ContactSectionName1, YesNo.No);
						ArrayList<String> result4 = bp.verifyRecordOnMeetingsAndCallPopUpSectionInAcuity(icon, date,
								subjectName, details, participant, null);
						if (result4.isEmpty()) {
							log(LogStatus.INFO, "Records have been verified on meeting and call popup for record "
									+ RGATE_ContactSectionName1 + ". ", YesNo.No);
						} else {
							log(LogStatus.ERROR, "Records are not verifid on meeting and call popup for record "
									+ RGATE_ContactSectionName1 + ". " + result4, YesNo.No);
							sa.assertTrue(false, "Records are not verifid on meeting and call popup"
									+ RGATE_ContactSectionName1 + ". " + result4);
						}
					...
					if (CommonLib.clickUsingJavaScript(driver, bp.contactNameUserIconButton(contactName, 30),
						...
						if (CommonLib.clickUsingJavaScript(driver, bp.getMeetingAndCallCount(userName1, 20),
								"Count of " + userName1 + " on contact section", action.SCROLLANDBOOLEAN)) {
							log(LogStatus.INFO, "clicked on count of " + userName1, YesNo.No);
							ArrayList<String> result4 = bp.verifyRecordOnMeetingsAndCallPopUpSectionInAcuity(icon1,
									date1, subjectName1, details1, participant1, null);
							if (result4.isEmpty()) {
								log(LogStatus.INFO, "Records have been verified on meeting and call popup. user name : "
										+ userName1 + ".", YesNo.No);
							} else {
								log(LogStatus.ERROR, "Records are not verifid on meeting and call popup for user "
										+ userName1 + ". " + result4, YesNo.No);
								sa.assertTrue(false, "Records are not verifid on meeting and call popup for user "
										+ userName1 + ". " + result4);
							}
						...
						if (CommonLib.clickUsingJavaScript(driver, bp.getMeetingAndCallCount(userName2, 20),
								"Count of " + userName2 + " on contact section", action.SCROLLANDBOOLEAN)) {
							ThreadSleep(2000);
							log(LogStatus.INFO, "clicked on count of " + userName2, YesNo.No);
							ArrayList<String> result5 = bp.verifyRecordOnMeetingsAndCallPopUpSectionInAcuity(icon2,
									date2, subjectName2, details2, participant2, null);
							if (result5.isEmpty()) {
								log(LogStatus.INFO, "Records have been verified on meeting and call popup. user name : "
										+ userName2 + ".", YesNo.No);
							} else {
								log(LogStatus.ERROR, "Records are not verifid on meeting and call popup for user "
										+ userName2 + ". " + result5, YesNo.No);
								sa.assertTrue(false, "Records are not verifid on meeting and call popup for user "
										+ userName2 + ". " + result5);
							}
						...
						log(LogStatus.ERROR, "Not able to click on connection icon of contact : " + contactName,
								YesNo.No);
	...
	@Parameters({ "projectName" })
	@Test
	public void RGATETc008_GoToContactAcuityTabAndVerifyRevenueEventOnInteractionsAndContactAccountInCompanyReferenceAndContactInPeopleTaggedSection(
			String projectName) {
		...
		String[] peopleTagedName = { RGATE_TaggedPeople1, RGATE_TaggedPeople2, RGATE_TaggedPeople3 };
		String[] peopleTaggedTimeReference = { RGATE_TaggedPeopleReferenceCount1, RGATE_TaggedPeopleReferenceCount2,
				RGATE_TaggedPeopleReferenceCount2 };
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					if (click(driver, bp.getTaggedRecordName("Firms", 30), "Firms tab", action.SCROLLANDBOOLEAN)) {
						...
						if (click(
								driver, bp.getTaggedRecordTimeReference("Firms", companyTagName,
										companyTagTimeReferenceCount, 30),
								companyTagName + " on Company Tagged", action.SCROLLANDBOOLEAN)) {
							log(LogStatus.INFO, "Clicked on Time reference count of " + companyTagName, YesNo.No);

							ArrayList<String> result5 = bp
									.verifyDescriptionShouldNotVisibleUnderDetailsOnInteractionSection(subjectName1,
											notes1);
							if (result5.isEmpty()) {
								log(LogStatus.INFO,
										"Description message is not showing under details on view all interaction popup",
					...
					if (lp.clickOnTab(projectName, tabObj1)) {
						...
						if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName1,
							...
							if (bp.clicktabOnPage(TabName.Acuity.toString())) {
								...
								ArrayList<String> result2 = bp.verifyRecordOnContactSectionAcuity(contactSectionName,
										contactSectionTitle, contactSectionDeal, contactSectionMeetingAndCall,
										contactSectionEmail);
								if (result2.isEmpty()) {
									log(LogStatus.INFO,
											"The records have been verified on contact section in Acuity contact",
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.ContactTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					ArrayList<String> result1 = bp.verifyRecordOnInteractionCard(eventDueDate, IconType.Meeting,
							eventSubject, eventNotes, false, true, eventRelatedTo, eventRelatedAssociation);

					if (result1.isEmpty()) {
						log(LogStatus.INFO, eventSubject + " Event has been verified on interaction section", YesNo.No);
					} else {
						log(LogStatus.ERROR, eventSubject + " Event is not verified on interaction section. " + result1,
								YesNo.No);
						sa.assertTrue(false,
								eventSubject + " Event is not verified on interaction section. " + result1);
					}
					...
					ArrayList<String> result6 = bp.verifyRecordOnConnectionsSectionInAcuity(recordName,
							connectionUserName, null, null, connectionMeetingaAndCall, null);
					if (result6.isEmpty()) {
						log(LogStatus.INFO, "The records have been verified on Connection section in Acuity user : "
								+ connectionUserName, YesNo.No);
					} else {
						log(LogStatus.ERROR, "The records are not verified on Connection section in Acuity. user : "
								+ connectionUserName + " " + result6, YesNo.No);
						sa.assertTrue(false, "The records are not verified on Connection section in Acuity.  user : "
								+ connectionUserName + " " + result6);
					}

					ArrayList<String> result7 = bp.verifyRecordOnConnectionsSectionInAcuity(recordName,
							connectionUserName1, null, null, connectionMeetingaAndCall1, null);
					if (result7.isEmpty()) {
						log(LogStatus.INFO, "The records have been verified on Connection section in Acuity user : "
								+ connectionUserName1, YesNo.No);
					} else {
						log(LogStatus.ERROR, "The records are not verified on Connection section in Acuity. user : "
								+ connectionUserName1 + " " + result7, YesNo.No);
						sa.assertTrue(false, "The records are not verified on Connection section in Acuity.  user : "
								+ connectionUserName1 + " " + result7);
					}

					ArrayList<String> result8 = bp.verifyRecordOnConnectionsSectionInAcuity(recordName,
							connectionUserName2, null, null, connectionMeetingaAndCall2, null);
					if (result8.isEmpty()) {
						log(LogStatus.INFO, "The records have been verified on Connection section in Acuity user : "
								+ connectionUserName2, YesNo.No);
					} else {
						log(LogStatus.ERROR, "The records are not verified on Connection section in Acuity. user : "
								+ connectionUserName2 + " " + result8, YesNo.No);
						sa.assertTrue(false, "The records are not verified on Connection section in Acuity.  user : "
								+ connectionUserName2 + " " + result8);
					}

					ArrayList<String> result9 = bp.verifyRecordOnConnectionsSectionInAcuity(recordName,
							connectionUserName3, null, null, connectionMeetingaAndCall3, null);
					if (result9.isEmpty()) {
						log(LogStatus.INFO, "The records have been verified on Connection section in Acuity user : "
								+ connectionUserName3, YesNo.No);
					} else {
						log(LogStatus.ERROR, "The records are not verified on Connection section in Acuity. user : "
								+ connectionUserName3 + " " + result8, YesNo.No);
						sa.assertTrue(false, "The records are not verified on Connection section in Acuity.  user : "
								+ connectionUserName3 + " " + result8);
					}
	...
	public void RGATETc010_UpdateTheInviteeInRevenueEventsFromOutlook(String projectName) {
		...
		String endDate = CommonLib.convertDateFromOneFormatToAnother(RGATE_AdvanceEndDate1, "M/d/yyyy", "MMMM yyyy");

		lp.CRMLogin(RGcrmUser1EmailID, adminPassword);
		log(LogStatus.INFO, "---------Now Going to Create Event: " + eventTitle + " through Outlook---------",
				YesNo.No);

		if (op.loginNavigateAndUpdateTheEvent(rgOutLookUser1Email, rgOutLookUser1Password, startDate, endDate,
				eventTitle, false, null, eventAttendees, null, null, null, null, null, false, null)) {
			log(LogStatus.INFO,
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.ContactTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					ArrayList<String> result1 = bp.verifyRecordOnInteractionCard(eventDueDate, IconType.Meeting,
							eventSubject, eventNotes, false, true, null, null);
	...
	public void RGATETc012_VerifyUpdatedEventOnFirmRecordPage(String projectName) {
		...
		String[] connectionMeetingaAndCall = { RGATE_ConnectionSectionNameMeetingAndCall1,
				RGATE_ConnectionSectionNameMeetingAndCall2 };
		...
		if (lp.clickOnTab(projectName, tabObj1)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					ArrayList<String> result7 = bp.verifyRecordOnConnectionsPopUpOfContactInAcuity(contactName,
							connectionUserName, null, null, connectionMeetingaAndCall, null);
					if (result7.isEmpty()) {
						log(LogStatus.INFO, "The records on Connection popup have been verified for " + contactName,
								YesNo.No);
					} else {
						log(LogStatus.ERROR,
								"The records on Connection popup are not verified for " + contactName + ". " + result7,
								YesNo.No);
						sa.assertTrue(false,
								"The records on Connection popup are not verified for " + contactName + ". " + result7);
					}
	...
	public void RGATETc013_UpdateTheDateInRevenueEventsFromOutlook(String projectName) {
		...
		String updatedEventStartDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_UStartDay1));
		ExcelUtils.writeData(AcuityDataSheetFilePath, updatedEventStartDate, "Activity Timeline",
				excelLabel.Variable_Name, "RGATE_U001", excelLabel.Advance_Start_Date);

		String updatedEventEndDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_UEndDay1));
		ExcelUtils.writeData(AcuityDataSheetFilePath, updatedEventEndDate, "Activity Timeline",
				excelLabel.Variable_Name, "RGATE_U001", excelLabel.Advance_End_Date);
		...
		if (op.loginNavigateAndUpdateTheEvent(rgOutLookUser1Email, rgOutLookUser1Password, startDate, endDate,
				eventTitle, false, null, null, updatedEventStartDate, updatedEventEndDate, null, null, null, false,
				null)) {
			log(LogStatus.INFO,
					"-----Event updated Msg is showing, So Event of Title: " + eventTitle + " has been updated-----",
					YesNo.No);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.ContactTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					ArrayList<String> result1 = bp.verifyRecordOnInteractionCard(eventDueDate, IconType.Meeting,
							eventSubject, eventNotes, true, false, null, null);
	...
	public void RGATETc016_VerifyViewAllLinkOnInteractionSectionOfContactPage(String projectName) {
		...
		String[][] basicsection = { { "Subject", eventSubjectName }, { "Notes", eventNotes },
				{ "Related_To", relatedTo } };
		String[][] advanceSection = { { "Date", eventDueDate } };
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.ContactTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					if (CommonLib.clickUsingJavaScript(driver, bp.getViewAllBtnOnIntration(20), "View All button")) {
						log(LogStatus.INFO, "Clicked on View All button of Interaction section", YesNo.No);
						ArrayList<String> result = bp.verifyRecordsonInteractionsViewAllPopup(recordName, iconType,
								date, subjectName, details, subjectName, participant, null);
						if (result.isEmpty()) {
							log(LogStatus.INFO, "The records have been verified on interaction popup in Acuity",
									YesNo.No);
							...
							log(LogStatus.ERROR,
									"The records are not verified on interaction popup in Acuity : " + result,
									YesNo.No);
							sa.assertTrue(false,
									"The records are not verified on interaction popup in Acuity :  " + result);
						}
						...
						ArrayList<String> result2 = bp.verifySubjectLinkPopUpOnIntraction(driver, eventSubjectName,
								basicsection, advanceSection, IconType.Event, PageName.Interaction);
	...
	public void RGATETc017_VerifyUpdatedDateEventOnFirmRecordPage(String projectName) {
		...
		if (lp.clickOnTab(projectName, tabObj1)) {
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName, 30)) {
				...
				if (CommonLib.clickUsingJavaScript(driver, bp.getViewAllBtnOnIntration(20), "View All button")) {
					log(LogStatus.INFO, "Clicked on View All button of Interaction section", YesNo.No);
					ArrayList<String> result = bp.verifyRecordsonInteractionsViewAllPopup(recordName, iconType, date,
							subjectName, details, subjectName, participant, null);
					if (result.isEmpty()) {
						log(LogStatus.INFO, "The records have been verified on interaction popup in Acuity", YesNo.No);
					} else {
						log(LogStatus.ERROR, "The records are not verified on interaction popup in Acuity : " + result,
								YesNo.No);
						sa.assertTrue(false,
								"The records are not verified on interaction popup in Acuity :  " + result);
					}
	...
	public void RGATETc020_VerifyEmailTaskInTheFirmAccountPage(String projectName) {
		...
		String[] companiesTaggedName = { RGATE_TaggedCompany5, RGATE_TaggedCompany6, RGATE_TaggedCompany7,
				RGATE_TaggedCompany8 };
		String[] companiesTaggedTimeReference = { RGATE_TaggedCompanyReferenceCount5,
				RGATE_TaggedCompanyReferenceCount6, RGATE_TaggedCompanyReferenceCount7,
				RGATE_TaggedCompanyReferenceCount8 };

		String[] peopleTagedName = { RGATE_TaggedPeople4, RGATE_TaggedPeople5, RGATE_TaggedPeople6, RGATE_TaggedPeople7,
				RGATE_TaggedPeople8 };
		String[] peopleTaggedTimeReference = { RGATE_TaggedPeopleReferenceCount4, RGATE_TaggedPeopleReferenceCount5,
				RGATE_TaggedPeopleReferenceCount6, RGATE_TaggedPeopleReferenceCount7,
				RGATE_TaggedPeopleReferenceCount8 };
			...
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.InstituitonsTab, recordName, 30)) {
				...
				if (bp.clicktabOnPage(TabName.Acuity.toString())) {
					...
					if (CommonLib.clickUsingJavaScript(driver, bp.getViewAllBtnOnIntration(20), "View All button")) {
						log(LogStatus.INFO, "Clicked on View All button of Interaction section", YesNo.No);
						ArrayList<String> result2 = bp.verifyRecordsonInteractionsViewAllPopup(recordName, iconType,
								date, subjectName, details, subjectName, null, null);
						if (result2.isEmpty()) {
							log(LogStatus.INFO, "The records have been verified on interaction popup in Acuity",
									YesNo.No);
						} else {
						 ...
						 * ; ele=FindElement(driver, xPath, "All Interaction popup close",
						 * action.SCROLLANDBOOLEAN, 20); if(clickUsingJavaScript(driver, ele,
						 * "close button")) { log(LogStatus.INFO,
						 * "clicked on close button of all Interaction popup", YesNo.No); } else {
						 * log(LogStatus.ERROR,
						 * "Not able to click on close button of all Interaction popup", YesNo.No);
						 * sa.assertTrue(false,
						 * "Not able to click on close button of all Interaction popup"); }
						 */
					} else {
						log(LogStatus.ERROR, "Not able to click on View All button of Interaction section", YesNo.No);
						sa.assertTrue(false, "Not able to click on View All button of Interaction section");
	...
	public void RGATETc021_VerifyEmailTaskInTheFirmAccountContactPage(String projectName) {
		...
		String[] peopleTagedName = { RGATE_TaggedPeople4, RGATE_TaggedPeople5, RGATE_TaggedPeople6,
				RGATE_TaggedPeople7 };
		String[] peopleTaggedTimeReference = { RGATE_TaggedPeopleReferenceCount4, RGATE_TaggedPeopleReferenceCount5,
				RGATE_TaggedPeopleReferenceCount6, RGATE_TaggedPeopleReferenceCount7 };
	...
	public void RGATETc022_CreateAccountDeals(String projectName) {
		...
		for (int i = 0; i < contactLastName.length; i++) {
			if (lp.clickOnTab(projectName, tabObj2)) {
				...
				if (cp.createContact(projectName, contactFirstName[i], contactLastName[i], contactLegalName[i],
						contactEmail[i], "", Fields.Title.toString(), contactTitle[i], CreationPage.ContactPage, null,
						null)) {
					log(LogStatus.INFO,
							"successfully Created Contact : " + contactFirstName[i] + " " + contactLastName[i],
							YesNo.No);
			...
			if (lp.clickOnAlreadyCreated(environment, mode, TabName.DealTab, dealName, 10)) {
				...
				if (BP.clicktabOnPage(TabName.Acuity.toString())) {
					...
					if (BP.InteractionRecord(eventTitle8, 10) != null) {
						log(LogStatus.INFO, "All records on Intraction card have been verified " + eventTitle8,
								YesNo.No);
						ThreadSleep(2000);
						sa.assertTrue(true, "All records on Intraction card have been verified " + eventTitle8);
					} else {
...
//		}
		...
		String startDate8 = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_StartDay10));
		ExcelUtils.writeData(AcuityDataSheetFilePath, startDate8, "Activity Timeline", excelLabel.Variable_Name,
				"RGATE_010", excelLabel.Advance_Start_Date);

		String endDate8 = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
				Integer.parseInt(RGATE_EndDay10));
		ExcelUtils.writeData(AcuityDataSheetFilePath, endDate8, "Activity Timeline", excelLabel.Variable_Name,
		...
		if (lp.clickOnTab(projectName, TabName.InstituitonsTab)) {
			...
			if (lp.clickOnAlreadyCreated(environment, mode, TabName.InstituitonsTab, accountName[2], 10)) {
				...
				if (BP.clicktabOnPage(TabName.Acuity.toString())) {
					...
					ArrayList<String> result1 = BP.verifyRecordOnInteractionCard(advancedDate, IconType.Meeting,
							eventTitle8, details, false, true, null, null);
					if (result1.isEmpty()) {
						log(LogStatus.INFO,
								"The task has been verified on Interaction card. subject name: " + eventTitle8,
								YesNo.No);
					} else {
						log(LogStatus.ERROR, "The task is not verified on Interaction card. subject name: "
								+ eventTitle8 + ". " + result1, YesNo.No);
						sa.assertTrue(false, "The task is not verified on Interaction card. subject name: "
								+ eventTitle8 + ". " + result1);
					}
					...
					for (int i = 0; i < firmsTaggedName.length; i++) {
						...
						if (result5.isEmpty()) {
							...
							if (Integer.parseInt(firmsTaggedTimeReference[i]) > 0) {
								...
								log(LogStatus.ERROR, "Count of firm tagged tim reference is zero, so no need to click",
										YesNo.No);
							}
						} else {
						...
						ArrayList<String> result = BP.verifyRecordAndReferencedTypeOnTagged(null, null,
								peopleTaggedName, peopleTaggedTimeReference, null, null, isInstitutionRecord, null,
								null);
						if (result.isEmpty()) {
							log(LogStatus.INFO, "The record name and Time reference have been verifed", YesNo.No);
							if (Integer.parseInt(peopleTaggedTimeReference[i]) > 0) {
								...
								log(LogStatus.ERROR,
										"Count of people tagged tim reference is zero, so no need to click", YesNo.No);
							}
						} else {
							log(LogStatus.ERROR, "The record name and Time reference are not verifed. " + result5,
									YesNo.Yes);
...
//		}
	...
	public void RGATETc031_UpdateEventDetailsAndVerify(String projectName) {
		...
		if (home.globalSearchAndNavigate(task1SubjectName[2], "Events", false, projectName)) {

			log(LogStatus.INFO, "-----Verified Task named: " + task1SubjectName[2] + " found in Tasks Object-----",
					YesNo.No);

			if (click(driver, BP.editButtonOfSubjectLinkPopUpInInteractionSection(task1SubjectName[2], 20),
				...
				if (BP.updateActivityTimelineRecord(projectName, task1UpdateBasicSection, null, null, null, null, false,
						null, null, null, null, null, null)) {
					log(LogStatus.PASS, "Activity timeline record has been Updated for Task: " + task1SubjectName[2],
							YesNo.No);
				} else {
					log(LogStatus.FAIL, "Activity timeline record has not Updated for task: " + task1SubjectName[2],
							YesNo.No);
					sa.assertTrue(false, "Activity timeline record has not Updated for task: " + task1SubjectName[2]);
				}

			} else {
				log(LogStatus.ERROR,
						"Not able to click on Edit button on Subjec Link Popup of Task: " + task1SubjectName[2],
						YesNo.No);
				sa.assertTrue(false,
						"Not able to click on Edit button on Subjec Link Popup of Task: " + task1SubjectName[2]);
			}
			...
			log(LogStatus.ERROR, "-----Task named: " + task1SubjectName[2] + " not found in Tasks Object-----",
					YesNo.Yes);
			BaseLib.sa.assertTrue(false, "-----Task named: " + task1SubjectName[2] + " not found in Tasks Object-----");
