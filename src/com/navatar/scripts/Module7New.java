...
public class Module7New extends BaseLib {
	...
	public void M7NTc002_CreateEntityAndContact(String projectName) {
		...
		WebElement ele = CommonLib.isDisplayed(driver,
				CommonLib.FindElement(driver, xpath, "Notification close button", action.BOOLEAN, 30), "Visibility", 20,
				"Notifiction close button");

		if (ele != null) {
			click(driver, ele, "Notification close button", action.BOOLEAN);
			ThreadSleep(3000);
			ele = CommonLib.isDisplayed(driver, CommonLib.FindElement(driver, "", "", action.BOOLEAN, 30), "Visibility",
					20, "Notifiction close button");
			if (ele == null) {
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact1EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON1", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact1FName, M7NContact1LName, M7NIns1, M7NContact1EmailID,
					M7NContact1RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact1FName + " " + M7NContact1LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact1FName + " " + M7NContact1LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact1FName + " " + M7NContact1LName,
						YesNo.Yes);
			}
		} else {
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact2EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON2", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact2FName, M7NContact2LName, M7NIns1, M7NContact2EmailID,
					M7NContact2RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact2FName + " " + M7NContact2LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact2FName + " " + M7NContact2LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact2FName + " " + M7NContact2LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact3EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON3", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact3FName, M7NContact3LName, M7NIns1, M7NContact3EmailID,
					M7NContact3RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact3FName + " " + M7NContact3LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact3FName + " " + M7NContact3LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact3FName + " " + M7NContact3LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
	...
	public void M7NTc003_CreateStandardTaskForTomLathamAndVerifyLastTouchpointOnContactDetailPage(String projectName) {
		...
		String[][] basicsection = { { PageLabel.Subject.toString(), task },
				{ PageLabel.Related_To.toString(), contactName } };
		String[][] advanceSection = { { PageLabel.Priority.toString(), "Normal" },
				{ PageLabel.Due_Date.toString(), M7NTask1dueDate }, { PageLabel.Status.toString(), M7NTask1Status } };

		if (bp.createActivityTimeline(projectName, true, "Task", basicsection, advanceSection, null, null, false, null,
	...
	public void M7NTc004_CreateMultiTaggedTaskforContactJamesRoseAndVerifyLastTouchPoint(String projectName) {
		...
		String[][] basicsection = { { PageLabel.Subject.toString(), task },
				{ PageLabel.Related_To.toString(), secondaryContact } };
		String[][] advanceSection = { { PageLabel.Due_Date.toString(), M7NTask2dueDate },
				{ PageLabel.Status.toString(), M7NTask2Status } };

		if (cp.clickOnTab(projectName, tabObj2)) {
			log(LogStatus.INFO, "Clicked on Tab : " + tabObj2 + " For : " + primaryContact, YesNo.No);
			ThreadSleep(1000);
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.ContactTab, primaryContact, 30))
			/* if (cp.clickOnAlreadyCreatedItem(projectName, primaryContact, 30)) */ {
				...
				ThreadSleep(2000);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask2dueDate, "Task1", excelLabel.Variable_Name,
						"M7NTask2", excelLabel.Due_Date);
				///////////////////////

				if (bp.createActivityTimeline(projectName, true, "Task", basicsection, advanceSection, null, null,
		...
		if (cp.clickOnTab(projectName, tabObj2)) {
			...
			ThreadSleep(1000);
			if (bp.clickOnAlreadyCreated_Lighting(environment, mode, TabName.ContactTab, secondaryContact, 30))
	...
	public void M7NTc05_CreatefourNewContactToCheckTheLastTouchPointInCall(String projectName) {
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact4EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON4", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact4FName, M7NContact4LName, M7NIns1, M7NContact4EmailID,
					M7NContact4RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact4FName + " " + M7NContact4LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact4FName + " " + M7NContact4LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact4FName + " " + M7NContact4LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact5EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON5", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact5FName, M7NContact5LName, M7NIns1, M7NContact5EmailID,
					M7NContact5RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact5FName + " " + M7NContact5LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact5FName + " " + M7NContact5LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact5FName + " " + M7NContact5LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact6EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON6", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact6FName, M7NContact6LName, M7NIns1, M7NContact6EmailID,
					M7NContact6RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact6FName + " " + M7NContact6LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact6FName + " " + M7NContact6LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact6FName + " " + M7NContact6LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			log(LogStatus.INFO, "Click on Tab : " + tabObj2, YesNo.No);
			M7NContact6EmailID = lp.generateRandomEmailId(gmailUserName);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact7EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON7", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact7FName, M7NContact7LName, M7NIns1, M7NContact7EmailID,
					M7NContact7RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact7FName + " " + M7NContact7LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact7FName + " " + M7NContact7LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact7FName + " " + M7NContact7LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
	...
	public void M7NTc06_CreatLogACallForContactJhonAleaxVerifyLastTouchpointOnContactDetailPage(String projectName) {
		...
		ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask3dueDate, "Task1", excelLabel.Variable_Name, "M7NTask3",
				excelLabel.Due_Date);

		if (bp.createActivityTimeline(projectName, true, "Call", basicsection, advanceSection, null, null, false, null,
				null, null, null, null, null)) {
			log(LogStatus.INFO, "Able to create Task : " + task, YesNo.No);
			flag = true;
		...
		if (flag) {
				...
				/* if (cp.clickOnAlreadyCreatedItem(projectName, contactName, 30)) */ {
					...
					if (ele != null) {
						...
						if (cp.verifyDate(expectedValue, actualValue)) {
							...
							log(LogStatus.ERROR, "Last touch point value is not matched For : " + contactName
									+ " Actual : " + actualValue + " /t Expected : " + expectedValue, YesNo.Yes);
							sa.assertTrue(false, "last touch point value is not matched For : " + contactName
			...
			log(LogStatus.SKIP, "Not Able to create Task : " + task + " so cannot check last touch point value",
					YesNo.Yes);
		}
	...
	public void M7NTc07_CreateMultiTaggedCallforContactSamanthaRaoAndVerifyLastTouchPoint(String projectName) {
		...
		if (cp.clickOnTab(projectName, tabObj2)) {
			...
			/* if (cp.clickOnAlreadyCreatedItem(projectName, primaryContact, 30)) */ {
				...
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask4dueDate, "Task1", excelLabel.Variable_Name,
						"M7NTask4", excelLabel.Due_Date);
				///////////////////////
				bp.createActivityTimeline(projectName, false, "Call", basicsection, advanceSection, null, null, false,
						null, null, null, null, null, null);
				System.err.println(
						"donnnnnnnnnnneeeeeeeeeeeeeeeeeeeeeeeeeeeeee...................................................................");
			...
			/* if (cp.clickOnAlreadyCreatedItem(projectName, secondaryContact, 30)) */ {
				...
				if (ele != null) {
					...
					if (cp.verifyDate(expectedValue, actualValue)) {
						...
						log(LogStatus.INFO, expectedValue + " successfully verified last touch point date For : "
								+ secondaryContact, YesNo.No);
					} else {
						log(LogStatus.ERROR, "Last touch point value is not matched For : " + secondaryContact
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue, YesNo.Yes);
						sa.assertTrue(false, "last touch point value is not matched For : " + secondaryContact
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue);
					}
				} else {
					log(LogStatus.ERROR, "last touch point value is not visible For : " + secondaryContact, YesNo.Yes);
	...
	public void M7NTc08_CreateMultiTaggedCallforContactJohnAlexaAndVerifyLastTouchPoint(String projectName) {
		...
		if (cp.clickOnTab(projectName, tabObj2)) {
			...
			/* if (cp.clickOnAlreadyCreatedItem(projectName, primaryContact, 30)) */ {
				log(LogStatus.INFO, "Clicked on  : " + primaryContact + " For : " + tabObj2, YesNo.No);
				ThreadSleep(3000);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask5dueDate, "Task1", excelLabel.Variable_Name,
				...
				/* if (cp.clickOnAlreadyCreatedItem(projectName, contactName, 30)) */ {
					...
					if (ele != null) {
						...
						if (cp.verifyDate(expectedValue, actualValue)) {
							...
							log(LogStatus.ERROR, "Last Touch Point should be Blank for " + contactName
									+ " Actual Last Touch Point Date : " + actualValue, YesNo.Yes);
							sa.assertTrue(false, "Last Touch Point should be Blank for " + contactName
									+ " Actual Last Touch Point Date : " + actualValue);
						}
					} else {
						log(LogStatus.ERROR,
								expectedValue + " last touch point value is not visible For : " + contactName,
								YesNo.Yes);
						sa.assertTrue(false,
								expectedValue + " last touch point value is not visible For : " + contactName);
					}
...
//	}	
		...
		if (flag) {
			...
			log(LogStatus.SKIP, "Task is not been deleted so cannot check Last Touch Point for " + contactName,
					YesNo.Yes);
		}
			...
			/* if (cp.clickOnAlreadyCreatedItem(projectName, secondaryContact, 30)) */ {
				...
				if (ele != null) {
					...
					if (cp.verifyDate(expectedValue1, actualValue1)) {
						log(LogStatus.INFO, expectedValue1 + " successfully verified last touch point date For : "
								+ secondaryContact, YesNo.No);
					} else {
						log(LogStatus.ERROR, "Last touch point value is not matched For : " + secondaryContact
								+ " Actual : " + actualValue1 + " /t Expected : " + expectedValue1, YesNo.Yes);
						sa.assertTrue(false, "last touch point value is not matched For : " + secondaryContact
								+ " Actual : " + actualValue1 + " /t Expected : " + expectedValue1);
					}
				} else {
					log(LogStatus.ERROR, "last touch point value is not visible For : " + secondaryContact, YesNo.Yes);
					sa.assertTrue(false, "last touch point value is not visible For : " + secondaryContact);
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc011_RestoreTheDeletedTaskMATouchpointCall_1AndVerifyTheImpactOnLastTouchPointInContactPage(
			String projectName) {
		...
		if (flag) {
			...
			log(LogStatus.SKIP, "Task is not been restored so cannot check Last Touch Point for " + contactName,
					YesNo.Yes);
		}
	...
	public void M7NTc012_CreateEntityAndContact(String projectName) {
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact8EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON8", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact8FName, M7NContact8LName, M7NIns1, M7NContact8EmailID,
					M7NContact8RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact8FName + " " + M7NContact8LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact8FName + " " + M7NContact8LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact8FName + " " + M7NContact8LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact9EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON9", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact9FName, M7NContact9LName, M7NIns1, M7NContact9EmailID,
					M7NContact9RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact9FName + " " + M7NContact9LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact9FName + " " + M7NContact9LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact9FName + " " + M7NContact9LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact10EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON10", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact10FName, M7NContact10LName, M7NIns1, M7NContact10EmailID,
					M7NContact10RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact10FName + " " + M7NContact10LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact10FName + " " + M7NContact10LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact10FName + " " + M7NContact10LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact11EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON11", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact11FName, M7NContact11LName, M7NIns1, M7NContact11EmailID,
					M7NContact11RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact11FName + " " + M7NContact11LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact11FName + " " + M7NContact11LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact11FName + " " + M7NContact11LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
	...
	public void M7NTc013_CreateEventForEllieVokesAndVerifyLastTouchpointOnContactDetailPage(String projectName) {
		...
		if (lp.clickAnyCellonCalender(projectName)) {
			...
			gp.enterValueForTask(projectName, PageName.Object2Page, event1, 20);
			flag = lp.selectRelatedAssociationOrContactOrRelatedToDropDownAndClickOnItem(projectName, PageName.TaskPage,
					PageLabel.Related_To.toString(), TabName.Object1Tab, relatedValue, action.SCROLLANDBOOLEAN, 10);
			if (flag) {
				log(LogStatus.INFO, "Selected " + relatedValue + " For Label " + PageLabel.Related_Associations,
						YesNo.No);

			} else {
				sa.assertTrue(false,
						"Not Able to Select " + relatedValue + " For Label " + PageLabel.Related_Associations);
				log(LogStatus.SKIP,
						"Not Able to Select " + relatedValue + " For Label " + PageLabel.Related_Associations,
						YesNo.Yes);
			...
			if (clickUsingJavaScript(driver, gp.getEventSaveBtn(10), "Save Button", action.SCROLLANDBOOLEAN)) {
				log(LogStatus.INFO, "Click on Save Button For Task : " + task, YesNo.No);
				ThreadSleep(10000);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent1StartDate, "Events", excelLabel.Variable_Name,
		...
		if (flag) {
			if (cp.clickOnTab(projectName, tabObj2)) {
				...
				if (cp.clickOnAlreadyCreatedItem(projectName, primaryContact, 30)) {
					...
					if (ele != null) {
						...
						log(LogStatus.ERROR,
								expectedValue + " last touch point value is not visible For : " + primaryContact,
								YesNo.Yes);
						sa.assertTrue(false,
								expectedValue + " last touch point value is not visible For : " + primaryContact);
					}
			...
			log(LogStatus.SKIP, "Event is not created so cannot check Last Touch Point for " + primaryContact,
					YesNo.Yes);
		}
		switchToDefaultContent(driver);
		lp.CRMlogout();
	...
	public void M7NTc014_CreateEventfromCalendarforContactJohrYathamAndVerifyLastTouchPoint(String projectName) {
		...
		String[][] Event2 = { { PageLabel.Subject.toString(), task }, { PageLabel.Name.toString(), primaryContact },
		...
		if (lp.clickAnyCellonCalender(projectName)) {
			...
			if (clickUsingJavaScript(driver, gp.getEventSaveBtn(10), "Save Button", action.SCROLLANDBOOLEAN)) {
				log(LogStatus.INFO, "Click on Save Button For Task : " + task, YesNo.No);
				ThreadSleep(10000);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent2StartDate, "Events", excelLabel.Variable_Name,
						"M7NEvent2", excelLabel.Start_Date);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent2EndDate, "Events", excelLabel.Variable_Name,
		...
		if (flag) {
				...
				if (cp.clickOnTab(projectName, tabObj2)) {
					...
					if (cp.clickOnAlreadyCreatedItem(projectName, contactName, 30)) {
						...
						if (ele != null) {
							actualValue = ele.getText().trim();
							if (cp.verifyDate(expectedValue, actualValue)) {
								log(LogStatus.INFO, expectedValue
										+ " successfully verified last touch point date For : " + contactName,
										YesNo.No);
							} else {
								log(LogStatus.ERROR, "Last touch point value is not matched For : " + contactName
										+ " Actual : " + actualValue + " /t Expected : " + expectedValue, YesNo.Yes);
			...
			log(LogStatus.SKIP, "Task is not been created so cannot check Last Touch Point for " + contactName,
					YesNo.Yes);
		}
		switchToDefaultContent(driver);
		lp.CRMlogout();
	...
	public void M7NTc015_CreateEventfromCalendarforContactEllieVokesAndVerifyLastTouchPoint(String projectName) {
		...
		String[][] Event3 = { { PageLabel.Subject.toString(), task },
				...
				{ PageLabel.End_Date.toString(), M7NEvent3EndDate }, { PageLabel.Name.toString(), primaryContact },
				{ PageLabel.Name.toString(), secondaryContact } };

		if (lp.clickAnyCellonCalender(projectName)) {
			log(LogStatus.INFO, "Able to click on Calendar/Event Link", YesNo.No);
			gp.enterValueForNewEvent(projectName, GlobalActionItem.New_Event, Event3, 10);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent3StartDate, "Events", excelLabel.Variable_Name,
	...
	public void M7NTc016_ModifyTheEndDateAndVerifyTheImpactOnTheLastTouchPointDate(String projectName) {
		...
		if (home.globalSearchAndEditTaskorCall(task, "Events", false)) {
			...
			if (sendKeys(driver, gp.getLabelTextBoxForGobalAction(projectName, GlobalActionItem.New_Event,
				...
				if (sendKeys(driver, gp.getLabelTextBoxForGobalAction(projectName, GlobalActionItem.New_Event,
					...
					ThreadSleep(2000);
					if (clickUsingJavaScript(driver, gp.getEditEventSaveBtn(10), "Save Button",
							action.SCROLLANDBOOLEAN)) {
						log(LogStatus.INFO, "Click on Save Button For Event : " + task, YesNo.No);
						ThreadSleep(10000);
						ThreadSleep(5000);
						ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent3EndDate, "Events",
								excelLabel.Variable_Name, "M7NEvent3", excelLabel.End_Date);
						flag = true;
					} else {
		...
		if (flag) {
			...
			log(LogStatus.SKIP, "Event is not been updated so cannot check Last Touch Point for " + contactName,
					YesNo.Yes);
		}
		switchToDefaultContent(driver);
		lp.CRMlogout();
	...
	public void M7NTc017_DeleteMATouchpointEvent_1AndVerifyImpactOnLastTouchPointOnContactPage(String projectName) {
		...
		if (flag) {
			...
			log(LogStatus.SKIP, "Event is not been deleted so cannot check Last Touch Point for " + contactName,
					YesNo.Yes);
		}
		switchToDefaultContent(driver);
		lp.CRMlogout();
...
//							action.BOOLEAN, 30);
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc020_RestoreTheDeletedTaskMATouchpointEvent_1AndVerifyTheImpactOnLastTouchPointInContactPage(
			String projectName) {
		...
		WebElement ele;
		boolean flag = false;
		String restoreItem = M7NEvent1Subject;
		...
		if (flag) {
			...
			log(LogStatus.SKIP, "Event is not been restored so cannot check Last Touch Point for " + contactName,
					YesNo.Yes);
		}
			...
			if (cp.clickOnTab(projectName, tabObj2)) {
				...
				if (cp.clickOnAlreadyCreatedItem(projectName, contactName, 30)) {
					...
					if (ele != null) {
						...
						log(LogStatus.ERROR, "last touch point value is not visible For : " + primaryContact,
								YesNo.Yes);
						sa.assertTrue(false, "last touch point value is not visible For : " + primaryContact);
					}
				} else {
	...
	public void M7NTc022_CreateNewEventToVerifyTheFutureDateInLastTouchPointDate(String projectName) {
		...
		String[][] Event4 = { { PageLabel.Subject.toString(), task },
				...
				{ PageLabel.End_Date.toString(), M7NEvent4EndDate }, { PageLabel.Name.toString(), primaryContact },
				{ PageLabel.Name.toString(), secondaryContact } };
		...
		if (lp.clickAnyCellonCalender(projectName)) {
			...
			if (clickUsingJavaScript(driver, gp.getEventSaveBtn(10), "Save Button", action.SCROLLANDBOOLEAN)) {
				...
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent4EndDate, "Events", excelLabel.Variable_Name,
		...
		if (home.globalSearchAndEditTaskorCall(task, "Events", false)) {
			...
			if (sendKeys(driver, gp.getLabelTextBoxForGobalAction(projectName, GlobalActionItem.New_Event,
				...
				if (clickUsingJavaScript(driver, lp.getEditEventSaveBtn(20), "save", action.SCROLLANDBOOLEAN)) {
					log(LogStatus.INFO, "successfully Updated task : " + task, YesNo.No);
					ThreadSleep(5000);
					ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent4StartDate, "Events",
							excelLabel.Variable_Name, "M7NEvent4", excelLabel.Start_Date);
					flag = true;
	...
	public void M7NTc024_CreateNewEventToVerifyAllDayEvent(String projectName) {
		...
		M7NEvent5StartDate = todaysDate;
		String task = M7NEvent5Subject;
		String[][] Event5 = { { PageLabel.Subject.toString(), task }, { PageLabel.Name.toString(), primaryContact },
				{ PageLabel.Related_To.toString(), M7Ins1 }, { PageLabel.All_Day_Event.toString(), "true" } };

		if (lp.clickAnyCellonCalender(projectName)) {
			log(LogStatus.INFO, "Able to click on Calendar/Event Link", YesNo.No);
			gp.enterValueForTask(projectName, PageName.Object2Page, Event5, 20);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent5StartDate, "Events", excelLabel.Variable_Name,
		...
		if (flag) {
				...
				if (cp.clickOnAlreadyCreatedItem(projectName, primaryContact, 30)) {
					...
					if (ele != null) {
						...
						if (value.isEmpty() || value.equals("")) {
							...
							log(LogStatus.ERROR, "Last Touch Point should be Blank for " + primaryContact
									+ " Actual Last Touch Point Date : " + value, YesNo.Yes);
							sa.assertTrue(false, "Last Touch Point should be Blank for " + primaryContact
									+ " Actual Last Touch Point Date : " + value);
						}
					} else {
						log(LogStatus.ERROR, "last touch point value is not visible For : " + primaryContact,
								YesNo.Yes);
			...
			log(LogStatus.SKIP, "Call is not created so cannot check Last Touch Point for " + primaryContact,
					YesNo.Yes);
		}
		switchToDefaultContent(driver);
		lp.CRMlogout();
	...
	public void M7NTc026_1_VerifytheLasttouchpointOnContactWhenCallIsCreated(String projectName) {
		...
		String[][] basicsection = { { PageLabel.Subject.toString(), task },
				{ PageLabel.Related_To.toString(), primaryContact } };
		String[][] advanceSection = { { PageLabel.Date.toString(), M7NTask6dueDate } };

		ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask6dueDate, "Task1", excelLabel.Variable_Name, "M7NTask6",
				excelLabel.Due_Date);
	...
	public void M7NTc026_2_VerifytheLasttouchpointOnContactWhenEventIsCreated(String projectName) {
		...
		String[][] Event6 = { { PageLabel.Subject.toString(), task },
				...
				{ PageLabel.End_Date.toString(), M7NEvent6EndDate }, { PageLabel.Name.toString(), primaryContact } };

		if (lp.clickAnyCellonCalender(projectName)) {
			log(LogStatus.INFO, "Able to click on Calendar/Event Link", YesNo.No);
			gp.enterValueForTask(projectName, PageName.Object2Page, Event6, 20);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent6StartDate, "Events", excelLabel.Variable_Name,
					"M7NEvent6", excelLabel.Start_Date);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent6EndDate, "Events", excelLabel.Variable_Name,
	...
	public void M7NTc027_DeleteTheCreatedCallAndVerifyTheImpactOnLastTouchPointInContactPage(String projectName) {
		...
		if (flag) {
			...
			log(LogStatus.SKIP, "Call is not been deleted so cannot check Last Touch Point for " + contactName,
					YesNo.Yes);
		}
		switchToDefaultContent(driver);
		lp.CRMlogout();
	...
	public void M7NTc029_VerifytheErrormessageOnContactWhenEventIsCreated(String projectName) {
		...
		String[][] Event6 = { { PageLabel.Subject.toString(), task },
				...
				{ PageLabel.End_Date.toString(), M7NEvent7EndDate }, { PageLabel.Name.toString(), primaryContact } };

		if (lp.clickAnyCellonCalender(projectName)) {
			log(LogStatus.INFO, "Able to click on Calendar/Event Link", YesNo.No);
			gp.enterValueForTask(projectName, PageName.Object2Page, Event6, 20);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent7StartDate, "Events", excelLabel.Variable_Name,
					"M7NEvent7", excelLabel.Start_Date);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent7EndDate, "Events", excelLabel.Variable_Name,
	...
	public void M7NTc030_CreateacontactwithouttaskandupdatetheTierafterupgrade(String projectName) {
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NContact12EmailID, "Contacts", excelLabel.Variable_Name,
					"M7NCON12", excelLabel.Contact_EmailId);
			if (cp.createContact(projectName, M7NContact12FName, M7NContact12LName, M7NIns2, M7NContact12EmailID,
					M7NContact12RecordType, null, null, CreationPage.ContactPage, null, null)) {
				log(LogStatus.INFO, "successfully Created Contact : " + M7NContact12FName + " " + M7NContact12LName,
						YesNo.No);
			} else {
				sa.assertTrue(false, "Not Able to Create Contact : " + M7NContact12FName + " " + M7NContact12LName);
				log(LogStatus.SKIP, "Not Able to Create Contact: " + M7NContact12FName + " " + M7NContact12LName,
						YesNo.Yes);
			}
		} else {
			sa.assertTrue(false, "Not Able to Click on Tab : " + tabObj2);
		...
		if (cp.clickOnTab(projectName, tabObj2)) {
			...
			if (cp.clickOnAlreadyCreatedItem(projectName, contactName, 30)) {
				...
				if (cp.UpdateContactTier(projectName, PageName.ContactPage, "1")) {
					log(LogStatus.INFO, "successfully updated Contact Tier :" + value + " of record type :" + type,
							YesNo.No);
				} else {
					sa.assertTrue(false, "Not Able to updated Contact Tier : " + value + " of record type : " + type);
					log(LogStatus.SKIP, "Not Able to updated Contact Tier : " + value + " of record type : " + type,
							YesNo.Yes);
				}
			} else {
				sa.assertTrue(false, "Item Not Found : " + contactName + " For : " + tabObj2);
		...
		if (cp.verifyDate(expectedDate, actualDate)) {
			log(LogStatus.INFO, "Next touch point value is matched As after " + days + " days from created date  in :"
					+ contactName, YesNo.No);

		} else {
			sa.assertTrue(false, "Next touch point value is not matched As after " + days
					+ " days from created date  in contact :" + contactName);
	...
	public void M7NTc031_CreatePreConditionData(String projectName) {
		...
		String[][] contactData = { { M7NContact13FName, M7NContact13LName, M7NIns3 },
				{ M7NContact14FName, M7NContact14LName, M7NIns3 }, { M7NContact15FName, M7NContact15LName, M7NIns3 },
				{ M7NContact16FName, M7NContact16LName, M7NIns2 }, { M7NContact17FName, M7NContact17LName, M7NIns4 },
				{ M7NContact18FName, M7NContact18LName, M7NIns4 }, { M7NContact19FName, M7NContact19LName, M7NIns4 },
				{ M7NContact20FName, M7NContact20LName, M7NIns4 }, { M7NContact21FName, M7NContact21LName, M7NIns4 },
				{ M7NContact22FName, M7NContact22LName, M7NIns4 }, { M7NContact23FName, M7NContact23LName, M7NIns4 },
				{ M7NContact24FName, M7NContact24LName, M7NIns4 }, { M7NContact25FName, M7NContact25LName, M7NIns4 },
				{ M7NContact26FName, M7NContact26LName, M7NIns4 }, { M7NContact27FName, M7NContact27LName, M7NIns4 }, };
		...
		for (String[] data : contactData) {
			...
			if (lp.clickOnTab(projectName, tabObj2)) {
				...
				ExcelUtils.writeData(phase1DataSheetFilePath, email, "Contacts", excelLabel.Variable_Name,
						"M7NCON" + (i + 13), excelLabel.Contact_EmailId);
				if (cp.createContact(projectName, data[0], data[1], data[2], email, "", null, null,
	...
	public void M7NTc032_CreateacontactCallandupdatetheNameafterupgrade(String projectName) {
		...
		ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask8dueDate, "Task1", excelLabel.Variable_Name, "M7NTask8",
				excelLabel.Due_Date);
...
//			}
	...
	public void M7NTc033_CreateaContactwithEventandUpdatetheEndDateAfterUpgrade(String projectName) {
		...
		String[][] Event4 = { { PageLabel.Subject.toString(), task },
				...
				{ PageLabel.End_Date.toString(), M7NEvent8EndDate }, { PageLabel.Name.toString(), primaryContact } };

		if (lp.clickAnyCellonCalender(projectName)) {
			log(LogStatus.INFO, "Able to click on Calendar/Event Link", YesNo.No);
			gp.enterValueForTask(projectName, PageName.Object2Page, Event4, 20);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent8StartDate, "Events", excelLabel.Variable_Name,
	...
	public void M7NTc034_CreateContactWithoutCallAndCreateTheTaskAfterUpgradeTier(String projectName) {
		...
		ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask9dueDate, "Task1", excelLabel.Variable_Name, "M7NTask9",
				excelLabel.Due_Date);
			...
			if (cp.clickOnAlreadyCreatedItem(projectName, contactName, 30)) {
				...
				if (cp.UpdateContactTier(projectName, PageName.ContactPage, tier)) {
					if (cp.UpdateContactTier(projectName, PageName.ContactPage, tier)) {
						...
						String lastTouchPoint = cp.getlastTouchPointValue(projectName, 30).getText();
						if (lastTouchPoint.contains("") || lastTouchPoint.equalsIgnoreCase("")) {
							log(LogStatus.INFO, "Last touch point value is matched As blank in :" + contactName,
									YesNo.No);

						} else {
							sa.assertTrue(false,
									"Last touch point value is not matched As blank in contact :" + contactName);
							log(LogStatus.SKIP,
									"Last touch point value is not matched As blank in contact :" + contactName,
									YesNo.Yes);
						}
						...
						String expectedDate1 = previousOrForwardDateAccordingToTimeZone(days1, "M/dd/yyyy",
								"America/Los_Angles");
						if (cp.verifyDate(expectedDate1, actualDate1)) {
							log(LogStatus.INFO, "Next touch point value is matched As after " + days1
									+ " days from created date  in :" + contactName, YesNo.No);

						} else {
							sa.assertTrue(false, "Next touch point value is not matched As after " + days1
									+ " days from created date  in contact :" + contactName);
							log(LogStatus.SKIP, "Next touch point value is not matched As after " + days1
									+ " days from created date  in contact :" + contactName, YesNo.Yes);
						}
					} else {
	...
	public void M7NTc035_UpdateRossGellerContactwithEventandUpdatetheEndDateAfterUpgrade(String projectName) {
		...
		String[][] Event4 = { { PageLabel.Subject.toString(), task },
				...
				{ PageLabel.End_Date.toString(), M7NEvent9EndDate }, { PageLabel.Name.toString(), primaryContact } };

		if (lp.clickAnyCellonCalender(projectName)) {
			log(LogStatus.INFO, "Able to click on Calendar/Event Link", YesNo.No);
			gp.enterValueForTask(projectName, PageName.Object2Page, Event4, 20);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent9StartDate, "Events", excelLabel.Variable_Name,
					"M7NEvent9", excelLabel.Start_Date);
			ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent9EndDate, "Events", excelLabel.Variable_Name,
			...
			if (lp.clickOnAlreadyCreatedItem(projectName, TabName.ContactTab, contactName, 30)) {
				...
				if (cp.UpdateContactTier(projectName, PageName.ContactPage, tier)) {
					...
					if (lastTouchPoint.contains("") || lastTouchPoint.equalsIgnoreCase("")) {
						...
						sa.assertTrue(false,
								"Last touch point value is not matched As blank in contact :" + contactName);
						log(LogStatus.SKIP, "Last touch point value is not matched As blank in contact :" + contactName,
								YesNo.Yes);
					}

					int days = 90;
					String actualDate = cp.getNextTouchPointDateValue(projectName, 30).getText();
					String expectedDate = previousOrForwardDateAccordingToTimeZone(days, "M/dd/yyyy",
							"America/Los_Angles");
					if (cp.verifyDate(expectedDate, actualDate)) {
						log(LogStatus.INFO, "Next touch point value is matched As after " + days
								+ " days from created date  in :" + contactName, YesNo.No);
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc038_WisselyStingContactWithoutTierandVerifyLastTouchPointandNextTouchPointDate(
			String projectName) {
		LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
		ContactsPageBusinessLayer cp = new ContactsPageBusinessLayer(driver);
		BasePageBusinessLayer bp = new BasePageBusinessLayer(driver);
	...
	public void M7NTc039_WisselyStingContactWithCallandVerifyLastTouchPointandNextTouchPointDate(String projectName) {
		...
		ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask10dueDate, "Task1", excelLabel.Variable_Name, "M7NTask10",
				excelLabel.Due_Date);
				...
				if (cp.clickOnTab(projectName, tabObj2)) {
					...
					if (cp.clickOnAlreadyCreatedItem(projectName, contactName, 30)) {
						...
						if (cp.UpdateLegalName(projectName, PageName.ContactPage, legalName)) {
							log(LogStatus.INFO,
									"successfully updated Contact Account :" + value + " of record type :" + type,
									YesNo.No);
							ExcelUtils.writeData(phase1DataSheetFilePath, "Contacts", excelLabel.Variable_Name,
									"M7NCON19", excelLabel.Record_Type);
						} else {
							sa.assertTrue(false,
									"Not Able to updated Contact Account : " + value + " of record type : " + type);
							log(LogStatus.SKIP,
									"Not Able to updated Contact Account : " + value + " of record type : " + type,
									YesNo.Yes);
						}
		...
		if (lp.clickOnTab(contactName, mode, TabName.ContactTab)) {
			...
			if (lp.clickOnAlreadyCreatedItem(projectName, TabName.ContactTab, contactName, 30)) {
				...
				if (cp.UpdateContactTier(projectName, PageName.ContactPage, tier)) {
					...
					int days = 90;
					String actualDate = cp.getNextTouchPointDateValue(projectName, 30).getText();
					String expectedDate = previousOrForwardDateAccordingToTimeZone(days, "M/d/yyyy",
							"America/Los_Angles");
					if (cp.verifyDate(expectedDate, actualDate)) {
						log(LogStatus.INFO, "Next touch point value is matched As after " + days
								+ " days from created date  in :" + contactName, YesNo.No);
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc042_EllinaBingContactWithUpdateCallandVerifyLastTouchPointandNextTouchPointDate(
			String projectName) {
		LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
		ContactsPageBusinessLayer cp = new ContactsPageBusinessLayer(driver);
		BasePageBusinessLayer bp = new BasePageBusinessLayer(driver);
		...
		if (home.globalSearchAndNavigate(task, "Tasks", false, projectName)) {

			log(LogStatus.INFO, "-----Verified Event named: " + task + " found and Edit in Event Object-----",
					YesNo.No);
			if (clickUsingJavaScript(driver, bp.editButtonOfSubjectLinkPopUpInInteractionSection(M7NTask11Subject, 20),
					"Edit Note Button of: " + M7NTask11Subject, action.SCROLLANDBOOLEAN)) {
				log(LogStatus.INFO, "clicked on Edit button on Subject Link Popup", YesNo.No);
				bp.updateActivityTimelineRecord(projectName, basicsection, advanceSection, null, null, null, false,
						null, null, null, null, null, null);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NTask11dueDate, "Task1", excelLabel.Variable_Name,
				...
				log(LogStatus.ERROR,
						"Not able to click on Edit button on Subject Link Popup of Task: " + M7NTask11Subject,
						YesNo.No);
				sa.assertTrue(false,
						"Not able to click on Edit button on Subject Link Popup of Task: " + M7NTask11Subject);
			}
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc043_EllinaBingContactWithUpdateEventandVerifyLastTouchPointandNextTouchPointDate(
			String projectName) {
		GlobalActionPageBusinessLayer gp = new GlobalActionPageBusinessLayer(driver);
		LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
		ContactsPageBusinessLayer cp = new ContactsPageBusinessLayer(driver);
		...
		if (lp.clickAnyCellonCalender(projectName)) {
			...
			if (clickUsingJavaScript(driver, gp.getEventSaveBtn(10), "Save Button", action.SCROLLANDBOOLEAN)) {
				log(LogStatus.INFO, "Click on Save Button For Task : " + task, YesNo.No);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent10StartDate, "Events", excelLabel.Variable_Name,
						"M7NEvent10", excelLabel.Start_Date);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent10EndDate, "Events", excelLabel.Variable_Name,
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc044_EllinaBingContactWithUpdateEventWithUpdateEndDateandVerifyLastTouchPointandNextTouchPointDate(
			String projectName) {
		GlobalActionPageBusinessLayer gp = new GlobalActionPageBusinessLayer(driver);
		LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
		ContactsPageBusinessLayer cp = new ContactsPageBusinessLayer(driver);
		...
		if (lp.clickAnyCellonCalender(projectName)) {
			...
			if (clickUsingJavaScript(driver, gp.getEventSaveBtn(10), "Save Button", action.SCROLLANDBOOLEAN)) {
				log(LogStatus.INFO, "Click on Save Button For Task : " + task, YesNo.No);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent11StartDate, "Events", excelLabel.Variable_Name,
						"M7NEvent11", excelLabel.Start_Date);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent11EndDate, "Events", excelLabel.Variable_Name,
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc048_RestoreTheDeletedTaskEvent1AndVerifyVerifyLastTouchPointandNextTouchPointDate(
			String projectName) {
			...
			if (lp.clickOnAlreadyCreatedItem(projectName, TabName.ContactTab, contactName1, 30)) {
				...
				if (cp.UpdateContactTier(projectName, PageName.ContactPage, tier1)) {
					...
					if (lastTouchPoint.contains("") || lastTouchPoint.equalsIgnoreCase("")) {
						...
						sa.assertTrue(false,
								"Last touch point value is not matched As blank in contact :" + contactName1);
						log(LogStatus.SKIP,
								"Last touch point value is not matched As blank in contact :" + contactName1,
								YesNo.Yes);
					}
					...
					if (cp.verifyDate(expectedDate, actualDate)) {
						log(LogStatus.INFO, "Next touch point value is matched As after " + days
								+ " days from created date  in :" + contactName1, YesNo.No);

					} else {
						sa.assertTrue(false, "Next touch point value is not matched As after " + days
								+ " days from created date  in contact :" + contactName1);
						log(LogStatus.SKIP, "Next touch point value is not matched As after " + days
								+ " days from created date  in contact :" + contactName1, YesNo.Yes);
					}
				} else {
			...
			if (lp.clickOnAlreadyCreatedItem(projectName, TabName.ContactTab, contactName2, 30)) {
				...
				if (cp.UpdateContactTier(projectName, PageName.ContactPage, tier2)) {
					...
					if (lastTouchPoint.contains("") || lastTouchPoint.equalsIgnoreCase("")) {
						...
						sa.assertTrue(false,
								"Last touch point value is not matched As blank in contact :" + contactName2);
						log(LogStatus.SKIP,
								"Last touch point value is not matched As blank in contact :" + contactName2,
								YesNo.Yes);
					}
					...
					if (cp.verifyDate(expectedDate, actualDate)) {
						log(LogStatus.INFO, "Next touch point value is matched As after " + days
								+ " days from created date  in :" + contactName2, YesNo.No);

					} else {
						sa.assertTrue(false, "Next touch point value is not matched As after " + days
								+ " days from created date  in contact :" + contactName2);
						log(LogStatus.SKIP, "Next touch point value is not matched As after " + days
								+ " days from created date  in contact :" + contactName2, YesNo.Yes);
					}
				} else {
		...
		if (lp.clickOnTab(contactName, mode, TabName.ContactTab)) {
			...
			if (lp.clickOnAlreadyCreatedItem(projectName, TabName.ContactTab, contactName3, 30)) {
				...
				if (lastTouchPoint.contains("") || lastTouchPoint.equalsIgnoreCase("")) {
					...
					log(LogStatus.SKIP, "Last touch point value is not matched As blank in contact :" + contactName3,
							YesNo.Yes);
				}
				...
				if (cp.verifyDate(expectedDate, actualDate)) {
					log(LogStatus.INFO, "Next touch point value is matched As after " + days
							+ " days from created date  in :" + contactName3, YesNo.No);

				} else {
					sa.assertTrue(false, "Next touch point value is not matched As after " + days
							+ " days from created date  in contact :" + contactName3);
					log(LogStatus.SKIP, "Next touch point value is not matched As after " + days
							+ " days from created date  in contact :" + contactName3, YesNo.Yes);
				}
			} else {
	...
	public void M7NTc049_2_Update4contactswithEventAndVerifyVerifyLastTouchPointandNextTouchPointDate(
		...
		String[][] Event4 = { { PageLabel.Subject.toString(), task },
				...
				{ PageLabel.End_Date.toString(), M7NEvent12EndDate }, { PageLabel.Name.toString(), contactName },
				{ PageLabel.Name.toString(), contactName1 }, { PageLabel.Name.toString(), contactName2 },
			...
			if (cp.clickOnAlreadyCreatedItem(projectName, contactName4, 30)) {
				...
				if (ele != null) {
					...
					if (cp.verifyDate(expectedValue, actualValue)) {
						...
						log(LogStatus.ERROR, "Last touch point value is not matched For : " + contactName4
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue, YesNo.Yes);
						sa.assertTrue(false, "last touch point value is not matched For : " + contactName4
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue);
					}
				} else {
		...
		if (cp.clickOnTab(projectName, tabObj2)) {
			...
			if (cp.clickOnAlreadyCreatedItem(projectName, contactName5, 30)) {
				...
				if (ele != null) {
					...
					if (cp.verifyDate(expectedValue, actualValue)) {
						log(LogStatus.INFO,
								expectedValue + " successfully verified last touch point date For : " + contactName5,
								YesNo.No);
					} else {
						log(LogStatus.ERROR, "Last touch point value is not matched For : " + contactName5
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue, YesNo.Yes);
						sa.assertTrue(false, "last touch point value is not matched For : " + contactName5
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue);
					}
				} else {
		...
		if (cp.verifyDate(expectedDate1, actualDate1)) {
			log(LogStatus.INFO, "Next touch point value is matched As after " + days1 + " days from created date  in :"
					+ contactName5, YesNo.No);

		} else {
			sa.assertTrue(false, "Next touch point value is not matched As after " + days1
					+ " days from created date  in contact :" + contactName5);
			log(LogStatus.SKIP, "Next touch point value is not matched As after " + days1
					+ " days from created date  in contact :" + contactName, YesNo.Yes);
		}
		refresh(driver);
		...
		if (cp.clickOnTab(projectName, tabObj2)) {
			...
			if (cp.clickOnAlreadyCreatedItem(projectName, contactName6, 30)) {
				...
				if (ele != null) {
					...
					if (cp.verifyDate(expectedValue, actualValue)) {
						log(LogStatus.INFO,
								expectedValue + " successfully verified last touch point date For : " + contactName6,
								YesNo.No);
					} else {
						log(LogStatus.ERROR, "Last touch point value is not matched For : " + contactName6
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue, YesNo.Yes);
						sa.assertTrue(false, "last touch point value is not matched For : " + contactName6
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue);
					}
				} else {
		...
		if (cp.verifyDate(expectedDate2, actualDate2)) {
			log(LogStatus.INFO, "Next touch point value is matched As after " + days2 + " days from created date  in :"
					+ contactName6, YesNo.No);

		} else {
			sa.assertTrue(false, "Next touch point value is not matched As after " + days2
					+ " days from created date  in contact :" + contactName6);
			log(LogStatus.SKIP, "Next touch point value is not matched As after " + days2
					+ " days from created date  in contact :" + contactName6, YesNo.Yes);
		}
		refresh(driver);
		ThreadSleep(5000);
		...
		if (cp.clickOnTab(projectName, tabObj2)) {
			...
			if (cp.clickOnAlreadyCreatedItem(projectName, contactName7, 30)) {
				...
				if (ele != null) {
					...
					if (cp.verifyDate(expectedValue, actualValue)) {
						log(LogStatus.INFO,
								expectedValue + " successfully verified last touch point date For : " + contactName7,
								YesNo.No);
					} else {
						log(LogStatus.ERROR, "Last touch point value is not matched For : " + contactName7
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue, YesNo.Yes);
						sa.assertTrue(false, "last touch point value is not matched For : " + contactName7
								+ " Actual : " + actualValue + " /t Expected : " + expectedValue);
					}
				} else {
		...
		if (cp.verifyDate(expectedDate3, actualDate3)) {
			log(LogStatus.INFO, "Next touch point value is matched As after " + days3 + " days from created date  in :"
					+ contactName7, YesNo.No);

		} else {
			sa.assertTrue(false, "Next touch point value is not matched As after " + days3
					+ " days from created date  in contact :" + contactName7);
			log(LogStatus.SKIP, "Next touch point value is not matched As after " + days3
					+ " days from created date  in contact :" + contactName7, YesNo.Yes);
		}
		switchToDefaultContent(driver);
		lp.CRMlogout();
		sa.assertAll();
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc050_Updatecontactswithtier12AndVerifyVerifyLastTouchPointandNextTouchPointDate(
			String projectName) {
		LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
		ContactsPageBusinessLayer cp = new ContactsPageBusinessLayer(driver);
		BasePageBusinessLayer bp = new BasePageBusinessLayer(driver);
	...
	@Parameters({ "projectName" })
	@Test
	public void M7NTc051_UpdatecontactROBERTswithtier3AndVerifyVerifyLastTouchPointandNextTouchPointDate(
			String projectName) {
		LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
		ContactsPageBusinessLayer cp = new ContactsPageBusinessLayer(driver);
		BasePageBusinessLayer bp = new BasePageBusinessLayer(driver);
	...
	public void M7NTc052_2_UpdateJamesContactswithEventandAndVerifyVerifyLastTouchPointandNextTouchPointDate(
		...
		String[][] Event4 = { { PageLabel.Start_Date.toString(), M7NEvent13StartDate },
				{ PageLabel.End_Date.toString(), M7NEvent13EndDate }, { PageLabel.Subject.toString(), task } };
		...
		if (lp.clickAnyCellonCalender(projectName)) {
			...
			if (clickUsingJavaScript(driver, gp.getEventSaveBtn(10), "Save Button", action.SCROLLANDBOOLEAN)) {
				log(LogStatus.INFO, "Click on Save Button For Task : " + task, YesNo.No);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent13StartDate, "Events", excelLabel.Variable_Name,
						"M7NEvent13", excelLabel.Start_Date);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent13EndDate, "Events", excelLabel.Variable_Name,
	...
	public void M7NTc053_2_UpdateTerryContactswithEventandAndVerifyVerifyLastTouchPointandNextTouchPointDate(
		...
		String[][] Event4 = { { PageLabel.Subject.toString(), task },
				...
				{ PageLabel.End_Date.toString(), M7NEvent14EndDate }, { PageLabel.All_Day_Event.toString(), "true" } };
		...
		if (lp.clickAnyCellonCalender(projectName)) {
			...
			if (clickUsingJavaScript(driver, gp.getEventSaveBtn(10), "Save Button", action.SCROLLANDBOOLEAN)) {
				log(LogStatus.INFO, "Click on Save Button For Task : " + task, YesNo.No);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent14StartDate, "Events", excelLabel.Variable_Name,
						"M7NEvent14", excelLabel.Start_Date);
				ExcelUtils.writeData(phase1DataSheetFilePath, M7NEvent14EndDate, "Events", excelLabel.Variable_Name,
