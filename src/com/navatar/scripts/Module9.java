...
public class Module9 extends BaseLib {
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc002_1_Create_Fund_First_SDG_Grid(String projectName) {
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * SDGPageBusinessLayer sdg = new SDGPageBusinessLayer(driver);
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName); String fields =
	 * SDGLabels.APIName.toString(); String values = ""; lp.searchAndClickOnApp(SDG,
	 * 30);
	 * 
	 * if (lp.clickOnTab(projectName, TabName.SDGTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.SDGTab, YesNo.No); String sdgName =
	 * "Fund - First SDG Grid New"; String sdgTag = "Fund - First SDG Grid New";
	 ...
	 * 
	 * for (int i = 0; i < 1; i++) { String api = "Name"; values = api; if
	 * (sdg.addFieldOnSDG(projectName, fields, values)) { log(LogStatus.INFO,
	 * "Successfully added fields on " + sdgName, YesNo.Yes);
	 * 
	 * } else { sa.assertTrue(false, "Not Able to add fields on SDG : " + sdgName);
	 * log(LogStatus.SKIP, "Not Able to add fields on SDG : " + sdgName, YesNo.Yes);
	 * } }
	 * 
	 * } else { sa.assertTrue(false, "Not Able to create/verify created SDG : " +
	 * sdgName); log(LogStatus.SKIP, "Not Able to create/verify created SDG : " +
	 * sdgName, YesNo.Yes); }
	 * 
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc004_ValidateErrorMsg_Fund_First_SDG_Grid(String
	 * projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); SDGPageBusinessLayer sdg = new
	 * SDGPageBusinessLayer(driver); lp.CRMLogin(superAdminUserName, adminPassword,
	 * appName);
	 ...
	 * "Click on Tab : " + TabName.SDGTab, YesNo.No);
	 * 
	 * String[][] sdgLabels1 = { { SDGCreationLabel.Parent_Field_Name.toString(),
	 * "navpeII__X1st_Closing_Date__c" } }; String[][] sdgLabels2 = { {
	 * SDGCreationLabel.Parent_Field_Name.toString(), "Active__c" } }; String[][]
	 * sdgLabels3 = { { SDGCreationLabel.Parent_Field_Name.toString(),
	 * "Custom_Mpick_list__c" } }; String[][] sdgLabels4 = { {
	 * SDGCreationLabel.Parent_Field_Name.toString(), "navpeII__Fund_Type__c" } };
	 * String[][] sdgLabels5 = { { SDGCreationLabel.Parent_Field_Name.toString(),
	 * "navpeII__Remaining_Commitments_USD_mn__c" } }; String[][] sdgLabels6 = { {
	 * SDGCreationLabel.Parent_Field_Name.toString(),
	 * "navpeII__Target_Commitments_USD_mn__c" } }; String[][] sdgLabels7 = { {
	 * SDGCreationLabel.Parent_Field_Name.toString(),
	 * "navpeII__Total_Capital_Called_mn__c" } }; String[][] sdgLabels8 = { {
	 * SDGCreationLabel.Parent_Field_Name.toString(), "navpeII__Total_Commitment__c"
	 * } };
	 * 
	 * String[][][] sdgLabels = { sdgLabels1, sdgLabels2, sdgLabels3, sdgLabels4,
	 * sdgLabels5, sdgLabels6, sdgLabels7, sdgLabels8 };
	 * 
	 * if (sdg.editCustomSDGandFoundErrorMsg(projectName, "Fund - First SDG Grid",
	 * sdgLabels, action.BOOLEAN, 20,
	 * "must be a Reference, ID, String or Text Area field")) { log(LogStatus.PASS,
	 * "edit/verify created SDG : " + "Fund - First SDG Grid", YesNo.No);
	 * sa.assertTrue(true, "Able to edit SDG and Find error Msg for SDG : " +
	 * Sdg1Name);
	 * 
	 * } else { sa.assertTrue(false, "Not Able to edit/verify created SDG : " +
	 * Sdg1Name); log(LogStatus.SKIP, "Not Able to edit/verify created SDG : " +
	 ...
	 * String projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); EditPageBusinessLayer edit = new
	 * EditPageBusinessLayer(driver); lp.CRMLogin(superAdminUserName, adminPassword,
	 * appName);
	 * 
	 * String[] fieldsInSDG = { "FUND NAME", "OWNER NAME", "FUND TYPE",
	 * "POINT OF CONTACT", "1ST CLOSING DATE", "SECTOR", "REGION",
	 * "CUSTOM MPICK_LIST", "TARGET - C@MMITMENTS", "#TARGET CLOSED",
	 * "#STAGE - INTERESTED", "#CLOSING - 3RD CLOSING",
	 * "#TOTAL LOW INVESTMENT AMOUNT", "#MAXINVESTOR'SAMOUNT($MN)",
	 * "#FINANCEBUYERS", "#FORMULA - COMMITMENT" }; String TitleOfSDG =
	 * "Fund - First SDG Grid";
	 * 
	 * List<String> columnsInSDG = Arrays.asList(fieldsInSDG); if
	 * (lp.clickOnTab(projectName, TabName.HomeTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.HomeTab, YesNo.No); WebElement
	 * alreadyAddedComponentToHomePage = FindElement(driver, "//a[text()='" +
	 * TitleOfSDG + "']", "Component Title ", action.SCROLLANDBOOLEAN, 10); if
	 * (alreadyAddedComponentToHomePage != null) {
	 * 
	 * log(LogStatus.INFO,
	 * "------------Component Already Added to Home Page, So Not adding Component: "
	 * + TitleOfSDG + "----------------", YesNo.Yes); sa.assertTrue(true,
	 * "------------Component Already Added to Home Page, So Not adding Component: "
	 * + TitleOfSDG + "---------------"); }
	 * 
	 * else {
	 * 
	 * if (edit.clickOnEditPageLink()) { log(LogStatus.INFO,
	 * "Component Not Already Added to Home Page, So adding Component: " +
	 * TitleOfSDG, YesNo.No); if
	 * (edit.addSDGComponentToRefrencedComponentAndVerifyColumnsAndNoOfRecords(
	 * projectName, columnsInSDG, "Navatar SDG", TitleOfSDG,
	 * "Fund - First SDG Grid", 84)) { log(LogStatus.INFO,
	 * "Component Added to Home Page: " + TitleOfSDG, YesNo.Yes);
	 * sa.assertTrue(true, "Component Added to Home Page: " + TitleOfSDG); }
	 * 
	 * else { log(LogStatus.ERROR, "Component Not Able to Add to Home Page: " +
	 * TitleOfSDG, YesNo.Yes); sa.assertTrue(false,
	 * "Component Not Able to Add to Home Page: " + TitleOfSDG); } }
	 * 
	 * else { log(LogStatus.ERROR,
	 * "Not able to click on edit page so cannot add Component to Home Page : " +
	 * TitleOfSDG, YesNo.Yes); sa.assertTrue(false,
	 * "Not able to click on edit page so cannot add Component to Home Page  : " +
	 * TitleOfSDG); }
	 * 
	 ...
	 * 
	 * @Test public void
	 * M9Tc006_ValidateMiscOptionsSDGComponent_Fund_First_SDG_Grid_InHomepage(String
	 * projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); EditPageBusinessLayer edit = new
	 * EditPageBusinessLayer(driver); lp.CRMLogin(superAdminUserName, adminPassword,
	 * appName);
	 ...
	 * "#TOTAL LOW INVESTMENT AMOUNT", "#MAXINVESTOR'SAMOUNT($MN)",
	 * "#FINANCEBUYERS", "#FORMULA - COMMITMENT" }; String TitleOfSDG =
	 * "Fund - First SDG Grid"; Boolean flag = false; int status = 0; List<String>
	 * columnsInSDG = Arrays.asList(fieldsInSDG); if (lp.clickOnTab(projectName,
	 * TabName.HomeTab)) { log(LogStatus.INFO, "Click on Tab : " + TabName.HomeTab,
	 * YesNo.No); WebElement alreadyAddedComponentToHomePage = FindElement(driver,
	 * "//a[text()='" + TitleOfSDG + "']", "Component Title ",
	 * action.SCROLLANDBOOLEAN, 10); if (alreadyAddedComponentToHomePage != null) {
	 * log(LogStatus.INFO, "------------Component Already Added to Home Page " +
	 * TitleOfSDG + "----------------", YesNo.Yes); sa.assertTrue(true,
	 * "------------Component Already Added to Home Page " + TitleOfSDG +
	 * "---------------");
	 * 
	 * if (edit.verifySDGExpandByDefault(TitleOfSDG)) { log(LogStatus.PASS,
	 * "-----------SDG: " + TitleOfSDG + " is Expanded By Default--------------",
	 * YesNo.No); sa.assertTrue(true, "-----------SDG: " + TitleOfSDG +
	 * " is Expanded By Default--------------");
	 * 
	 * }
	 * 
	 * else { log(LogStatus.FAIL, "-----------SDG: " + TitleOfSDG +
	 * " is not Expanded By Default--------------", YesNo.No); sa.assertTrue(false,
	 * "-----------SDG: " + TitleOfSDG +
	 * " is not Expanded By Default--------------"); status++; } if
	 * (edit.verifyColumnsOfSDG(TitleOfSDG, columnsInSDG)) { log(LogStatus.PASS,
	 * "-------Columns of SDG: " + TitleOfSDG + "are Matched--------", YesNo.No);
	 * sa.assertTrue(true, "-------Columns of SDG: " + TitleOfSDG +
	 * " are Matched-------");
	 * 
	 * } else { log(LogStatus.FAIL, "------Columns of SDG: " + TitleOfSDG +
	 * " are not Matched------", YesNo.Yes); sa.assertTrue(false,
	 * "------Columns of SDG: " + TitleOfSDG + " are not Matched------"); status++;
	 * } int row = 2; if (edit.verifySDGTooltipForARecord(TitleOfSDG, row)) {
	 * log(LogStatus.PASS, "-----------Tooltips for all columns of a record no. " +
	 * row + " matched of SDG: " + TitleOfSDG + "--------------", YesNo.No);
	 * sa.assertTrue(true, "-----------Tooltips for all columns of a record no. " +
	 * row + " matched of SDG: " + TitleOfSDG + "--------------");
	 * 
	 * }
	 * 
	 * else { log(LogStatus.FAIL,
	 * "-----------Tooltips for all columns of a record no. " + row +
	 * " Not matched of SDG: " + TitleOfSDG + "--------------", YesNo.No);
	 * sa.assertTrue(false, "-----------Tooltips for all columns of a record no. " +
	 * row + " Not matched of SDG: " + TitleOfSDG + "--------------"); status++; }
	 * 
	 * if (lp.clickOnTab(projectName, TabName.InstituitonsTab)) {
	 * log(LogStatus.INFO, "Click on Tab : " + TabName.InstituitonsTab, YesNo.No);
	 * if (lp.clickOnTab(projectName, TabName.HomeTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.HomeTab, YesNo.No); if
	 * (edit.verifyCollapseTooltipAFterGoingToInstitutionPageAndComingBack(
	 * TitleOfSDG)) { log(LogStatus.PASS,
	 ...
	 * ); status++; }
	 * 
	 * } else { log(LogStatus.ERROR, "Not Able to Click on Tab : " +
	 * TabName.HomeTab, YesNo.No); } } else { log(LogStatus.ERROR,
	 * "Not Able to Click on Tab : " + TabName.InstituitonsTab, YesNo.No); }
	 * 
	 * if (lp.switchToClassic()) { log(LogStatus.INFO,
	 * "----------Switched to Classic Mode-----", YesNo.No); if
	 * (lp.switchToLighting()) { log(LogStatus.INFO,
	 * "----------Switched to Lightning Mode-----", YesNo.No); if
	 * (edit.verifyCollapseTooltipAFterGoingToInstitutionPageAndComingBack(
	 * TitleOfSDG)) { log(LogStatus.PASS,
	 ...
	 * ); status++; }
	 * 
	 * } else { log(LogStatus.ERROR, "Not Able to Switch to Lightning Mode",
	 * YesNo.No); } } else { log(LogStatus.ERROR,
	 * "Not Able to Switch to Classic Mode", YesNo.No); }
	 * 
	 * if (edit.verifySDGTooltipForExpandAndCollapse(TitleOfSDG)) {
	 * log(LogStatus.PASS,
	 * "-----------Tooltip for Collapse/Expand after click matched of SDG: " +
	 * TitleOfSDG + "--------------", YesNo.No); sa.assertTrue(true,
	 * "-----------Tooltip for Collapse/Expand after click matched of SDG: " +
	 * TitleOfSDG + "--------------");
	 * 
	 * }
	 * 
	 * else { log(LogStatus.FAIL,
	 * "-----------Tooltips for Collapse/Expand after click Not matched of SDG: " +
	 * TitleOfSDG + "--------------", YesNo.No); sa.assertTrue(true,
	 * "-----------Tooltips Collapse/Expand after click Not matched of SDG: " +
	 * TitleOfSDG + "--------------"); status++; }
	 * 
	 * }
	 * 
	 * else {
	 * 
	 * log(LogStatus.ERROR, "-----------Component Not Added to Home Page: " +
	 * TitleOfSDG + " -------------", YesNo.Yes); sa.assertTrue(false,
	 ...
	 * 
	 * @Test public void
	 * M9Tc007_ValidateOptionsWithAdminAndUserSDGComponent_Fund_First_SDG_Grid_InHomepage
	 * (String projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); HomePageBusineesLayer home = new
	 * HomePageBusineesLayer(driver);
	 * 
	 * String[] Emails = { superAdminUserName, crmUser2EmailID };
	 * 
	 * for (String Email : Emails) { lp.CRMLogin(Email, adminPassword, appName);
	 * 
	 * String TitleOfSDG = "Fund - First SDG Grid";
	 * 
	 * if (lp.clickOnTab(projectName, TabName.HomeTab)) { log(LogStatus.INFO,
	 * "Clicked on Tab : " + TabName.HomeTab, YesNo.No); WebElement
	 * alreadyAddedComponentToHomePage = FindElement(driver, "//a[text()='" +
	 * TitleOfSDG + "']", "Component Title ", action.SCROLLANDBOOLEAN, 10);
	 * 
	 * if (alreadyAddedComponentToHomePage != null) { log(LogStatus.INFO,
	 * "------------Component Already Added to Home Page " + TitleOfSDG +
	 * "----------------", YesNo.Yes); sa.assertTrue(true,
	 * "------------Component Already Added to Home Page " + TitleOfSDG +
	 * "---------------");
	 * 
	 * if (home.verifySDGExpandByDefault(TitleOfSDG)) { log(LogStatus.PASS,
	 * "-----------SDG: " + TitleOfSDG + " is Expanded By Default in case of " +
	 * Email + "--------------", YesNo.No); sa.assertTrue(true, "-----------SDG: " +
	 * TitleOfSDG + " is Expanded By Default in case of " + Email +
	 * "--------------");
	 * 
	 * }
	 * 
	 ...
	 * YesNo.No); sa.assertTrue(false, "-----------SDG: " + TitleOfSDG +
	 * " is not Expanded By Default in case of " + Email + "--------------");
	 * 
	 * }
	 * 
	 ...
	 * log(LogStatus.PASS,
	 * "-----------Gear Icon Found and Tooltip Verified--------------", YesNo.No);
	 * sa.assertTrue(true,
	 * "-----------Gear Icon Found and Tooltip Verified--------------");
	 * 
	 * }
	 * 
	 * else { log(LogStatus.FAIL,
	 * "-----------Gear Icon Found and Tooltip not Verified--------------",
	 * YesNo.No); sa.assertTrue(false,
	 * "-----------Gear Icon Found and Tooltip not Verified--------------");
	 * 
	 * }
	 * 
	 * } else { log(LogStatus.ERROR, "-----------Component Not Added to Home Page: "
	 * + TitleOfSDG + " -------------", YesNo.Yes); sa.assertTrue(false,
	 * "-----------Component Not Added to Home Page: " + TitleOfSDG +
	 * " ------------");
	 * 
	 ...
	 * 
	 * @Test public void
	 * M9Tc008_ValidateDefaultSortingAndCustomSortingSDGComponent_Fund_First_SDG_Grid_InHomepage(
	 * String projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); HomePageBusineesLayer home = new
	 * HomePageBusineesLayer(driver); HomePage hp = new HomePage(driver);
	 * 
	 * String[] fieldsInSDG = { "FUND NAME", "OWNER NAME", "FUND TYPE",
	 * "POINT OF CONTACT", "1ST CLOSING DATE", "SECTOR", "REGION",
	 * "TARGET - C@MMITMENTS" }; List<String> columnInSDG =
	 * Arrays.asList(fieldsInSDG); lp.CRMLogin(crmUser1EmailID, adminPassword,
	 * appName);
	 * 
	 * String TitleOfSDG = "Fund - First SDG Grid";
	 * 
	 ...
	 * 
	 * String pageSize = "100"; if (home.pageSizeSelect(TitleOfSDG, pageSize)) {
	 * 
	 * log(LogStatus.PASS, "-----------Page Size has selected to" + pageSize +
	 * " --------------", YesNo.No); List<String> columnDataText =
	 * hp.columnData(TitleOfSDG, 2).stream().map(s -> s.getText())
	 * .collect(Collectors.toList()).stream().map(t ->
	 * t.trim()).collect(Collectors.toList()); Collections.sort(columnDataText,
	 * String.CASE_INSENSITIVE_ORDER.reversed()); System.out.println(
	 * "Descending with Data: " + columnDataText.size() + " Collections: " +
	 * columnDataText);
	 * 
	 * if (CommonLib.checkSorting(driver, SortOrder.Decending,
	 * hp.columnData(TitleOfSDG, 2))) { log(LogStatus.PASS,
	 ...
	 * );
	 * 
	 * } } else { log(LogStatus.FAIL, "-----------Not able to Select Page Size: " +
	 * pageSize + "--------------", YesNo.No); sa.assertTrue(false,
	 * "-----------Not able to Select Page Size: " + pageSize + " --------------");
	 * }
	 * 
	 * } else { log(LogStatus.FAIL,
	 * "-----------Not able to Expand SDG Grid --------------", YesNo.No);
	 * sa.assertTrue(false,
	 * "-----------Not able to Expand SDG Grid --------------"); }
	 * 
	 * home.verifyColumnAscendingDescendingOrder(SDGGridName.Fund_First_SDG,
	 * columnInSDG);
	 * 
	 * } else { log(LogStatus.ERROR, "-----------Component Not Added to Home Page: "
	 * + TitleOfSDG + " -------------", YesNo.Yes); sa.assertTrue(false,
	 ...
	 * " -------------", YesNo.No); sa.assertTrue(true,
	 * "--------Able to edit SDG : " + sdgName + " --------------");
	 * 
	 * if (lp.clickOnTab(projectName, TabName.HomeTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.HomeTab, YesNo.No); WebElement
	 * alreadyAddedComponentToHomePage = FindElement(driver, "//a[text()='" +
	 * sdgName + "']", "Component Title ", action.SCROLLANDBOOLEAN, 10);
	 * 
	 * if (alreadyAddedComponentToHomePage != null) { log(LogStatus.INFO,
	 ...
	 * 
	 * String pageSize = "100"; if (home.pageSizeSelect(sdgName, pageSize)) {
	 * 
	 * log(LogStatus.PASS, "-----------Page Size has selected to" + pageSize +
	 * " --------------", YesNo.No);
	 * 
	 * int numberOfRecords = 76; if (home.numberOfRecordsMatch(sdgName, 76)) {
	 * log(LogStatus.INFO, "----------No. of Records Matched: " + numberOfRecords +
	 * "------------", YesNo.No);
	 * 
	 * }
	 * 
	 * else { log(LogStatus.FAIL, "---------No. of Records not Matched-------- ",
	 * YesNo.No); sa.assertTrue(false,
	 ...
	 * 
	 * @Test public void
	 * M9Tc010_ValidateNumberOfRecordsAfterEnterLitViewNameForUserSDGComponent_Fund_First_SDG_Grid_InHomepage(
	 * String projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); HomePageBusineesLayer home = new
	 * HomePageBusineesLayer(driver);
	 * 
	 ...
	 * " --------------", YesNo.No);
	 * 
	 * int numberOfRecords = 76; if (home.numberOfRecordsMatch(sdgName,
	 * numberOfRecords)) { log(LogStatus.INFO, "----------No. of Records Matched: "
	 * + numberOfRecords + "------------", YesNo.No);
	 * 
	 * }
	 * 
	 * else { log(LogStatus.FAIL, "---------No. of Records not Matched-------- ",
	 ...
	 * SDGPageBusinessLayer sdg = new SDGPageBusinessLayer(driver);
	 * 
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName); String[][][]
	 * sdgLabels = { { { SDGCreationLabel.List_View_Name.toString(),
	 * "InvalidListViewName" } }, { { SDGCreationLabel.List_View_Name.toString(),
	 * "Launched_Date" } } }; String sdgName = "Fund - First SDG Grid"; for
	 * (String[][] sdgLabel : sdgLabels) { lp.searchAndClickOnApp(SDG, 30);
	 * 
	 * if (lp.clickOnTab(projectName, TabName.SDGTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.SDGTab, YesNo.No);
	 * 
	 ...
	 * 
	 * int numberOfRecords = 84; if (home.numberOfRecordsMatch(sdgName,
	 * numberOfRecords)) { log(LogStatus.INFO, "----------No. of Records Matched: "
	 * + numberOfRecords + "for List View Name: " + sdgLabel[0][1] + "------------",
	 * YesNo.No);
	 * 
	 * }
	 * 
	 * else { log(LogStatus.FAIL, "---------No. of Records not Matched " +
	 * numberOfRecords + "for List View Name: " + sdgLabel[0][1] + "-------- ",
	 * YesNo.No); sa.assertTrue(false, "-----------No. of Records not Matched: " +
	 * numberOfRecords + "for List View Name: " + sdgLabel[0][1] +
	 * " --------------");
	 * 
	 * } } else if (sdgLabel[0][1].equals("Launched_Date")) {
	 * 
	 * int numberOfRecords = 2; if (home.numberOfRecordsMatch(sdgName,
	 * numberOfRecords)) { log(LogStatus.INFO, "----------No. of Records Matched: "
	 * + numberOfRecords + "for List View Name: " + sdgLabel[0][1] + "------------",
	 * YesNo.No);
	 * 
	 ...
	 * } else { sa.assertTrue(false, "Not Able to Click on Tab : " +
	 * TabName.SDGTab); log(LogStatus.SKIP, "Not Able to Click on Tab : " +
	 * TabName.SDGTab, YesNo.Yes); } } lp.CRMlogout(); sa.assertAll(); }
	 * 
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9tc001_3_AddListViews(String projectName) {
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * 
	 * String[][] listViewSheetData = { { M9LV_1_Member, M9LV_1_TabName,
	 * M9LV_1_ListViewName, M9LV_1_ListAccessibility, M9LV_1_Filter, M9LV_1_Field,
	 * M9LV_1_Operators, M9LV_1_FilterValue }, { M9LV_2_Member, M9LV_2_TabName,
	 * M9LV_2_ListViewName, M9LV_2_ListAccessibility, M9LV_2_Filter, M9LV_2_Field,
	 * M9LV_2_Operators, M9LV_2_FilterValue }, { M9LV_3_Member, M9LV_3_TabName,
	 * M9LV_3_ListViewName, M9LV_3_ListAccessibility, M9LV_3_Filter, M9LV_3_Field,
	 * M9LV_3_Operators, M9LV_3_FilterValue }, { M9LV_4_Member, M9LV_4_TabName,
	 * M9LV_4_ListViewName, M9LV_4_ListAccessibility, M9LV_4_Filter, M9LV_4_Field,
	 * M9LV_4_Operators, M9LV_4_FilterValue } };
	 * 
	 * for (String[] row : listViewSheetData) {
	 * 
	 * if (row[0].trim().equalsIgnoreCase("User1")) {
	 * 
	 * lp.CRMLogin(crmUser1EmailID, adminPassword, appName); } else if
	 * (row[0].trim().equalsIgnoreCase("User2")) { lp.CRMlogout();
	 * lp.CRMLogin(crmUser2EmailID, adminPassword, appName); } else if
	 * (row[0].trim().equalsIgnoreCase("admin")) { lp.CRMlogout();
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName); }
	 * 
	 * if (lp.clickOnTab(projectName, row[1])) { if
	 * (lp.addAutomationAllListView(projectName, row, 10)) { log(LogStatus.INFO,
	 * "list view added on " + row[1], YesNo.No); } else { log(LogStatus.FAIL,
	 * "list view could not added on " + row[1], YesNo.Yes); sa.assertTrue(false,
	 * "list view could not added on " + row[1]); } }
	 * 
	 * else { log(LogStatus.FAIL, "could not click on " + row[1], YesNo.Yes);
	 * sa.assertTrue(false, "could not click on " + row[1]); }
	 * 
	 * ThreadSleep(5000); lp.CRMlogout(); }
	 * 
	 * sa.assertAll(); }
	 */
	 ...
	 * mode, labelName, tableName, parentWindowID)) { log(LogStatus.PASS,
	 * "App Page has been Created : " + labelName, YesNo.Yes); sa.assertTrue(true,
	 * "App Page has been Created"); } else { log(LogStatus.ERROR,
	 * "App Page is not created : " + labelName, YesNo.Yes); sa.assertTrue(false,
	 * "App Page is not created : " + labelName); } } else { log(LogStatus.ERROR,
	 * "Not able to search the Object", YesNo.Yes); sa.assertTrue(false,
	 * "Not able to search the Object"); }
	 * 
	 * } lp.CRMlogout(); sa.assertAll(); }
	 */
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc054_VerifySDGDataOnAppPage(String projectName) {
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 * LightningAppBuilderPageBusinessLayer AppBuilder = new
	 * LightningAppBuilderPageBusinessLayer(driver); String appPage =
	 * "Test App Page"; String tableName = "Test"; lp.CRMLogin(crmUser1EmailID,
	 ...
	 * val); if (Data == null) { log(LogStatus.PASS, "SDG Data has been Matched",
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc055_DeleteContactAndVerifySDGDataOnAppPage(String
	 * projectName) {
	 * 
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc056_checkAllRowAndVerifySDGDataOnAppPage(String
	 * projectName) {
	 * 
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 ...
	 * SDGPageBusinessLayer(driver); String appPage = "Test App Page"; String
	 * tableName = "Test";
	 * 
	 * String[][] val = { { M9SDGD_21_AccountIndustry, M9SDGD_21_Totalfirm,
	 * M9SDGD_21_Task_as_per_Industries, M9SDGD_21_Individuals,
	 ...
	 * 
	 * @Test public void
	 * M9Tc057_RemoveEmailFromRecycleAndEditSDGAndVerifySDGDataOnAppPage(String
	 * projectName) {
	 * 
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 ...
	 * 
	 * String appPage = "Test App Page"; String tableName = "Test"; String name =
	 * "James Falcon -1"; String[][] val = { { M9SDGD_1_AccountIndustry,
	 * M9SDGD_1_Totalfirm, M9SDGD_1_Task_as_per_Industries, M9SDGD_1_Individuals,
	 * M9SDGD_1_Fundraising_as_per_Industries }, { M9SDGD_2_AccountIndustry,
	 * M9SDGD_2_Totalfirm, M9SDGD_2_Task_as_per_Industries, M9SDGD_2_Individuals,
	 * M9SDGD_2_Fundraising_as_per_Industries }, { M9SDGD_3_AccountIndustry,
	 * M9SDGD_3_Totalfirm, M9SDGD_3_Task_as_per_Industries, M9SDGD_3_Individuals,
	 ...
	 * (lp.searchAndClickOnApp(recycleTab, 60)) { ele =
	 * lp.getCheckboxOfRestoreItemOnRecycleBin(projectName, name, 30); if
	 * (clickUsingJavaScript(driver, ele, "Check box against : " + name,
	 * action.BOOLEAN)) { log(LogStatus.INFO, "Click on checkbox for " + name,
	 * YesNo.No); ; ele = lp.getRestoreButtonOnRecycleBin(projectName, 30); if
	 * (clickUsingJavaScript(driver, ele, "Restore Button : " + name,
	 * action.BOOLEAN)) { ThreadSleep(10000); log(LogStatus.INFO,
	 * "Click on Restore Button for " + name, YesNo.No); if
	 * (BP.openAppFromAppLauchner(60, "Sortable Data Grids")) { if
	 * (sd.editAllRowOnSDG(projectName, "SDG_GROUPBY_1",
	 * Condition.UnSelectCheckbox)) {
	 * 
	 * lp.CRMlogout(); lp.CRMLogin(crmUser1EmailID, adminPassword, appName); if
	 * (BP.openAppFromAppLauchner(appPage, 50)) { ArrayList<String> Data =
	 * AppBuilder.verifySDGDataOnAppPage(projectName, mode, appPage, tableName,
	 * val); if (Data == null) { log(LogStatus.PASS, "SDG Data has been Matched",
	 * YesNo.No); sa.assertTrue(true, "SDG Data has been Matched"); } else {
	 ...
	 * } else {
	 * 
	 * log(LogStatus.ERROR, "Not Able to Click on Restore Button for " + name,
	 * YesNo.Yes); sa.assertTrue(false, "Not Able to Click on Restore Button for " +
	 * name); }
	 * 
	 * } else {
	 * 
	 * log(LogStatus.ERROR, "Not Able to Click on checkbox for " + name, YesNo.Yes);
	 * sa.assertTrue(false, "Not Able to Click on checkbox for " + name); } } else {
	 ...
	 * 
	 * @Test public void
	 * M9Tc058_UpdatePiclistFieldLabelAndVerifySDGDataOnAppPage(String projectName)
	 * {
	 * 
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 ...
	 * CommonLib.refresh(driver); lp.CRMlogout(); lp.CRMLogin(crmUser1EmailID,
	 ...
	 * appPage, tableName, val); if (Data == null) { log(LogStatus.PASS,
	 ...
	 * 
	 * @Test public void
	 * M9Tc059_DeactivateBiotechnologyOnIndustryAndVerifySDGDataOnAppPage(String
	 ...
	 * 
	 * @Test public void
	 * M9Tc060_ActivateBiotechnologyOnIndustryAndVerifySDGDataOnAppPage(String
	 * projectName) {
	 * 
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 ...
	 * 
	 * @Test public void
	 * M9Tc061_deletePicklistOptionAndReplaceValueAndVerifySDGDataOnAppPage(String
	 * projectName) {
	 * 
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 ...
	 * String picklistvalue = "Retail"; String replaceValueName = "Consulting";
	 * 
	 ...
	 * 
	 * String appPage = "Test App Page"; String tableName = "Test";
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName); if
	 * (home.clickOnSetUpLink()) {
	 * 
	 * String parentWindowID = switchOnWindow(driver); if (parentWindowID == null) {
	 ...
	 * 
	 * @Test public void
	 * M9Tc062_deletePicklistOptionAndReplaceValuewithBlankAndVerifySDGDataOnAppPage
	 * (String projectName) {
	 * 
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 ...
	 * FieldAndRelationshipPageBusinessLayer fr = new
	 * FieldAndRelationshipPageBusinessLayer(driver); String field = "Industry";
	 * String picklistvalue = "Utilities"; String replaceValueName = "Consulting";
	 * String appPage = "Test App Page"; String tableName = "Test";
	 * 
	 ...
	 * 
	 * @Test public void
	 * M9Tc063_CreateNewOptionAndReplaceWithExistingValueVerifySDGDataOnAppPage(
	 * String projectName) {
	 * 
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 ...
	 * appPage = "Test App Page"; String tableName = "Test";
	 * 
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc064_AddSDGOnAppPage(String projectName) {
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * HomePageBusineesLayer home = new HomePageBusineesLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 ...
	 * LightningAppBuilderPageBusinessLayer(driver);
	 * FieldAndRelationshipPageBusinessLayer fr = new
	 * FieldAndRelationshipPageBusinessLayer(driver); EditPageBusinessLayer EP = new
	 * EditPageBusinessLayer(driver); String labelName = "Testing1234"; String
	 * tableName = "Test"; String appPage = "Testing1234";
	 * 
	 * ArrayList<String> tableNames = new ArrayList<String>();
	 * tableNames.add("SDG_GROUPBY_2"); tableNames.add("SDG_GROUPBY_3");
	 ...
	 * 
	 * } else { log(LogStatus.ERROR, "Could not edit the Page and add the SDG",
	 * YesNo.Yes); sa.assertTrue(false, "Could not edit the Page and add the SDG");
	 * }
	 * 
	 * } else { log(LogStatus.ERROR, "Could not open the App from the App Launcher",
	 * YesNo.Yes); sa.assertTrue(false,
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc065_VerifySDGDataOnAppPage(String projectName) {
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * HomePageBusineesLayer home = new HomePageBusineesLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 ...
	 * FieldAndRelationshipPageBusinessLayer fr = new
	 * FieldAndRelationshipPageBusinessLayer(driver); EditPageBusinessLayer EP = new
	 * EditPageBusinessLayer(driver); String tableName = ""; String appPage =
	 * "Test App Page"; String[][] SDG_GROUPBY_2_SDG = { {
	 ...
	 * 
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName); tableName =
	 * "SDG_GROUPBY_2"; if (BP.openAppFromAppLauchner(appPage, 50)) {
	 * ArrayList<String> Data = AppBuilder.verifySDGDataOnAppPage(projectName, mode,
	 * appPage, tableName, SDG_GROUPBY_2_SDG); if (Data == null) {
	 * log(LogStatus.PASS, "SDG Data has been Matched", YesNo.No);
	 * sa.assertTrue(true, "SDG Data has been Matched"); } else {
	 * log(LogStatus.ERROR, "SDG Data is not Matched", YesNo.Yes);
	 * sa.assertTrue(false, "SDG Data is not Matched : " + Data); }
	 * 
	 * } else { log(LogStatus.ERROR, "Could not Opened the App Launcher",
	 ...
	 * 
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName); tableName =
	 * "SDG_GROUPBY_3"; if (BP.openAppFromAppLauchner(appPage, 50)) {
	 * ArrayList<String> Data = AppBuilder.verifySDGDataOnAppPage(projectName, mode,
	 * appPage, tableName, SDG_GROUPBY_3_SDG); if (Data == null) {
	 * log(LogStatus.PASS, "SDG Data has been Matched", YesNo.No);
	 * sa.assertTrue(true, "SDG Data has been Matched"); } else {
	 * log(LogStatus.ERROR, "SDG Data is not Matched", YesNo.Yes);
	 * sa.assertTrue(false, "SDG Data is not Matched : " + Data); }
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc066_VerifyPermissionAddFieldToLayoutAndEditField(String
	 * projectName) { SetupPageBusinessLayer setup = new
	 * SetupPageBusinessLayer(driver); LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); HomePageBusineesLayer home = new
	 * HomePageBusineesLayer(driver); BasePageBusinessLayer BP = new
	 ...
	 * FieldAndRelationshipPageBusinessLayer fr = new
	 * FieldAndRelationshipPageBusinessLayer(driver); EditPageBusinessLayer EP = new
	 * EditPageBusinessLayer(driver); DataLoaderWizardPageBusinessLayer dataload =
	 * new DataLoaderWizardPageBusinessLayer(driver); String parentWindow = "";
	 * boolean flag = false; String data; lp.CRMLogin(superAdminUserName,
	 * adminPassword, appName); if (home.clickOnSetUpLink()) { parentWindow =
	 ...
	 * ); } ThreadSleep(3000);
	 * 
	 * data = M9AFTPL_13_FieldNames; System.out.println(data); String[] fields =
	 * data.split(",");
	 * 
	 ...
	 * columns) { sourceANDDestination.put(column, "Identifier");
	 * 
	 ...
	 * + email); } }
	 * 
	 * } else { log(LogStatus.INFO, "Not able to give the permission", YesNo.Yes);
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc067_CreateAppPageAndAddSDGs(String projectName) {
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * HomePageBusineesLayer home = new HomePageBusineesLayer(driver);
	 * LightningAppBuilderPageBusinessLayer AppBuilder = new
	 ...
	 * tableName.add("Account Filter Grid"); tableName.add("Contact Filter Grid");
	 * tableName.add("Fund Filter Grid"); tableName.add("Fundraising Filter Grid");
	 * 
	 ...
	 * sa.assertTrue(true, "App Page has been Created"); } else {
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9tc012_DeleteListViewAndVerifySDGRecords(String
	 * projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); HomePageBusineesLayer home = new
	 * HomePageBusineesLayer(driver); SDGPageBusinessLayer sdg = new
	 * SDGPageBusinessLayer(driver); String[][] listViewSheetData = { {
	 * M9LV_3_Member, M9LV_3_TabName, M9LV_3_ListViewName } };
	 * 
	 * for (String[] row : listViewSheetData) {
	 * 
	 * if (row[0].trim().equalsIgnoreCase("User1")) {
	 ...
	 * 
	 * if (lp.clickOnTab(projectName, row[1])) { if
	 * (home.deleteListView(projectName, row[2], 20)) { log(LogStatus.INFO,
	 * "------------List view " + row[2] + " deleted on " + row[1] + "-----------",
	 * YesNo.No); if (lp.clickOnTab(projectName, TabName.HomeTab)) {
	 ...
	 * "-----------Not able to Expand SDG Grid --------------", YesNo.No);
	 * sa.assertTrue(false,
	 * "-----------Not able to Expand SDG Grid --------------"); } } else {
	 * sa.assertTrue(false, "Not Able to Click on Tab : " + TabName.HomeTab);
	 * log(LogStatus.SKIP, "Not Able to Click on Tab : " + TabName.HomeTab,
	 * YesNo.Yes); } } else { log(LogStatus.FAIL, "-------------List view " + row[2]
	 * + " could not deleted on " + row[1] + "-----------", YesNo.Yes);
	 * sa.assertTrue(false, "-------------List view " + row[2] +
	 * " could not deleted on " + row[1] + "-----------"); } }
	 * 
	 * else { log(LogStatus.FAIL, "could not click on " + row[1], YesNo.Yes);
	 * sa.assertTrue(false, "could not click on " + row[1]); }
	 * 
	 ...
	 * 
	 * for (String[][] sdgLabel : sdgLabels) { lp.searchAndClickOnApp(SDG, 30);
	 * 
	 * if (lp.clickOnTab(projectName, TabName.SDGTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.SDGTab, YesNo.No);
	 * 
	 ...
	 * 
	 * if (lp.clickOnTab(projectName, TabName.HomeTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.HomeTab, YesNo.No);
	 * 
	 * if (home.sdgGridExpandedByDefaultIfNotThenExpand(sdgName)) {
	 * 
	 * String pageSize = "100"; if (home.pageSizeSelect(sdgName, pageSize)) {
	 ...
	 * }
	 * 
	 * else { sa.assertTrue(false, "Not Able to Click on Tab : " + TabName.HomeTab);
	 * log(LogStatus.SKIP, "Not Able to Click on Tab : " + TabName.HomeTab,
	 * YesNo.Yes); }
	 * 
	 * } else { sa.assertTrue(false,
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9tc013_DeleteOneFundRecordAndVerifySDG(String projectName)
	 * { LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * HomePageBusineesLayer home = new HomePageBusineesLayer(driver);
	 * 
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName); String sdgName =
	 * "Fund - First SDG Grid"; String fundNameToDelete = "Test Fund 1";
	 * 
	 * if (lp.clickOnTab(projectName, TabName.HomeTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.HomeTab, YesNo.No); WebElement
	 * alreadyAddedComponentToHomePage = FindElement(driver, "//a[text()='" +
	 ...
	 * 
	 * log(LogStatus.PASS, "-----------Page Size has selected to" + pageSize +
	 * " --------------", YesNo.No); int noRecordsBeforeDelete =
	 * home.numberOfRecordsInComponent(sdgName); if (home.deleteSDGRecord(sdgName,
	 * fundNameToDelete)) { log(LogStatus.INFO,
	 * "------------Record Deleted Message Show for " + fundNameToDelete +
	 * "----------------", YesNo.Yes); sa.assertTrue(true,
	 * "------------Record Deleted Message Show for " + fundNameToDelete +
	 * "---------------");
	 * 
	 * if (home.numberOfRecordsInComponent(sdgName) == noRecordsBeforeDelete - 1) {
	 * log(LogStatus.INFO, "------------Record Gets Deleted " + fundNameToDelete +
	 * "----------------", YesNo.Yes); sa.assertTrue(true,
	 * "------------Record Gets Deleted " + fundNameToDelete + "---------------");
	 * 
	 * } else { log(LogStatus.ERROR, "-----------Record Not Gets Deleted " +
	 * fundNameToDelete + " ,Expected:" + (noRecordsBeforeDelete - 1) + " " +
	 * ",But Actual:" + home.numberOfRecordsInComponent(sdgName) + "-------------",
	 * YesNo.Yes); sa.assertTrue(false, "-----------Record Not Gets Deleted " +
	 * fundNameToDelete + " ,Expected:" + (noRecordsBeforeDelete - 1) + " " +
	 * ",But Actual:" + home.numberOfRecordsInComponent(sdgName) + "-------------");
	 * 
	 * }
	 * 
	 * } else { log(LogStatus.ERROR,
	 * "-----------Record Deleted Message Not Show for " + fundNameToDelete +
	 * " -------------", YesNo.Yes); sa.assertTrue(false,
	 * "-----------Record Deleted Message Not Show for " + fundNameToDelete +
	 * " ------------");
	 * 
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9tc014_CheckAllRowsCheckboxAndThenVerifySDGGrid(String
	 * projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); HomePageBusineesLayer home = new
	 * HomePageBusineesLayer(driver); SDGPageBusinessLayer sdg = new
	 * SDGPageBusinessLayer(driver); HomePage hp = new HomePage(driver);
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName); String sdgName =
	 * "Fund - First SDG Grid"; String fundNameDeleted = "Test Fund 1";
	 * 
	 * if (lp.clickOnTab(projectName, TabName.HomeTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.HomeTab, YesNo.No); WebElement
	 * alreadyAddedComponentToHomePage = FindElement(driver, "//a[text()='" +
	 ...
	 * 
	 * if (lp.clickOnTab(projectName, TabName.SDGTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.SDGTab, YesNo.No); if
	 * (sdg.editAllRowOnSDG(projectName, sdgName, Condition.SelectCheckbox)) {
	 * log(LogStatus.PASS, "--------edit/verify SDG : " + sdgName +
	 * " -------------", YesNo.No); sa.assertTrue(true,
	 * "--------Able to edit SDG : " + sdgName + " --------------");
	 * 
	 ...
	 * int numberOfRecords = 76; if (home.numberOfRecordsMatch(sdgName,
	 * numberOfRecords)) { log(LogStatus.INFO, "----------No. of Records Matched: "
	 * + numberOfRecords + "for All Records Checked------------", YesNo.No);
	 * 
	 * if (hp.fundNameElement(sdgName, fundNameDeleted) != null) {
	 * log(LogStatus.INFO, "Record Found " + fundNameDeleted, YesNo.No);
	 * 
	 * } else { log(LogStatus.ERROR, "Record not Found: " + fundNameDeleted,
	 * YesNo.No); sa.assertTrue(false, "Record not Found: " + fundNameDeleted); }
	 * 
	 * }
	 * 
	 * else { log(LogStatus.FAIL, "---------No. of Records not Matched " +
	 ...
	 * numberOfRecords + "for All Records Checked--------------");
	 * 
	 * }
	 * 
	 * } else { log(LogStatus.FAIL, "-----------Not able to Select Page Size: " +
	 ...
	 * " ------------"); log(LogStatus.SKIP,
	 * "-----------Not Able to edit/verify created SDG : " + sdgName +
	 * " -------------", YesNo.Yes); } } else { sa.assertTrue(false,
	 * "Not Able to Click on Tab : " + TabName.SDGTab); log(LogStatus.SKIP,
	 * "Not Able to Click on Tab : " + TabName.SDGTab, YesNo.Yes); }
	 * 
	 * } else { log(LogStatus.ERROR, "-----------Component Not Added to Home Page: "
	 * + sdgName + " -------------", YesNo.Yes); sa.assertTrue(false,
	 * "-----------Component Not Added to Home Page: " + sdgName + " ------------");
	 ...
	 * TabName.HomeTab, YesNo.Yes); }
	 * 
	 * WebElement ele; String recycleTab = lp.getTabName(projectName,
	 * TabName.RecycleBinTab); if (lp.openAppFromAppLauchner(60, recycleTab)) {
	 * 
	 * if (click(driver, hp.getSelectListIcon(60), "List View Button",
	 * action.SCROLLANDBOOLEAN)) { log(LogStatus.INFO,
	 * "Clicked on List Views Button  ", YesNo.No); WebElement allListViewEle =
	 * FindElement(driver, "//span[text()='Org Recycle Bin']/ancestor::a",
	 * "Org Recycle Bin List View Button ", action.SCROLLANDBOOLEAN, 10); if
	 * (click(driver, allListViewEle, "Org Recycle Bin List View Button",
	 * action.SCROLLANDBOOLEAN)) { log(LogStatus.INFO,
	 * "Clicked on Org Recycle Bin List Views Button  ", YesNo.No);
	 * 
	 * ele = lp.getCheckboxOfRestoreItemOnRecycleBin(projectName, fundNameDeleted,
	 * 30); if (clickUsingJavaScript(driver, ele, "Check box against : " +
	 * fundNameDeleted, action.BOOLEAN)) { log(LogStatus.INFO,
	 * "Click on checkbox for " + fundNameDeleted, YesNo.No); ; ele =
	 * lp.getRestoreButtonOnRecycleBin(projectName, 30); if
	 * (clickUsingJavaScript(driver, ele, "Restore Button : " + fundNameDeleted,
	 * action.BOOLEAN)) { ThreadSleep(10000); log(LogStatus.INFO,
	 * "Click on Restore Button for " + fundNameDeleted, YesNo.No);
	 * 
	 * } else {
	 * 
	 * log(LogStatus.ERROR, "Not Able to Click on Restore Button for " +
	 * fundNameDeleted, YesNo.Yes); sa.assertTrue(false,
	 * "Not Able to Click on Restore Button for " + fundNameDeleted); }
	 * 
	 * } else {
	 * 
	 * log(LogStatus.ERROR, "Not Able to Click on checkbox for " + fundNameDeleted,
	 * YesNo.Yes); sa.assertTrue(false, "Not Able to Click on checkbox for " +
	 * fundNameDeleted); } } else {
	 * appLog.error("Not able to click on Org Recycle Bin List View Button");
	 * 
	 * } } else { appLog.error("Not able to click on List Views Button");
	 * 
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9tc015_UpdateMyRecordsFieldWithRecordOwnerId(String
	 * projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); SDGPageBusinessLayer sdg = new
	 * SDGPageBusinessLayer(driver); EditPageBusinessLayer edit = new
	 * EditPageBusinessLayer(driver); LightningAppBuilderPageBusinessLayer
	 * AppBuilder = new LightningAppBuilderPageBusinessLayer(driver);
	 * HomePageBusineesLayer home = new HomePageBusineesLayer(driver); boolean flag
	 * = false; lp.CRMLogin(superAdminUserName, adminPassword, appName); String
	 * sdgName = "Fund - First SDG Grid"; String globalFilterQuery =
	 * "Select Name from navpeII__Fund__c ORDER BY Name ASC"; String[][] sdgLabels =
	 * { { SDGCreationLabel.My_Records.toString(), "Owner.Id = '<<User.Id>>'" } };
	 * String pageSize = "100"; int rowCountAfterFilter; int
	 * rowCountAfterFilterAdminCase = 51; int rowCountAfterFilterUser1Case = 27; int
	 * rowCountAfterFilterUser2Case = 6; boolean globalFilterFlag = false;
	 * 
	 * if (lp.clickOnTab(projectName, TabName.HomeTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.HomeTab, YesNo.No); WebElement
	 * alreadyAddedComponentToHomePage = FindElement(driver, "//a[text()='" +
	 ...
	 * if (lp.clickOnTab(projectName, TabName.SDGTab)) { log(LogStatus.INFO,
	 * "Click on Tab : " + TabName.SDGTab, YesNo.No); if
	 * (sdg.editCustomSDG(projectName, sdgName, sdgLabels, action.BOOLEAN, 20)) {
	 * log(LogStatus.PASS, "--------edit/verify SDG : " + sdgName +
	 * " -------------", YesNo.No); sa.assertTrue(true,
	 * "--------Able to edit SDG : " + sdgName + " --------------"); flag = true;
	 * 
	 * } else { sa.assertTrue(false,
	 * "----------Not Able to edit/verify created SDG : " + sdgName +
	 * " ------------"); log(LogStatus.SKIP,
	 ...
	 * TabName.HomeTab, YesNo.Yes); }
	 * 
	 * if (flag) { if (lp.clickOnTab(projectName, TabName.HomeTab)) {
	 * log(LogStatus.INFO, "Click on Tab : " + TabName.HomeTab, YesNo.No); if
	 * (edit.editPageAndAddFilter("Fund", globalFilterQuery, "", "", "", "")) {
	 * log(LogStatus.INFO, "Global Filter Added to: " + TabName.HomeTab.toString(),
	 * YesNo.No); globalFilterFlag = true;
	 * 
	 * } else { sa.assertTrue(false, "Global not Filter Added to: " +
	 * TabName.HomeTab.toString()); log(LogStatus.FAIL,
	 * "Global not Filter Added to: " + TabName.HomeTab.toString(), YesNo.Yes); }
	 * 
	 * } else { sa.assertTrue(false, "Not Able to Click on Tab : " +
	 * TabName.HomeTab); log(LogStatus.SKIP, "Not Able to Click on Tab : " +
	 * TabName.HomeTab, YesNo.Yes); }
	 ...
	 * 
	 * else { sa.assertTrue(false,
	 * "Edit SDG Part not Completed, So Global filter not adding to :" +
	 * TabName.HomeTab.toString()); log(LogStatus.SKIP,
	 * "Edit SDG Part not Completed, So Global filter not adding to :" +
	 * TabName.HomeTab.toString(), YesNo.Yes); }
	 * 
	 * if (globalFilterFlag)
	 * 
	 * { if (AppBuilder.selectFilter("Show", "My Records")) { log(LogStatus.INFO,
	 * "Filter has been selected: ", YesNo.No); CommonLib.ThreadSleep(8000);
	 * rowCountAfterFilter = AppBuilder.numberOfRecords(sdgName, pageSize);
	 * 
	 * if (rowCountAfterFilter != 0) { if (rowCountAfterFilter ==
	 * rowCountAfterFilterAdminCase) { log(LogStatus.INFO,
	 * "-----------Row Count for Admin After filter Apply Matched: " +
	 ...
	 * "Could not get the count of row "); } } else { log(LogStatus.ERROR,
	 * "Could not Select the filter", YesNo.No); sa.assertTrue(false,
	 * "Could not Select the filter"); }
	 * 
	 * if (lp.CRMlogout()) { lp.CRMLogin(crmUser1EmailID, adminPassword, appName);
	 * if (AppBuilder.selectFilter("Show", "My Records")) { log(LogStatus.INFO,
	 * "Filter has been selected: ", YesNo.No); CommonLib.ThreadSleep(8000);
	 * rowCountAfterFilter = AppBuilder.numberOfRecords(sdgName, pageSize);
	 * 
	 * if (rowCountAfterFilter != 0) { if (rowCountAfterFilter ==
	 * rowCountAfterFilterUser1Case) { log(LogStatus.INFO,
	 * "-----------Row Count for User1 After filter Apply Matched: " +
	 * rowCountAfterFilter + "-----------", YesNo.No);
	 * 
	 * } else { log(LogStatus.ERROR,
	 ...
	 * "Could not get the count of row "); } } else { log(LogStatus.ERROR,
	 * "Could not Select the filter", YesNo.No); sa.assertTrue(false,
	 * "Could not Select the filter"); } } if (lp.CRMlogout()) {
	 * lp.CRMLogin(crmUser2EmailID, adminPassword, appName); if
	 * (AppBuilder.selectFilter("Show", "My Records")) { log(LogStatus.INFO,
	 * "Filter has been selected: ", YesNo.No); CommonLib.ThreadSleep(8000);
	 * 
	 * if (home.sdgGridExpandedByDefaultIfNotThenExpand(sdgName)) {
	 * log(LogStatus.INFO, "SDG data has been expanded: " + sdgName, YesNo.No);
	 * 
	 * CommonLib.ThreadSleep(5000); List<WebElement> records = FindElements(driver,
	 * "//a[text()='" + sdgName + "']/ancestor::article//tbody/tr", "Records");
	 * System.out.println("No. of Records Present: " + records.size());
	 * rowCountAfterFilter = records.size(); if (rowCountAfterFilter != 0) { if
	 * (rowCountAfterFilter == rowCountAfterFilterUser2Case) { log(LogStatus.INFO,
	 * "-----------Row Count for User2 After filter Apply Matched: " +
	 * rowCountAfterFilter + "-----------", YesNo.No);
	 * 
	 * } else { log(LogStatus.ERROR,
	 ...
	 * 
	 * } else { log(LogStatus.ERROR, "Could not expand the SDG", YesNo.No); flag =
	 * false; }
	 * 
	 * } else { log(LogStatus.ERROR, "Could not Select the filter", YesNo.No);
	 * sa.assertTrue(false, "Could not Select the filter"); } } } else {
	 * sa.assertTrue(false,
	 * "Global Filter not Added, So Not able to check Filters for Admin and both Users in :"
	 * + TabName.HomeTab.toString()); log(LogStatus.SKIP,
	 * "Global Filter not Added, So Not able to check Filters for Admin and both Users in :"
	 * + TabName.HomeTab.toString(), YesNo.Yes); }
	 * 
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc068_EditAppPageAndAddFilter(String projectName) {
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * HomePageBusineesLayer home = new HomePageBusineesLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 ...
	 * FieldAndRelationshipPageBusinessLayer(driver); EditPageBusinessLayer EP = new
	 * EditPageBusinessLayer(driver); String labelName = "Testing1234"; String
	 * tableName = "Test"; String appPage = "Custom App Page";
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName);
	 * 
	 * if (BP.openAppFromAppLauchner(appPage, 50)) { if
	 ...
	 * , "", "")) { log(LogStatus.PASS, "Filter has been added on the page",
	 * YesNo.Yes); sa.assertTrue(true, "Filter has been added on the page"); } else
	 * { log(LogStatus.ERROR, "Could not edit the Page and add the Filter",
	 * YesNo.Yes); sa.assertTrue(false, "Could not edit the Page and add the SDG");
	 * }
	 * 
	 * } else { log(LogStatus.ERROR, "Could not open the App from the App Launcher",
	 ...
	 * 
	 * @Test public void
	 * M9Tc069_VerifyFundAndFirmDropDownCountAndAcendingOrder(String projectName) {
	 * SetupPageBusinessLayer setup = new SetupPageBusinessLayer(driver);
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * HomePageBusineesLayer home = new HomePageBusineesLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 ...
	 * FieldAndRelationshipPageBusinessLayer fr = new
	 * FieldAndRelationshipPageBusinessLayer(driver); EditPageBusinessLayer EP = new
	 * EditPageBusinessLayer(driver);
	 * 
	 * String appPage = "Custom App Page"; lp.CRMLogin(superAdminUserName,
	 ...
	 * YesNo.No);
	 * 
	 * } else { log(LogStatus.INFO,
	 * "Dropdown count and Ascending order is not matched of ", YesNo.No); }
	 * 
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc070_VerifyGlobalFilterForFundAndFirm(String
	 * projectName) { LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); HomePageBusineesLayer home = new
	 * HomePageBusineesLayer(driver); SetupPageBusinessLayer setup = new
	 * SetupPageBusinessLayer(driver); BasePageBusinessLayer BP = new
	 * BasePageBusinessLayer(driver); LightningAppBuilderPageBusinessLayer
	 * AppBuilder = new LightningAppBuilderPageBusinessLayer(driver);
	 * FieldAndRelationshipPageBusinessLayer fr = new
	 * FieldAndRelationshipPageBusinessLayer(driver); EditPageBusinessLayer EP = new
	 ...
	 * lp.CRMLogin(superAdminUserName, adminPassword, appName);
	 * 
	 * String appPage = "Custom App Page"; String pageSize = "100"; String
	 * fundSDGName = "Fund Filter Grid"; String accountSDGName =
	 * "Account Filter Grid"; String fundraisingSDGName = "Fundraising Filter Grid";
	 ...
	 * @Parameters({ "projectName" })
	 * 
	 * @Test public void M9Tc071_AddFilterSequenceAndVerifyRecord(String
	 * projectName) { SetupPageBusinessLayer setup = new
	 * SetupPageBusinessLayer(driver); LoginPageBusinessLayer lp = new
	 * LoginPageBusinessLayer(driver); HomePageBusineesLayer home = new
	 * HomePageBusineesLayer(driver); BasePageBusinessLayer BP = new
	 ...
	 * FieldAndRelationshipPageBusinessLayer fr = new
	 * FieldAndRelationshipPageBusinessLayer(driver); EditPageBusinessLayer EP = new
	 * EditPageBusinessLayer(driver); SDGPageBusinessLayer SB = new
	 * SDGPageBusinessLayer(driver); String appPage = "Custom App Page"; String
	 * fundraisingSDGName = "Fundraising Filter Grid"; int
	 * fundraisingRowCountBeforeFilter, fundraisingRowCountAfterFilter; String
	 * pageSize = "100"; lp.CRMLogin(superAdminUserName, adminPassword, appName);
	 * 
	 * if (BP.openAppFromAppLauchner(60, "Sortable Data Grids")) { if
	 * (SB.sequenceFilter(projectName, "Fund Filter Grid")) { if
	 ...
	 * "Appfluent Technology")) { log(LogStatus.INFO,
	 ...
	 * }
	 * 
	 * log(LogStatus.INFO, "Sequence filter is not added", YesNo.No); } else {
