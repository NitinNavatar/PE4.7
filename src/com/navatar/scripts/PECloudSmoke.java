	...
	public void smokeTc003_2_createDataAndVerifyOnHomepageSDGAndComponent(String projectName){
		...
		// contact
			...
			//deal	
				...
				if (lp.createActivityTimeline("", true, "Task", basicSection, taskData, null, null, false, null, null, null, null, null)) {
...
//		}
			...
			if (npbl.clickOnNavatarEdgeLinkHomePage(projectName, navigationMenuName, action.BOOLEAN, 30)) {
				...
				if (flag) {
					...
					if (i==0) {
						...
						if(lp.createActivityTimeline("", true,NewInteractions_DefaultValues.Call.toString(), basicTask, advanceTask, null, null, false, null, null, null, null, null)) {
							log(LogStatus.INFO,"successfully created : "+subject+" for "+newInteractionsNavigationLink,  YesNo.No);
	...
	public void SmokeTc014_1_CreateSomeActivityAndVerifyTheActivitytimelineOnTestContact1RelatedPage(String projectName) {
		...
		if (lp.createActivityTimeline("", true, NewInteractions_DefaultValues.Task.toString(), basictask, advancetask, null, null, false, null, null, null, null, null)) {
...
//					}
	...
	public void SmokeTc028_CreateWatchlistTaskEventsAndCall(String projectName) {
		...
		for(int i=0;i<2;i++){
			...
			if (lp.createActivityTimeline("", true, NewInteractions_DefaultValues.Task.toString(), basicTask[i], advancetask[i], null, null, false, null, null, null, null, null)) {
				log(LogStatus.INFO,"Able to create task : "+task,YesNo.No);
...
//		}
		...
		for(int i=0;i<basicCall.length;i++){
			...
			if (lp.createActivityTimeline("", true, NewInteractions_DefaultValues.Call.toString(), basicCall[i], null, null, null, false, null, null, null, null, null)) {
				log(LogStatus.INFO,"Able to create task : "+task,YesNo.No);
...
//		}
	...
	public void SmokeTc031_CreateCallAndVerifyLastTouchPointAtContactPage(String projectName) {
		...
		if (lp.createActivityTimeline("",true, "Call", logACall, advanceCall, null, null, false, null, null, null, null, null)) {
