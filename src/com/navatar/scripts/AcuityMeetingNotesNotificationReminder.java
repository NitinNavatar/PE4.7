...
public class AcuityMeetingNotesNotificationReminder extends BaseLib {
	...
	public void AcuityMNNRTc002_VerifyTheUIOfMeetingNotesPopUpFromAddNoteButtonPlacedOnAcuityTabInteractionSection(
		...
		String getAdvanceDueDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "MMM dd, yyyy",
				Integer.parseInt("0"));
		...
		String taskSectionDueDateOnly = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "MMM dd, yyyy",
				Integer.parseInt("0"));
...
//		String status = AMNNR_AdvanceStatus15;
		...
		String[][] tasksSectionVerificationData = { { AMNNR_TaskLabel1, task1SubjectName },
				{ AMNNR_CallLabel5, crmUser1FirstName + " " + crmUser1LastName }, { AMNNR_TaskLabel5, "Not Started" },
				{ AMNNR_CallLabel4, getAdvanceDueDateInTaskSection } };
...
//		String status = AMNNR_AdvanceStatus17;
	 ...
	 * 
	 * @Test public void
	 * AcuityMNNRTc054_VerifyNotesSectionForTheMultipleScenarios(String projectName)
	 * {
	 * 
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 * 
	 * String recordName = "Sumo Logic"; String task1SubjectName = "Notes Test";
	 * String task1Notes = " @sumo"; String[] suggestedTags =
	 * "SuggestedPopUpShouldNotThere".split("<break>", -1); String relatedTo =
	 * recordName + "<Prefilled>"; String AdvanceDueDate =
	 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
	 * Integer.parseInt("4")); String getAdvanceDueDate = AdvanceDueDate;
	 * 
	 * String task1UpdatedNotes1 = "@sumo Ki"; String[] updatedSuggestedTags1 =
	 * "Cancel<Section>Sumo Kind==Firm<break>Sumo Kind==Contact<break>Sumo Kind==Deal<break>Sumo Kind Fund==Fund<break>Sumo Kind Theme==Theme<break>Sumo Kind Custom==Test Custom Object<break>Sumo Kind Fundraising==Fundraising"
	 * .split("<break>", -1);
	 * 
	 * String task1UpdatedNotes2 = ""; String[] updatedSuggestedTags2 =
	 * "SuggestedPopUpShouldNotThere".split("<break>", -1);
	 * 
	 * String task1UpdatedNotes3 = "@ sumo kind"; String[] updatedSuggestedTags3 =
	 * "Cancel<Section>Sumo Kind==Firm<break>Sumo Kind==Contact<break>Sumo Kind==Deal<break>Sumo Kind Fund==Fund<break>Sumo Kind Theme==Theme<break>Sumo Kind Custom==Test Custom Object<break>Sumo Kind Fundraising==Fundraising"
	 * .split("<break>", -1);
	 * 
	 ...
	 * };
	 * 
	 * String[][] task1UpdateBasicSection1 = { { AMNNR_TaskLabel2,
	 * task1UpdatedNotes1 } };
	 * 
	 * String[][] task1UpdateAdvancedSection1 = null;
	 * 
	 * String[][] task1UpdateBasicSection2 = { { AMNNR_TaskLabel2,
	 * task1UpdatedNotes2 } };
	 * 
	 * String[][] task1UpdateAdvancedSection2 = null;
	 * 
	 * String[][] task1UpdateBasicSection3 = { { AMNNR_TaskLabel2,
	 * task1UpdatedNotes3 } };
	 * 
	 ...
	 * 
	 * if (BP.clickOnRecordPageButtonForNewRecordCreation(recordPageButtonName, 30))
	 * { log(LogStatus.INFO, "Clicked on Button: " + recordPageButtonName +
	 * " of Record Page: " + recordName, YesNo.No);
	 * 
	 * if (BP.updateActivityTimelineRecord(projectName, task1BasicSection,
	 * task1AdvancedSection, null, suggestedTags, null)) { log(LogStatus.PASS,
	 * "Activity timeline record has been Created", YesNo.No);
	 * 
	 * } else { log(LogStatus.FAIL, "Activity timeline record has not Created",
	 * YesNo.No); sa.assertTrue(false, "Activity timeline record has not Created");
	 * }
	 * 
	 * CommonLib.refresh(driver);
	 * 
	 * if (BP.crossIconButtonInNotePopUp(5) != null) { click(driver,
	 * BP.crossIconButtonInNotePopUp(20), "Clicked on Cross Icon of PopUp",
	 * action.SCROLLANDBOOLEAN); } CommonLib.refresh(driver); if (click(driver,
	 * BP.editButtonOnInteractionCard(task1SubjectName, 20), "Edit Note Button of: "
	 * + task1SubjectName, action.SCROLLANDBOOLEAN)) { log(LogStatus.INFO,
	 * "clicked on Edit Note button", YesNo.No); if
	 * (BP.updateActivityTimelineRecord(projectName, task1UpdateBasicSection1,
	 ...
	 * + task1SubjectName, action.SCROLLANDBOOLEAN)) { log(LogStatus.INFO,
	 * "clicked on Edit Note button", YesNo.No); if
	 * (BP.updateActivityTimelineRecord(projectName, task1UpdateBasicSection2,
	 ...
	 * YesNo.No); sa.assertTrue(false, "Not able to click on Edit Note button"); }
	 * 
	 * CommonLib.refresh(driver); if (BP.crossIconButtonInNotePopUp(5) != null) {
	 * click(driver, BP.crossIconButtonInNotePopUp(20),
	 * "Clicked on Cross Icon of PopUp", action.SCROLLANDBOOLEAN); }
	 * CommonLib.refresh(driver); if (click(driver,
	 * BP.editButtonOnInteractionCard(task1SubjectName, 20), "Edit Note Button of: "
	 * + task1SubjectName, action.SCROLLANDBOOLEAN)) { log(LogStatus.INFO,
	 * "clicked on Edit Note button", YesNo.No); if
	 * (BP.updateActivityTimelineRecord(projectName, task1UpdateBasicSection3,
	 ...
	 * YesNo.No); sa.assertTrue(false, "Not able to click on Edit Note button"); }
	 * 
	 * } else { log(LogStatus.ERROR, "Not able to Click on Button: " +
	 * recordPageButtonName + " of Record Page: " + recordName, YesNo.No);
	 * sa.assertTrue(false, "Not able to Click on Button: " + recordPageButtonName +
	 * " of Record Page: " + recordName); }
	 * 
	 * } else { log(LogStatus.ERROR, "Not able to Open the Record: " + recordName,
	 ...
	 * 
	 * @Test public void
	 * AcuityMNNRTc055_VerifyTheValidationOnTaskPopUpWhenFieldsAreMadeMandetoryFromThePageLayoutAndHitSave(
	 * String projectName) {
	 * 
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * HomePageBusineesLayer home = new HomePageBusineesLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 * 
	 * String validationRuleMessage = "Please enter the " + AMNNR_TaskLabel1 +
	 * " Name"; String validationRuleErrorMsgLocation = "Field<break>Status"; String
	 * status = "-None-"; String[][] task1BasicSection = null;
	 * 
	 * String[][] task1AdvancedSection = { { AMNNR_TaskLabel5, status } }; String
	 * task1ButtonName = AMNNR_ActivityType1;
	 * 
	 * lp.CRMLogin(crmUser1EmailID, adminPassword);
	 * 
	 ...
	 * true, validationRuleMessage, validationRuleErrorMsgLocation)) {
	 * log(LogStatus.PASS, "------Verified the Error Msg on Note Popup of: " +
	 * task1ButtonName + "------", YesNo.No);
	 * 
	 ...
	 * 
	 * @Test public void
	 * AcuityMNNRTc056_VerifyTheErrorMessageOnNotesPopUpWhenValidationRuleIsCreated(
	 * String projectName) {
	 * 
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * SetupPageBusinessLayer sp = new SetupPageBusinessLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 * 
	 * String fieldName = AMNNR_TaskLabel1; String validationRuleName =
	 * "Validation_Rule_" + AMNNR_TaskLabel1; String validationRuleFormula =
	 * " ISBLANK( Subject ) "; String validationRuleMessage = "Please enter the " +
	 * AMNNR_TaskLabel1 + " Name"; String validationRuleErrorMsgLocation =
	 * "Top of Page"; String task1Notes = "";
	 * 
	 * String[][] task1BasicSection = { { AMNNR_TaskLabel1, "" } };
	 * 
	 * String[][] task1AdvancedSection = null; String task1ButtonName =
	 * "Create Task";
	 * 
	 ...
	 * 
	 * if (sp.createValidationRule(object.Task, fieldName, validationRuleName,
	 * validationRuleFormula, validationRuleMessage,
	 * validationRuleErrorMsgLocation)) { log(LogStatus.PASS,
	 * "------Succesfully Created the Validation Rule named: " + validationRuleName
	 * + "------", YesNo.No); lp.CRMlogout(); CommonLib.ThreadSleep(8000);
	 * lp.CRMLogin(crmUser1EmailID, adminPassword); if
	 * (BP.navigateToRecordAndClickOnSubTab(projectName, tabObj1, recordName, null))
	 * { log(LogStatus.INFO, "Able to Open the Record: " + recordName, YesNo.No); if
	 * (BP.createActivityTimeline(projectName, false, task1ButtonName,
	 * task1BasicSection, task1AdvancedSection, null, null, true,
	 * validationRuleMessage, validationRuleErrorMsgLocation)) { log(LogStatus.PASS,
	 * "------Verified the Error Msg on Note Popup of: " + task1ButtonName +
	 * "------", YesNo.No);
	 * 
	 * } else { log(LogStatus.FAIL,
	 * "------Not Verified the Error Msg on Note Popup of: " + task1ButtonName +
	 ...
	 * } else {
	 * 
	 * log(LogStatus.ERROR, "------Not able to Create the Validation Rule Named: " +
	 ...
	 * 
	 * @Test public void
	 * AcuityMNNRTc058_VerifyWhenTaskIsCreatedAndNoNotesAreMaintained(String
	 * projectName) {
	 * 
	 * LoginPageBusinessLayer lp = new LoginPageBusinessLayer(driver);
	 * BasePageBusinessLayer BP = new BasePageBusinessLayer(driver);
	 ...
	 * "M/d/yyyy", Integer.parseInt("1"));
	 * 
	 * String getAdvanceDueDate = AdvanceDueDate;
	 * 
	 * String task1SubjectName = "Prepare Invoice"; String task1Notes = ""; String
	 * relatedTo = "Houlihan Lokey<break>Glomez"; String priority = "Not Started";
	 * String status = "Normal"; String classification = "A";
	 * 
	 * String[][] task1BasicSection = { { AMNNR_TaskLabel1, task1SubjectName }, {
	 * AMNNR_TaskLabel2, task1Notes }, { AMNNR_TaskLabel3, relatedTo } };
	 * 
	 ...
	 * 
	 * String task1ButtonName = "Create Task"; String recordName = "Sumo Logic";
	 * 
	 * lp.CRMLogin(crmUser1EmailID, adminPassword); if
	 * (BP.navigateToRecordAndClickOnSubTab(projectName, tabObj1, recordName, null))
	 * { log(LogStatus.INFO, "Able to Open the Record: " + recordName, YesNo.No); if
	 * (BP.createActivityTimeline(projectName, false, task1ButtonName,
	 * task1BasicSection, task1AdvancedSection, null, null, false, null, null)) {
	 * log(LogStatus.PASS, "------Verified the Error Msg on Note Popup of: " +
	 * task1ButtonName + "------", YesNo.No);
	 * 
	 * } else { log(LogStatus.FAIL,
