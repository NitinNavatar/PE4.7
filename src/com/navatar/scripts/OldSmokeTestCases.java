...
// pipeline related list on company page (Pipeline Name<>Stage<>Log In Date<>Investment Size<>Source Firm<>Deal Type<>Our Role)	
	...
	public void PESmokeTc072_CreateActivitiesWithContact(String environment, String mode){
		...
		if (home.createActivityTimeline("", true, NewInteractions_DefaultValues.Task.toString(), basic, new String[][] {{"Due Date Only",todaysDate}}, null, null, false, null, null)) {
		...
		if (home.createActivityTimeline("", true, NewInteractions_DefaultValues.Call.toString(), basicCall,advanceCall , null, null, false, null, null)) {
...
//							}
	...
	public void PESmokeTc081_CreateActivitiesWithContact(String environment, String mode){
			...
			if (lp.createActivityTimeline("", true, NewInteractions_DefaultValues.Task.toString(), basic, new String[][] {{"Due Date Only",todaysDate}}, null, null, false, null, null)) {
				log(LogStatus.INFO,"Able to create task : "+task,YesNo.No);
