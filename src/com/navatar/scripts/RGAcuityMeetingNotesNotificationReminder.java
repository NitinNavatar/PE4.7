...
public class RGAcuityMeetingNotesNotificationReminder extends BaseLib {
	...
	public void rgAcuityMNNRTc001_CreateAnEventAndVerifyTheNotificationOnRecordPageAndHomePage(String projectName) {
		...
		String eventTitle = RGAMNNR_Subject1;

		String eventAttendees = RGAMNNR_RelatedTo1 + "," + crmUser2EmailID + ";";
		...
		String startTime = RGAMNNR_EventStartTime1;
		String endTime = RGAMNNR_EventEndTime1;
		String descriptionBox = RGAMNNR_EventDescription1;
		String recordName = RGAMNNR_Contact1;
		...
		String[] RelatedToVerifyInInteraction = RGAMNNR_ATRelatedTo1.split("<break>");
		String[] RelatedAssociationVerifyInInteraction = (RGAMNNR_Contact1 + "<break>" + user2FullName + "<break>"
		 ...
		 * "Dealroom1.3+Max@gmail.com,Dealroom1.3+Martha@gmail.com,dealroom1.3+con9@gmail.com"
		 * + "," + crmUser2EmailID;
		 * 
		 * String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30",
		 * "M/d/yyyy", 1); String endDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 1);
		 * 
		 * String user2FullName; if (!crmUser2FirstName.equals("") &&
		 * !crmUser2LastName.equals("")) { user2FullName = crmUser2FirstName + " " +
		 * crmUser2LastName; } else { user2FullName = crmUser2LastName;
		 * 
		 * }
		 * 
		 * String user1FullName; if (!crmUser1FirstName.equals("") &&
		 * !crmUser1LastName.equals("")) { user1FullName = crmUser1FirstName + " " +
		 * crmUser1LastName; } else { user1FullName = crmUser1LastName;
		 * 
		 * }
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
		 * descriptionBox = "Revenue Grid Event"; String recordName = "con 9"; String
		 * relatedToNotContains = user2FullName; String[][]
		 * relatedAssociationNotContains = { { "Related_To", relatedToNotContains } };
		 * String descriptionBoxOnInteractonCard = ""; String
		 * dateToVerifyOnInteractionCard = startDate ; String[]
		 * RelatedToVerifyInInteraction = "Martha<break>Max<break>+3".split("<break>");
		 * String[] RelatedAssociationVerifyInInteraction = ("con 9" + "<break>" +
		 * user2FullName + "<break>" + (user1FullName).trim()).split("<break>", -1);
		 * 
		 */
		/*
	...
	public void rgAcuityMNNRTc002_CreateAnEventAndVerifyTheNotificationOnRecordPageAndHomePageForMultipleEventsBasedOnRecordPages(
		...
		String eventTitles[] = RGAMNNR_Subject2.split("<Section>", -1);
		String eventAttendees[] = (RGAMNNR_RelatedTo2 + "," + crmUser2EmailID + "<Section>" + RGAMNNR_RelatedTo3 + ","
				+ crmUser2EmailID + ";").split("<Section>", -1);
		...
		String startTime[] = (RGAMNNR_EventStartTime2).split("<Section>", -1);
		String endTime[] = (RGAMNNR_EventEndTime2).split("<Section>", -1);
		String descriptionBox = null;

		String updatedRelatedTo[] = RGAMNNR_RelatedTo4.split("<Section>", -1);

		String[][] task1UpdateAdvancedSection = null;
		String[] updatedSuggestedTags = null;

		String contactRecordName = RGAMNNR_Contact2;

		String accountRecordName1 = RGAMNNR_FirmLegalName1;
		String accountRecordType1 = RGAMNNR_FirmRecordType1;
		String accountRecordName2 = RGAMNNR_FirmLegalName2;
		String accountRecordType2 = RGAMNNR_FirmRecordType2;

		/*
		 * 
		 * String eventTitles[] = "Event 1.0<Section>Event 2.0".split("<Section>", -1);
		 * String eventAttendees[] = ("Dealroom1.3+James@gmail.com" + "," +
		 * crmUser2EmailID + "<Section>" + "Dealroom1.3+Litz@gmail.com" + "," +
		 * crmUser2EmailID).split("<Section>", -1); String startDate[] =
		 * (CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2) +
		 * "<Section>" + CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
		 * -2)).split("<Section>", -1); String endDate[] =
		 * (CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1) +
		 * "<Section>" + CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
		 * -1)).split("<Section>", -1);
		 * 
		 * String startTime[] = ("2:00 PM<Section>4:00 PM").split("<Section>", -1);
		 * String endTime[] = ("3:00 PM<Section>5:00 PM").split("<Section>", -1); String
		 * descriptionBox = null;
		 * 
		 * String updatedRelatedTo[] =
		 * "Sumo Logic<break>Maxjonic<Section>Nexus<break>Demo Deal<break>Acc 1"
		 * .split("<Section>", -1);
		 * 
		 * String[][] task1UpdateAdvancedSection = null; String[] updatedSuggestedTags =
		 * null;
		 * 
		 * String contactRecordName = "Litz";
		 * 
		 * String accountRecordName1 = "Maxjonic"; String accountRecordType1 =
		 * "Intermediary"; String accountRecordName2 = "Nexus"; String
		 * accountRecordType2 = "Institution";
		 * 
		 */
	...
	public void rgAcuityMNNRTc003_CreateAnEventAndVerifyItOnNotificationOnRecordPageAndHomePage(String projectName) {
		...
		String eventTitle = RGAMNNR_Subject5;
		String eventAttendees = RGAMNNR_RelatedTo5 + "," + crmUser2EmailID + ";";

		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime5;
		String endTime = RGAMNNR_EventEndTime5;
		String descriptionBox = RGAMNNR_EventDescription5;
		String recordName = RGAMNNR_Contact1;
		String user1FullName;
		if (!crmUser1FirstName.equals("") && !crmUser1LastName.equals("")) {
			user1FullName = crmUser1FirstName + " " + crmUser1LastName;
		...
		String RelatedToVerifyInNotes = (RGAMNNR_RelatedTo6 + user1FullName + "<break>" + user2FullName)
				.replaceAll(" +", " ");

		String[] RelatedAssociationVerifyInInteraction = null;

		String eventTitleUpdated = RGAMNNR_Subject7;
		String updatedRelatedTo = RGAMNNR_RelatedTo7;

		String[][] task1UpdateBasicSection = { { "Subject", eventTitleUpdated }, { "Related_To", updatedRelatedTo } };
		String[][] task1UpdateAdvancedSection = null;
		String[] updatedSuggestedTags = null;
		String contactRecordName = recordName;
		String accountRecordName = RGAMNNR_FirmLegalName3;
		String accountRecordType = RGAMNNR_FirmRecordType3;
		...
		/*
		 * String eventTitle = "Seminar"; String eventAttendees =
		 * "Dealroom1.3+Max@gmail.com,Dealroom1.3+Martha@gmail.com,dealroom1.3+con9@gmail.com"
		 * + "," + crmUser2EmailID; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
		 * descriptionBox = "Revenue Grid Event"; String recordName = "con 9"; String
		 * user1FullName; if (!crmUser1FirstName.equals("") &&
		 * !crmUser1LastName.equals("")) { user1FullName = crmUser1FirstName + " " +
		 * crmUser1LastName; } else { user1FullName = crmUser1LastName;
		 * 
		 * }
		 ...
		 * }
		 * 
		 * String dateToVerifyOnInteractionCard = startDate; String[]
		 * RelatedToVerifyInInteraction = "Max<break>Martha<break>+3".split("<break>",
		 * -1); String RelatedToVerifyInNotes = ("Max<break>Martha<break>con 9<break>" +
		 * user1FullName + "<break>" + user2FullName).replaceAll(" +", " ");
		 * 
		 * String[] RelatedAssociationVerifyInInteraction = null;
		 * 
		 * String eventTitleUpdated = "Seminar Done"; String updatedRelatedTo =
		 * "Houlihan Lokey<break>Sumo Logic";
		 * 
		 * String[][] task1UpdateBasicSection = { { "Subject", eventTitleUpdated }, {
		 * "Related_To", updatedRelatedTo } }; String[][] task1UpdateAdvancedSection =
		 * null; String[] updatedSuggestedTags = null; String contactRecordName =
		 * recordName; String accountRecordName = "Houlihan Lokey"; String
		 * accountRecordType = "Institution";
		 * 
		 * String[][] event1BasicSectionVerificationInNotesPopup = { { "Subject",
		 * eventTitle }, { "Notes", "" }, { "Related_To", RelatedToVerifyInNotes } };
		 * String[][] event1AdvancedSectionVerificationInNotesPopup = { { "Location", ""
		 * }, { "Assigned To ID", user1FullName }, { "Start Date Time<break>Date",
		 * startDate }, { "End Date Time<break>Date", endDate } };
		 * 
		 */
	...
	public void rgAcuityMNNRTc004_LoginToTheOrgAsUser2AndVerifyTheNotificationPopUp(String projectName) {
		...
		String eventTitleUpdated = RGAMNNR_Subject7;
		String contactRecordName = RGAMNNR_Contact1;
		String contactRecordNameUser1User2AndAdminNotContain = RGAMNNR_Contact3;

		String accountRecordName = RGAMNNR_FirmLegalName4;
		String accountRecordType = RGAMNNR_FirmRecordType4;
		String accountRecordNameUser1User2AndAdminNotContain = RGAMNNR_FirmLegalName5;
		String accountRecordTypeUser1User2AndAdminNotContain = RGAMNNR_FirmRecordType5;

		/*
		 * String eventTitleUpdated = "Seminar Done"; String contactRecordName =
		 * "con 9"; String contactRecordNameUser1User2AndAdminNotContain = "Con 1";
		 * 
		 * String accountRecordName = "Sumo Logic"; String accountRecordType =
		 * "Company"; String accountRecordNameUser1User2AndAdminNotContain = "Acc 3";
		...
		log(LogStatus.INFO,
				"---------Now Going to Verify Event: " + eventTitleUpdated
						+ " on Home Page as well as on Detail Page in case of User 2: " + crmUser2EmailID + "---------",
				YesNo.No);
		...
		if (lp.clickOnTab(projectName, tabObj2)) {
			...
			if (BP.clickOnAlreadyCreated_Lighting(environment, mode, TabName.ContactTab,
				...
				if (BP.clicktabOnPage("Acuity")) {
					...
					if (!BP.clickOnSubjectOfInteractionEitherOnCardOrInViewAllPopUp(eventTitleUpdated)) {
						log(LogStatus.INFO, "Event Detail Page has not been open for Record: " + eventTitleUpdated
								+ " in case of User 2 in Detail Page: " + contactRecordNameUser1User2AndAdminNotContain,
								YesNo.No);
	...
	public void rgAcuityMNNRTc005_UpdateAllEventFieldsOneByOneAndVerifyCustomNotification(String projectName) {
		...
		String[][] event1UpdateBasicSection = { { "Related_To", RGAMNNR_RelatedTo8 } };
		...
		String[][] event1UpdateBasicSectionOnHomepageNotePopup2 = { { "Location", RGAMNNR_Location7 } };
		String[][] event1UpdateAdvancedSectionOnHomepageNotePopup2 = null;
		String[] eventupdatedSuggestedTagsOnHomepageNotePopup2 = null;

		String recordName = RGAMNNR_FirmLegalName6;
		String recordType = RGAMNNR_FirmRecordType6;
		 ...
		 * crmUser2LastName; } else { user2FullName = crmUser2LastName;
		 * 
		 * } String RelatedToVerifyInNotes = ("Max<break>Martha<break>con 9<break>" +
		 * user1FullName + "<break>" + user2FullName).replaceAll(" +", " "); String[]
		 * labelAndValueSeprateByBreak = { "Assigned To" + "<break>" + user1FullName,
		 * "Subject" + "<break>" + eventTitleUpdated, "Name" + "<break>" + "" };
		 * 
		 * String[][] event1BasicSectionVerificationInNotesPopup = { { "Subject",
		 * eventTitleUpdated }, { "Notes", "" }, { "Related_To", RelatedToVerifyInNotes
		 * } }; String[][] event1AdvancedSectionVerificationInNotesPopup = { {
		 * "Location", "" }, { "Assigned To ID", user1FullName }, {
		 * "Start Date Time<break>Date", startDate }, { "End Date Time<break>Date",
		 * endDate } };
		 * 
		 * String[][] event1UpdateBasicSection = { { "Related_To", "Vertica" } };
		 * String[][] event1UpdateAdvancedSection = null; String[] updatedSuggestedTags
		 * = null; String getAdvanceDueDate = startDate; String[] updatedRelatedToVerify
		 * = null;
		 * 
		 * String updateStartDateOnHomepageNotePopup =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1); String
		 * updateEndDateOnHomepageNotePopup =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0); String[][]
		 * event1UpdateBasicSectionOnHomepageNotePopup = { {
		 * "Start Date Time<break>Date", updateStartDateOnHomepageNotePopup }, {
		 * "End Date Time<break>Date", updateEndDateOnHomepageNotePopup } }; String[][]
		 * event1UpdateAdvancedSectionOnHomepageNotePopup = null; String[]
		 * eventupdatedSuggestedTagsOnHomepageNotePopup = null; String
		 * getAdvanceDueDate2 = updateStartDateOnHomepageNotePopup; String[][]
		 * event1UpdateBasicSectionOnHomepageNotePopup2 = { { "Location", "NY" } };
		 * String[][] event1UpdateAdvancedSectionOnHomepageNotePopup2 = null; String[]
		 * eventupdatedSuggestedTagsOnHomepageNotePopup2 = null;
		 * 
		 * String recordName = "Vertica"; String recordType = "Company";
		 * 
		 */
	...
	public void rgAcuityMNNRTc006_AddTheNotesFromInteractionnSectionAddNotesButtonAndVerifyTheNotification(
		...
		String eventTitleUpdated = RGAMNNR_Subject7;
		String contactRecordName = RGAMNNR_Contact4;

		String accountRecordName = RGAMNNR_FirmLegalName3;
		String accountRecordType = RGAMNNR_FirmRecordType3;

		String[][] event1BasicSectionVerificationInNotesPopup = { { "Location", RGAMNNR_Location7 } };
		String[][] event1AdvancedSectionVerificationInNotesPopup = null;
		String[][] event1UpdateBasicSection = { { "Notes", RGAMNNR_Notes9 } };
		String[][] event1UpdateAdvancedSection = null;
		String[] event1UpdatedSuggestedTags = RGAMNNR_RelatedTo9.split("<break>", -1);

		/*
		 * String eventTitleUpdated = "Seminar Done"; String contactRecordName = "Max";
		 * 
		 * String accountRecordName = "Houlihan Lokey"; String accountRecordType =
		 * "Institution";
		 * 
		 * String[][] event1BasicSectionVerificationInNotesPopup = { { "Location", "NY"
		 * } }; String[][] event1AdvancedSectionVerificationInNotesPopup = null;
		 * String[][] event1UpdateBasicSection = { { "Notes",
		 * "Lomez and Vertica Houlihan Lokey can be considered as good opportunity." }
		 * }; String[][] event1UpdateAdvancedSection = null; String[]
		 * event1UpdatedSuggestedTags =
		 * "Vertica<break>Houlihan Lokey<break>Lomez".split("<break>", -1);
		 * 
		 */
	...
	public void rgAcuityMNNRTc007_CreateEventAndAddTheNotesByLogingAsAttendeeUserAndVerifyTheReminderByLogingAsAssignedUser(
		...
		String eventTitle = RGAMNNR_Subject10;
		String eventAttendees = RGAMNNR_RelatedTo10 + "," + crmUser1EmailID + "," + crmUser2EmailID + ","
				+ crmUser3EmailID + "," + superAdminUserName + ";";

		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime10;
		String endTime = RGAMNNR_EventEndTime10;
		String descriptionBox = RGAMNNR_EventDescription10;

		String task1NotesUpdated = RGAMNNR_Notes11;
		String[][] task1UpdateBasicSection = { { "Notes", task1NotesUpdated } };
		String[][] task1UpdateAdvancedSection = null;
		String[] updatedSuggestedTags = RGAMNNR_SuggestedTag11.split("<break>", -1);
		String contactRecordName = RGAMNNR_Contact5;
		String accountRecordName = RGAMNNR_FirmLegalName3;
		String accountRecordType = RGAMNNR_FirmRecordType3;

		/*
		 * String eventTitle = "Deal Booking Event 1"; String eventAttendees =
		 * "Dealroom1.3+James@gmail.com,Dealroom1.3+Jhon@gmail.com" + "," +
		 * crmUser1EmailID + "," + crmUser2EmailID + "," + crmUser3EmailID + "," +
		 * superAdminUserName; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
		 * descriptionBox = "Revenue Grid Event";
		 * 
		 * String task1NotesUpdated =
		 * "As per your info tagging Account Houlihan Lokey, Acc 11 and Contact  Lomez too."
		 * ; String[][] task1UpdateBasicSection = { { "Notes", task1NotesUpdated } };
		 * String[][] task1UpdateAdvancedSection = null; String[] updatedSuggestedTags =
		 * "Houlihan Lokey<break>Acc 11<break>Lomez".split("<break>", -1); String
		 * contactRecordName = "James"; String accountRecordName = "Houlihan Lokey";
	...
	public void rgAcuityMNNRTc008_LoginAsUser1CreateTheEventByChangingTheAssignedToUserAndVerifyTheNotificationForTheDifferentUsersWhichAreNeitherAnAttendeeNorAsignedAsUser(
		...
		String eventTitle = RGAMNNR_Subject12;
		String eventAttendees = RGAMNNR_RelatedTo12;

		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime12;
		String endTime = RGAMNNR_EventEndTime12;
		String descriptionBox = RGAMNNR_EventDescription12;

		String contactRecordName = RGAMNNR_Contact5;
		String accountRecordName = RGAMNNR_FirmLegalName6;
		String accountRecordType = RGAMNNR_FirmRecordType6;
		String updatedRelatedToInNotes = RGAMNNR_RelatedTo13;
		...
		/*
		 * String eventTitle = "Opportunity 1"; String eventAttendees =
		 * "Dealroom1.3+James@gmail.com"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
		 * descriptionBox = "Revenue Grid Event";
		 * 
		 * String contactRecordName = "James"; String accountRecordName = "Vertica";
		 * String accountRecordType = "Company"; String updatedRelatedToInNotes =
		 * "Maxjonic<break>Sumo Logic<break>Vertica<break>Demo Deal";
		 * 
		 * String user2FullName; if (!crmUser2FirstName.equals("") &&
		 * !crmUser2LastName.equals("")) { user2FullName = crmUser2FirstName + " " +
		 * crmUser2LastName; } else { user2FullName = crmUser2LastName;
		 * 
		 * } String[][] task1UpdateBasicSection = { { "Related_To",
		 * updatedRelatedToInNotes } }; String[][] task1UpdateAdvancedSection = { {
		 * "Assigned To ID", user2FullName } }; String[] updatedSuggestedTags = null;
		 */
	...
	public void rgAcuityMNNRTc009_CreateTheEventWithStartDateInPastEndDateInFutureAndVerifyTheNotificationAndReminderForTheAttendeeUser(
		...
		String eventTitle = RGAMNNR_Subject14;
		String eventAttendees = RGAMNNR_RelatedTo14 + "," + crmUser2EmailID + ";";

		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 1);

		String startTime = RGAMNNR_EventStartTime14;
		String endTime = RGAMNNR_EventEndTime14;
		String descriptionBox = RGAMNNR_EventDescription14;

		String contactRecordName = RGAMNNR_Contact6;

		/*
		 * String eventTitle = "Deal Closing"; String eventAttendees =
		 * "Dealroom1.3+Max@gmail.com,Dealroom1.3+Martha@gmail.com" + "," +
		 * crmUser2EmailID; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 1);
		 * 
	...
	public void rgAcuityMNNRTc010_VerifyTheNotificationWhenEventIsCreatedWithNeitherContactNorRelatedAssociationTagged(
		...
		String eventTitle = RGAMNNR_Subject15;

		String eventAttendees = crmUser4EmailID + ";";
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime15;
		String endTime = RGAMNNR_EventEndTime15;
		String descriptionBox = RGAMNNR_EventDescription15;

		String contactRecordName = RGAMNNR_Contact2;

		/*
		 * String eventTitle = "Announcing RampUp 2022 speakers and more +1"; String
		 * eventAttendees = crmUser4EmailID; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
	...
	public void rgAcuityMNNRTc011_CreateTheEventWithAttendeesTaggedRemoveOneOfTheAttendeeAndVerifyTheNotificationBeforeAndAfterRemovingTheUserAsAttendee(
		...
		String startTime = RGAMNNR_EventStartTime16;
		String endTime = RGAMNNR_EventEndTime16;
		String descriptionBox = RGAMNNR_EventDescription16;
		 ...
		 * String eventAttendees = "Dealroom1.3+Litz@gmail.com" + "," + crmUser2EmailID
		 * + "," + crmUser3EmailID; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String navigateStartDateForEdit = startDate; String
		 * navigateStartDateMonthYearForEdit =
		 * CommonLib.convertDateFromOneFormatToAnother(startDate, "M/d/yyyy",
		 * "MMMM yyyy");
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
		 * descriptionBox = "Revenue Grid Event";
		 ...
		 * String contactRecordName = "Litz";
		 * 
		 * String eventTitleUpdated = null; String eventAttendeesUpdated = null; String
		 * startDateUpdated = null; String endDateUpdated = null; String
		 * startTimeUpdated = null; String endTimeUpdated = null; String
		 * descriptionBoxUpdated = null; String eventAttendeesToRemove =
		 * crmUser2EmailID;
		 */
	...
	public void rgAcuityMNNRTc012_CreateThePastDatedEventVerifyTheNotificationDeleteTheEventAndVerify(
		...
		String eventTitle = RGAMNNR_Subject17;
		String eventAttendees = RGAMNNR_RelatedTo17 + crmUser1EmailID + ";";
		;

		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime17;
		String endTime = RGAMNNR_EventEndTime17;
		String descriptionBox = RGAMNNR_EventDescription17;
		String recordName = RGAMNNR_Contact7;

		String updatedRelatedTo = RGAMNNR_RelatedTo18;
		...
		/*
		 * String eventTitle = "Join all major influencers"; String eventAttendees =
		 * "Dealroom1.3+Lomez@gmail.com," + crmUser1EmailID; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
		 * descriptionBox = "Revenue Grid Event"; String recordName = "Lomez";
		 * 
		 * String updatedRelatedTo = "Sumo Logic"; String[][]
		 * event1UpdateBasicSectionOnHomepageNotePopup = { { "Related_To",
		 * updatedRelatedTo } }; String[][]
		 * event1UpdateAdvancedSectionOnHomepageNotePopup = null; String[]
		 * eventupdatedSuggestedTagsOnHomepageNotePopup = null;
		 * 
		 * String accountRecordName = "Sumo Logic"; String accountRecordType =
	...
	public void rgAcuityMNNRTc013_RestoreTheDeletedEventAndVerifyTheNotificationForUser1(String projectName) {
		...
		String[][] listViewSheetData = { { RGAMNNR_ListViewMember1, RGAMNNR_ListViewTabName1, eventTitle,
				RGAMNNR_ListViewAccessibility1, RGAMNNR_ListViewFilter1, RGAMNNR_ListViewField1,
				RGAMNNR_ListViewOperators1, eventTitle, RGAMNNR_ListViewTextBoxType1 } };
		 ...
		 * 
		 * String[][] listViewSheetData = { { "user 1", "Recycle Bin", eventTitle,
		 * "All users can see this list view", "My recycle bin", "Record Name",
		 * "equals", eventTitle, "TextBox" } }; String accountRecordName = "Sumo Logic";
	...
	public void rgAcuityMNNRTc014_UpdateTheSubjectOfTheEventAndVerifyTheSameAtNotificationPopUpAsWellAsInteractionSection(
		...
		String eventTitleUpdated = RGAMNNR_Subject19;
		 ...
		 * String contactRecordName = "Litz";
		 * 
		 * String eventTitleUpdated =
		 * "Updated This event will have your Business circles talking +3"; String[][]
		 * event1UpdateBasicSectionOnHomepageNotePopup = { { "Subject",
		 * eventTitleUpdated } }; String[][]
		 * event1UpdateAdvancedSectionOnHomepageNotePopup = null; String[]
		 * eventupdatedSuggestedTagsOnHomepageNotePopup = null;
		 */
	...
	public void rgAcuityMNNRTc015_VerifyTheCustomNotificationOnHomePageAsWellAsByClickingOnBellIconForExistingTask(
		...
		String getAdvanceDueDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String task1ButtonName = RGAMNNR_ActivityType20;
		String task1SubjectName = RGAMNNR_Subject20;
		String relatedTo = RGAMNNR_RelatedTo20;
		String[][] task1BasicSection = { { "Subject", task1SubjectName }, { "Related_To", relatedTo } };
		String[][] task1AdvancedSection = { { "Due Date Only", getAdvanceDueDate } };

		String contactRecordName = RGAMNNR_Contact8;
		String recordName = RGAMNNR_FirmLegalName7;
		String recordType = RGAMNNR_FirmRecordType7;

		/*
		 * 
		 * 
		 * String task1ButtonName = "Task"; String task1SubjectName =
		 * "Task For Notification Check"; String relatedTo = "con 3<break>Acc 12";
		 * String[][] task1BasicSection = { { "Subject", task1SubjectName }, {
		 * "Related_To", relatedTo } }; String[][] task1AdvancedSection = { {
		 * "Due Date Only", getAdvanceDueDate } };
		 * 
		 * String contactRecordName = "con 3"; String recordName = "Acc 12"; String
	...
	public void rgAcuityMNNRTc016_VerifyTheCustomNotificationOnHomePageAsWellAsByClickingOnBellIconForExistingCall(
		...
		String task1ButtonName = RGAMNNR_ActivityType21;
		String task1SubjectName = RGAMNNR_Subject21;
		String relatedTo = RGAMNNR_RelatedTo21;
		String[][] task1BasicSection = { { "Subject", task1SubjectName }, { "Related_To", relatedTo } };
		String[][] task1AdvancedSection = { { "Due Date Only", getAdvanceDueDate } };
		...
		/*
		 * 
		 * String task1ButtonName = "Call"; String task1SubjectName =
		 * "Call For Notification Check"; String relatedTo = "con 3<break>Acc 12";
		 * String[][] task1BasicSection = { { "Subject", task1SubjectName }, {
		 * "Related_To", relatedTo } }; String[][] task1AdvancedSection = { {
		 * "Due Date Only", getAdvanceDueDate } };
		 * 
	...
	public void rgAcuityMNNRTc017_AddTheNotesFromTheCustomBellIconAndVerifyTheNotificationBeforeAndAfterUpdatingThenotes(
		...
		String eventTitle = RGAMNNR_Subject22;
		...
		String updatedNotesOfEvent = RGAMNNR_Notes22;
		String[][] event1UpdateBasicSection = { { "Notes", updatedNotesOfEvent } };
		String[][] event1UpdateAdvancedSection = null;
		String[] updatedSuggestedTags = null;

		String accountRecordName = RGAMNNR_FirmLegalName2;
		String accountRecordType = RGAMNNR_FirmRecordType2;
		 ...
		 * 
		 * String[][] event1BasicSectionVerificationInNotesPopup = { { "Subject",
		 * eventTitle }, { "Notes", "" } }; String[][]
		 * event1AdvancedSectionVerificationInNotesPopup = null;
		 * 
		 * String notesVerifyOnInteraction = ""; String[] relatedToVerifyOnInteraction =
		 * null; String updatedNotesOfEvent = "Adding @Glomez @Jack in the loop";
		 * String[][] event1UpdateBasicSection = { { "Notes", updatedNotesOfEvent } };
		 * String[][] event1UpdateAdvancedSection = null; String[] updatedSuggestedTags
		 * = null;
		 * 
		 * String accountRecordName = "Nexus"; String accountRecordType = "Institution";
		 * 
		 */
	...
	public void rgAcuityMNNRTc018_CreateTheEventClickOnTheEventHeaderFromHomePageNotificationAndAddTheNotesAndVerifyTheNotificationPopUp(
		...
		String eventTitle = RGAMNNR_Subject23;
		String eventAttendees = RGAMNNR_RelatedTo23 + "," + crmUser2EmailID + "," + crmUser3EmailID + ";";
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime23;
		String endTime = RGAMNNR_EventEndTime23;
		String descriptionBox = RGAMNNR_EventDescription23;

		String contactRecordName = RGAMNNR_Contact5;
		String relateToVerifyOnNotesPopUp = null;
		String[][] event1BasicSectionVerificationInNotesPopup = { { "Subject", eventTitle },
				{ "Notes", RGAMNNR_Notes23 } };
		String[][] event1AdvancedSectionVerificationInNotesPopup = { { "Location", RGAMNNR_Location23 },
				{ "Assigned To ID", user1FullName }, { "Start Date Time<break>Date", startDate },
				{ "End Date Time<break>Date", endDate } };

		String updatedNotesOfEvent = RGAMNNR_Notes24;
		...
		/*
		 * String eventTitle = "Marketing Webinar 2"; String eventAttendees =
		 * "Dealroom1.3+James@gmail.com,Dealroom1.3+Jhon@gmail.com" + "," +
		 * crmUser2EmailID + "," + crmUser3EmailID + ";"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
		 * descriptionBox = "Revenue Grid Event";
		 * 
		 * String contactRecordName = "James"; String relateToVerifyOnNotesPopUp = null;
		 * String[][] event1BasicSectionVerificationInNotesPopup = { { "Subject",
		 * eventTitle }, { "Notes", "" } }; String[][]
		 * event1AdvancedSectionVerificationInNotesPopup = { { "Location", "" }, {
		 * "Assigned To ID", user1FullName }, { "Start Date Time<break>Date", startDate
		 * }, { "End Date Time<break>Date", endDate } };
		 * 
		 * String updatedNotesOfEvent =
		 * "Deal @sumo logic and @Max fund should be in loop"; String[][]
		 * event1UpdateBasicSectionOnHomepageNotePopup = { { "Notes",
		 * updatedNotesOfEvent } }; String[][]
		 * event1UpdateAdvancedSectionOnHomepageNotePopup = null; String[]
		 * eventupdatedSuggestedTagsOnHomepageNotePopup = null; Integer
		 * countIconBeforeUpdate = 0; Integer countIconAfterUpdate = 0;
		 * 
		 * 
		 */
	...
	public void rgAcuityMNNRTc019_CreateTheEventByTaggingAttendeesMakeOneOfTheAttendeeInactiveAndVerifyTheNotificationPopUpOnceTheUserIsActive(
		...
		String eventTitle = RGAMNNR_Subject25;
		String eventAttendees = RGAMNNR_RelatedTo25 + "," + crmUser2EmailID + "," + crmUser3EmailID + ";";
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime25;
		String endTime = RGAMNNR_EventEndTime25;
		String descriptionBox = RGAMNNR_EventDescription25;
		String recordName = RGAMNNR_Contact7;
		...
		/*
		 * 
		 * String eventTitle = "Mulesoft Connect"; String eventAttendees =
		 * "dealroom1.3+lomez@gmail.com,Dealroom1.3+James@gmail.com" + "," +
		 * crmUser2EmailID + "," + crmUser3EmailID + ";"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 ...
		 * descriptionBox = "Revenue Grid Event"; String recordName = "Lomez";
		 * 
		 * String user3firstName = crmUser3FirstName; String User3LastName =
		 * crmUser3LastName;
		 * 
		 * String user3EmailId = crmUser3EmailID;
		 * 
...
//								}
	...
	public void rgAcuityMNNRTc020_Create4EventsWithSameStartAndEndDateAndTimeAndVerifyTheNotificationPopUp(
		...
		String eventTitles[] = RGAMNNR_Subject26.split("<break>", -1);
		String eventAttendees = RGAMNNR_RelatedTo26 + "," + crmUser1EmailID + ";";
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime26;
		String endTime = RGAMNNR_EventEndTime26;
		String descriptionBox = RGAMNNR_EventDescription26;

		String updatedRelatedTo = RGAMNNR_RelatedTo27;
		String[][] task1UpdateBasicSection = { { "Related_To", updatedRelatedTo } };
		String[][] task1UpdateAdvancedSection = null;
		String[] updatedSuggestedTags = null;
		String contactRecordName = RGAMNNR_Contact3;

		String accountRecordName = RGAMNNR_FirmLegalName8;
		String accountRecordType = RGAMNNR_FirmRecordType8;

		/*
		 * String eventTitles[] =
		 * "Relive salesforce Live 1<break>Relive salesforce Live 2<break>Relive salesforce Live 3<break>Relive salesforce Live 4"
		 * .split("<break>", -1); String eventAttendees =
		 * "dealroom1.3+con1@gmail.com,dealroom1.3+con2@gmail.com" + "," +
		 * crmUser1EmailID + ";"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String startTime = "10:00 PM"; String endTime = "10:00 PM"; String
		 * descriptionBox = "";
		 * 
		 * String updatedRelatedTo = "Acc 11"; String[][] task1UpdateBasicSection = { {
		 * "Related_To", updatedRelatedTo } }; String[][] task1UpdateAdvancedSection =
		 * null; String[] updatedSuggestedTags = null; String contactRecordName =
		 * "Con 1";
		 * 
		 * String accountRecordName = "Acc 11"; String accountRecordType = "Company";
		 * 
		 */
		lp.CRMLogin(crmUser1EmailID, "navatar123");
	...
	public void rgAcuityMNNRTc021_VerifyTheNotificationPopUpWhenAttendeeNameIsModifiedAfterCreatingTheEvent(
		...
		String eventTitle = RGAMNNR_Subject28;
		String eventAttendees = RGAMNNR_RelatedTo28 + "," + crmUser2EmailID + "," + crmUser3EmailID + ";";
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);

		String startTime = RGAMNNR_EventStartTime28;
		String endTime = RGAMNNR_EventEndTime28;
		String descriptionBox = RGAMNNR_EventDescription28;
		String contactRecordName = RGAMNNR_Contact4;

		String user2firstName = crmUser2FirstName;
		String User2LastName = crmUser2LastName + RGAMNNR_ActivityType28;
		...
		user2FullName = user2FullName + RGAMNNR_ActivityType28;
		 ...
		 * String eventAttendees =
		 * "Dealroom1.3+Lomez@gmail.com,Dealroom1.3+Max@gmail.com,Dealroom1.3+James@gmail.com"
		 * + "," + crmUser2EmailID + "," + crmUser3EmailID + ";"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -2); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", -1);
		 * 
		 * String startTime = "6:00 PM"; String endTime = "6:30 PM"; String
		 * descriptionBox = "Revenue Grid Event"; String contactRecordName = "Max";
		 * 
		 * String user2firstName = crmUser2FirstName; String User2LastName =
		 * crmUser2LastName + "updated";
		 * 
		 * String user2FullName; if (!crmUser2FirstName.equals("") &&
		 * !crmUser2LastName.equals("")) { user2FullName = crmUser2FirstName + " " +
		 * crmUser2LastName; } else { user2FullName = crmUser2LastName;
		 ...
		 * }
		 * 
		 * user2FullName = user2FullName + "updated"; String user2EmailId =
		 * crmUser2EmailID;
		 * 
		 * String RelatedToVerifyInNotes = user2FullName; String[][]
		 * event1BasicSectionVerificationInNotesPopup = { { "Related_To",
		 * RelatedToVerifyInNotes } }; String[][]
		 * event1AdvancedSectionVerificationInNotesPopup = null;
		 */
	...
	public void rgAcuityMNNRTc022_EditEventAndAddNotesWithAlreadyTaggedContactFirmThenSuggestedPopUpNotCome(
		...
		String eventTitleExisting = RGAMNNR_Subject29;

		String updatedNotes = RGAMNNR_Notes30;
		String[][] event1UpdateBasicSection = { { "Notes", updatedNotes } };
		String[][] event1UpdateAdvancedSection = null;
		String[] updatedSuggestedTags = RGAMNNR_SuggestedTag30.split("<break>", -1);
		 ...
		 * 
		 * String updatedNotes = "Acc 11, Con 1, con 2"; String[][]
		 * event1UpdateBasicSection = { { "Notes", updatedNotes } }; String[][]
		 * event1UpdateAdvancedSection = null; String[] updatedSuggestedTags =
		 * "SuggestedPopUpShouldNotThere".split("<break>", -1);
		 * 
		 * String accountRecordName = "Acc 11"; String accountRecordType = "Company";
		 * 
		 */
				...
				if (BP.clicktabOnPage("Acuity")) {
					...
					if (BP.clickOnSubjectOfInteractionEitherOnCardOrInViewAllPopUp(eventTitleExisting)) {
						...
						if (click(driver, taskBP.editButtonInEventDetailPage(20), "Edit Button",
							...
							if (interactionResult.isEmpty()) {
								log(LogStatus.PASS,
										"------" + eventTitleExisting + " record has been verified on intraction------",
										YesNo.No);

							} else {
								log(LogStatus.ERROR,
										"------" + eventTitleExisting
												+ " record is not verified on intraction, Reason: " + interactionResult
												+ "------",
										YesNo.No);
								sa.assertTrue(false,
										"------" + eventTitleExisting
							...
							if (notificationNegativeResult.isEmpty()) {
								log(LogStatus.INFO, "Verified Notification not contains for Event(s): "
										+ eventTitleExisting + " in case of User 1 in Detail Page" + accountRecordName,
										YesNo.No);
	...
	public void rgAcuityMNNRTc023_CreateAllDayEventAndVerifyTheNotification(String projectName) {
		...
		String eventTitle = RGAMNNR_Subject31;
		String eventAttendees = RGAMNNR_RelatedTo31 + "," + crmUser3EmailID + ";";
		...
		String startTime = "";
		String endTime = "";
		String descriptionBox = RGAMNNR_EventDescription31;
		String contactRecordName = RGAMNNR_Contact9;
		...
		String[] labelAndValueSeprateByBreak = { "Subject" + "<break>" + eventTitle, "Start" + "<break>" + startDate,
				...
				"Name" + "<break>" + RGAMNNR_DetailPageRecord1 };

		/*
		 * String eventTitle = "Webinar 1 all day"; String eventAttendees =
		 * "Dealroom1.3+James@gmail.com,Dealroom1.3+Lenis@gmail.com" + "," +
		 * crmUser3EmailID + ";"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);
		 * 
		 * String startTime = ""; String endTime = ""; String descriptionBox =
		 * "Revenue Grid Event"; String contactRecordName = "Lenis";
		 * 
		 * String user3FullName; if (!crmUser3FirstName.equals("") &&
		 * !crmUser3LastName.equals("")) { user3FullName = crmUser3FirstName + " " +
		 * crmUser3LastName; } else { user3FullName = crmUser3LastName;
		 * 
		 * } String[] labelAndValueSeprateByBreak = { "Subject" + "<break>" +
		 * eventTitle, "Start" + "<break>" + startDate, "End" + "<break>" + endDate,
		 * "Description" + "<break>" + "",
		 * 
		 * "Name" + "<break>" + "James" };
		 */
	...
	public void rgAcuityMNNRTc024_CreateEventAndVerifyTheImpactOnSalesforceWhenSubjectEventStartAndEndDateTimeLocationAndDescriptionOfTheEventIsUpdatedInOutlook(
		...
		String eventTitle = RGAMNNR_Subject32;
		String eventAttendees = RGAMNNR_RelatedTo32 + "," + crmUser1EmailID + "," + crmUser2EmailID + ";";
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 1);
		...
		String startTime = RGAMNNR_EventStartTime32;
		String endTime = RGAMNNR_EventEndTime32;
		String descriptionBox = RGAMNNR_EventDescription32;

		String updatedEventName = RGAMNNR_Subject33;
		String updatedEventAttendees = RGAMNNR_RelatedTo33;
		...
		String updatedStartTime = RGAMNNR_EventStartTime33;
		String updatedEndTime = RGAMNNR_EventEndTime33;
		String updatedDescriptionBox = RGAMNNR_EventDescription33;
		boolean updatedAllDayToggle = false;
		String updatedEventAttendeesToRemove = null;

		String recordName = RGAMNNR_Contact2;
		...
		String[] labelAndValueSeprateByBreak = { "Subject" + "<break>" + updatedEventName,
				...
				"Description" + "<break>" + "", "Related Associations" + "<break>" + RGAMNNR_DetailPageRecord2,
				"Related Contacts" + "<break>" + RGAMNNR_DetailPageRecord3 };

		/*
		 * String eventTitle = "Salesforce Event"; String eventAttendees =
		 * "Dealroom1.3+Litz@gmail.com,Dealroom1.3+Jhon@gmail.com" + "," +
		 * crmUser1EmailID + "," + crmUser2EmailID + ";"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 1);
		 * String endDateInAnotherForm1 = endDate; String endDateInAnotherForm2 =
		 * CommonLib.convertDateFromOneFormatToAnother(endDate, "M/d/yyyy",
		 * "MMMM yyyy");
		 * 
		 * String startTime = "2:00 PM"; String endTime = "9:00 PM"; String
		 * descriptionBox = "Revenue Grid Event";
		 * 
		 * String updatedEventName = "Salesforce Event Updated"; String
		 * updatedEventAttendees = "Dealroom1.3+James@gmail.com;"; String
		 * updatedStartDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30",
		 * "M/d/yyyy", 1); String updatedEndDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 1); String
		 * updatedStartTime = "8:00 AM"; String updatedEndTime = "10:00 AM"; String
		 * updatedDescriptionBox = ""; boolean updatedAllDayToggle = false; String
		 * updatedEventAttendeesToRemove = null;
		 * 
		 ...
		 * 
		 * } String[] labelAndValueSeprateByBreak = { "Subject" + "<break>" +
		 * updatedEventName, "Start" + "<break>" + updatedStartDate, "End" + "<break>" +
		 * updatedEndDate, "Description" + "<break>" + "", "Related Associations" +
		 * "<break>" + "Sumo Logic, Vertica, Demo Deal", "Related Contacts" + "<break>"
		 * + "James, Jhon, Litz" };
		 * 
		 * 
		 */
	...
	public void rgAcuityMNNRTc025_VerifyWhenPrivateEventIsCreatedInOutllookHavingOrganizerAsInvitee(
		...
		String eventTitle = RGAMNNR_Subject34;
		String eventAttendees = crmUser1EmailID + ";";
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);

		String startTime = RGAMNNR_EventStartTime34;
		String endTime = RGAMNNR_EventEndTime34;
		String descriptionBox = RGAMNNR_EventDescription34;

		/*
		 * String eventTitle = "Outlook Private Event"; String eventAttendees =
		 * crmUser1EmailID + ";"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);
		 * 
		 * String startTime = "8:00 AM"; String endTime = "9:00 AM"; String
		 * descriptionBox = "Revenue Grid Event";
		 * 
		 */
	...
	public void rgAcuityMNNRTc026_VerifyWhenEventIsCreatedInOutlookByTaggingTheContactsAndAccountNotCreatedInSalesforce(
		...
		String eventTitle = RGAMNNR_Subject35;
		String eventAttendees = crmUser1EmailID + "," + crmUser2EmailID + "," + RGAMNNR_RelatedTo35;
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);

		String startTime = RGAMNNR_EventStartTime35;
		String endTime = RGAMNNR_EventEndTime35;
		String descriptionBox = RGAMNNR_EventDescription35;
		String contact1 = RGAMNNR_Contact10;
		String account1 = RGAMNNR_FirmLegalName9;
		String[] labelAndValueSeprateByBreak1 = { "Name" + "<break>" + contact1, "Legal Name" + "<break>" + account1,
				"Email" + "<break>" + RGAMNNR_DetailPageRecord4 };

		String contact2 = RGAMNNR_Contact11;
		String account2 = RGAMNNR_FirmLegalName10;
		String[] labelAndValueSeprateByBreak2 = { "Name" + "<break>" + contact2, "Legal Name" + "<break>" + account2,
				"Email" + "<break>" + RGAMNNR_DetailPageRecord5 };
		...
		/*
		 * String eventTitle = "Outlook Event Test"; String eventAttendees =
		 * crmUser1EmailID + "," + crmUser2EmailID + "," +
		 * "cont1.test@zxc.com,cont2+test@zxc.com;"; String startDate =
		 * CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0); String
		 * endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);
		 * 
		 * String startTime = "8:00 AM"; String endTime = "9:00 AM"; String
		 * descriptionBox = "Added the event in outlook to tag users and Contacts Con1";
		 * String contact1 = "cont1 test"; String account1 = "zxc.com"; String[]
		 * labelAndValueSeprateByBreak1 = { "Name" + "<break>" + contact1, "Legal Name"
		 * + "<break>" + account1, "Email" + "<break>" + "cont1.test@zxc.com" };
		 * 
		 * String contact2 = "cont2+test"; String account2 = "zxc.com"; String[]
		 * labelAndValueSeprateByBreak2 = { "Name" + "<break>" + contact2, "Legal Name"
		 * + "<break>" + account2, "Email" + "<break>" + "cont2+test@zxc.com" };
		 * 
		 * String user1FullName; if (!crmUser1FirstName.equals("") &&
		 * !crmUser1LastName.equals("")) { user1FullName = crmUser1FirstName + " " +
		 * crmUser1LastName; } else { user1FullName = crmUser1LastName;
		 ...
		 * }
		 * 
		 * String[] labelAndValueSeprateByBreakInCaseOfEvent = { "Assigned To" +
		 * "<break>" + user1FullName, "Subject" + "<break>" + eventTitle, "Name" +
		 * "<break>" + contact1 };
		 * 
		 * 
		 */
	...
	public void rgAcuityMNNRTc027_VerifyWhenEventIsCreatedInOutlookByTaggingTheContactsAndAccountWhereInOnlyAccountIsCreatedInSalesforceContact(
		...
		String eventTitle = RGAMNNR_Subject36;
		String eventAttendees = crmUser1EmailID + "," + crmUser2EmailID + "," + RGAMNNR_RelatedTo36;
		String startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);
		String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);

		String startTime = RGAMNNR_EventStartTime36;
		String endTime = RGAMNNR_EventEndTime36;
		String descriptionBox = RGAMNNR_EventDescription36;
		String contact1 = RGAMNNR_Contact12;
		String account1 = RGAMNNR_FirmLegalName11;
		String[] labelAndValueSeprateByBreak1 = { "Name" + "<break>" + contact1, "Legal Name" + "<break>" + account1,
				"Email" + "<break>" + RGAMNNR_DetailPageRecord6 };

		String contact2 = RGAMNNR_Contact13;
		String account2 = RGAMNNR_FirmLegalName12;
		String[] labelAndValueSeprateByBreak2 = { "Name" + "<break>" + contact2, "Legal Name" + "<break>" + account2,
				"Email" + "<break>" + RGAMNNR_DetailPageRecord7 };
		String user1FullName;
		if (!crmUser1FirstName.equals("") && !crmUser1LastName.equals("")) {
			user1FullName = crmUser1FirstName + " " + crmUser1LastName;
		} else {
		 ...
		 * crmUser1EmailID + "," + crmUser2EmailID + "," +
		 * "cont3.test@carlylegroup-ng.com,cont4+test@carlylegroup-ng.com;"; String
		 * startDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy", 0);
		 * String endDate = CommonLib.getFutureDateAccToTimeZone("GMT+5:30", "M/d/yyyy",
		 * 0);
		 * 
		 * String startTime = "8:00 AM"; String endTime = "9:00 AM"; String
		 * descriptionBox = "Added the event in outlook to tag users and Contacts Con1";
		 * String contact1 = "cont3 test"; String account1 = "carlylegroup-ng.com";
		 * String[] labelAndValueSeprateByBreak1 = { "Name" + "<break>" + contact1,
		 * "Legal Name" + "<break>" + account1, "Email" + "<break>" +
		 * "cont3.test@carlylegroup-ng.com" };
		 * 
		 * String contact2 = "cont4+test"; String account2 = "carlylegroup-ng.com";
		 * String[] labelAndValueSeprateByBreak2 = { "Name" + "<break>" + contact2,
		 * "Legal Name" + "<break>" + account2, "Email" + "<break>" +
		 * "cont4+test@carlylegroup-ng.com" }; String user1FullName; if
		 * (!crmUser1FirstName.equals("") && !crmUser1LastName.equals("")) {
		 * user1FullName = crmUser1FirstName + " " + crmUser1LastName; } else {
		 * user1FullName = crmUser1LastName;
		 * 
		 * }
		 * 
		 * String[] labelAndValueSeprateByBreakInCaseOfEvent = { "Assigned To" +
		 * "<break>" + user1FullName, "Subject" + "<break>" + eventTitle, "Name" +
		 * "<break>" + contact1, "Related Associations" + "<break>" +
		 * "Assign Multiple Associations" };
		 * 
		 */
