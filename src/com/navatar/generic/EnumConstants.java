...
public class EnumConstants {
	...
	public static enum excelLabel {
		...
		UpdatedFileStandard, TestCases_Name, Alert_Count, AllDocument_Count, Folder_Template_Name, Fund_Contact,
		Fund_Phone, Fund_Email, Firm_Description, ContactNew_fName, ContactNew_lName, Contact_Title, Contact_Phone,
		Facebook, Mailing_Street, Linkedin, Institution_Type_MyProfile, Industry_Dropdown_myprofile, FundType_myprofile,
		IndustrySelectBox_myprofile, Investment_Category, GeoFocus_myprofile, Firm_Description_Firmprofile,
		Billing_street_Firmprofile, Billing_city_firmprofile, Billing_state_firmprofile, Billing_country_firmprofile,
		Industries_selectbox, FundType_selectbox, Geofocus_selectbox, Industry_dropdown, InstType_dropdown,
		Min_investment, Max_investment, AUM, Contact_updated_firmname, Folder_Description, Fund_Size, Fund_VintageYear,
		Fund_Description, Disclaimer_Name, Disclaimer_Description, StandardPath, CommonPath, SharedPath, InternalPath,
		MyProfile_FName, MyProfile_LName, Updated_FirmName, Updated_FirstName, Updated_LastName, Title, Business_Phone,
		Mailing_City, Mailing_State, Mailing_Zip, Mailing_Country, Firm_Contact, KeyWord_For_Search, AllFirms_Count,
		OnlineImportPath, AdvisorInvolvementID, FOLDER_NAME, INVALID_FOLDER_NAME, TargetRegistrationURL, TargetLoginURL,
		Watermarking, UpdateInstitution_NameFormManageInvestor, UpdatedLimitedPartner_NameFormManageInvestor,
		HomePageAlertCount, FundsPageALertCount, ContactPageALertCount, BillingZip, UpdateFund_NameFromUpdateInfoIWR,
		UpdateFund_NameFromUpdateInfoFR, ContactName, FundName, Module_Name, Execute, Statistics, FRW_Value, INV_Value,
		FRW_DocumentsName, INV_DocumentsName, Updated_InstitutionName_From_InvestorSide, Activity_Count,
		Viewed_Or_DownloadedAnyFile, Account_Name, Logo_Name, Contact_Access, ContactUpdatedEmailID, Path, DrawdownID,
		CapitalCalllID, CapitalAmount, ManagementFee, OtherFee, InvestmentAmount, CallAmount, CallDate, DueDate,
		CallAmountReceived, ReceivedDate, AmountDue, CapitalReturn, Dividends, RealizedGain, OtherProceeds,
		TotalDistributions, FundDistributionID, InvestorDistributionID, Capital_Returned_Recallable,
		Capital_Returned_NonRecallable, Start_Time, End_Time, Test_Custom_Object_Name, Average_Deal_Quality_Score,
		Total_Deals_Shown, Deal_Quality_Score, Meeting_Type, User_Title, Theme_Name, Item_ID {
			@Override
		...
		, Stage, Source, Source_Firm, Source_Contact 
	, Deal_Type, Employees, Website, Email, Legal_Name,Target_Close_Date, Name, Investment_Size,Updated_Investment_Size, Log_In_Date{
		...
		Our_Role, Last_Name, Last_Stage_Change_Date_New, Last_Stage_Change_Date, Highest_Stage_Reached,
		Age_of_Current_Stage, Date_Stage_Changed, Changed_Stage, Age, First_Stage_Changed, Second_Stage_Changed,
		Office_Location_Name, State_Province, ZIP, Organization_Name, Primary, Updated_Primary, Start, Related_To,
		Due_Date, Investment_Likely_Amount, Closing, Total_Fundraising_Contacts, Fundraising_Contact_ID, Fundraising,
		Role, Other_Address, Label, Mailing_Address, Total_Commitments, Commitment_Amount, Partner_Type, Tax_Forms,
		Final_Commitment_Date, Company, Bank_Name, Placement_Fee, Fund_Investment_Category,
		Total_CoInvestment_Commitments, Total_Fund_Commitments, Institution_Type, Fund_Preferences,
		Industry_Preferences, Shipping_Street, Shipping_City, Shipping_State, Shipping_Zip, Shipping_Country,
		Mobile_Phone, Assistant, Asst_Phone, Phone, Total_Call_Amount_Received, Total_Amount_Called,
		Total_Amount_Received, Total_Uncalled_Amount, Total_Commitment_Due, Commitment_Called, Called_Due,
		Preferred_Mode_of_Contact, Percent, Contact_Tier, Pipeline_Comments, Parent_Field_Name, Override_Label, APIName,
		FieldOrder, URL, Region, Industry, Attendee_Staff, Marketing_Event, Notes, DTID, Member, File, EffectiveDate,
		ReceiptDate, SDG_Row_Number, My_Records, Global_Filter_Query, Field_Data_SDG, Filter_Search, Filter_PickList,
		Filter_Label, SDG_Misc, Highlighted_Colors, Highlighted_Colors_RGB, Referenced_Component_Heading,
		Introduction_Date, TotalCommitment, Priority, Project_Type, Project_Name, Task_Name, Status,
		Fund_InvestmentCategory, FundInvestmentID, Comment, Updated_Priority, Updated_Subject, Updated_Comment,
		Updated_Stage, Start_Date, End_Date, Data_Type, Field_Label, Length, Decimal_Places, Options, Deal_Name,
		DealTeamID, FinancingId, SDG_Name, sObjectName, SDG_Tag, Object_Name, Field_Set_Label, NameSpace_PreFix,
		Page_Layout, Fields_Name, Toggle_Button, Request, Date_Requested, Request_Tracker_ID, Marketing_Event_Name,
		Date, TabName, Item, Filter_Value, Select_List_Item, RelatedTab, ToggleButton, Column_Name1, Column_Name2,
		Field_Type, FieldLabel_SubString, ExtraFieldsName, Column_Name, Navigation_Label_Name, Redirection_Label_Name,
		Update_Navigation_Label_Name, Updated_Order, Parent_Institution, Entity_Type, Parent,
		Navigation_Label_With_Parent, List_View_Object, List_View_Name, Action_Object, Coverage_Name, Action_Order,
		Event, Event_Payload, Action_Type, Sector, Assigned_To, Location, Event_PayLoad, Institution, Firm, Contact,
		Type_Of_Debt, Amount, Frequency, Fiscal_Year_end, Marketing_Initiative, Client, Advisor, List_Accessibility,
		Field, Operators, Filter, Fundraising_Stage, Count_as_per_fundraising_stage, Fundraising_Count, Partnership,
		SDG_Data_Count, AppPage_Name, SDG_TableName, SDG_DataProviderName
		...
		Connection_TeamMember, Connection_Title, Connection_Deal, Connection_MeetingsAndCall, Connection_Email, Value,
		FieldName, New_Value, Highlighted_Firm, CC, linkedRecord, Repeat, To, Advance_End_Time, Advance_Start_Time,
	...
	public static enum FolderType {
		Common, Shared, Internal, Standard, Global;
	}

	public static enum MetaDataSetting {
		Acuity_Setting, RG_Setting, Nintex_Report, Org_Setting, SDGDefault;
	}
	...
	public static enum WorkSpaceAction {
		CREATEFOLDERTEMPLATE, IMPORTFOLDERTEMPLATE, WITHOUTEMPLATE, WITHTARGET, WITHOUTTARGET, ACTIVE, INACTIVE, UPDATE,
		CHECKERRORMSG, UPLOAD;
	}
	...
	public static enum ContentGridArrowKeyFunctions {
		Update, Delete, ManageVersions, Open;
	}
	...
	public static enum TabName {
		...
		FolderTemplate, FundDistributions, FundOfFundsTransactions, OfficeLocations, InvestorDistributions,
		MarketingInitiatives, MarketingProspects, Affiliations, AgreementsAmendments {
			@Override
			public String toString() {
	...
	public static enum PageName {
		...
		BuildStep2Of3, PipelinesPage, NewTaskPage, CRMUserPage, TaskPage, NewTaskPopUP, TestCustomObjectPage,
		ContactPage, NewEventPopUp, ActivitiesOrMeetings, SearchActivitiesAttachment, EmailUploadPage, Object1Page,
		Object1PagePopup, Object2Page, Object3Page, Object4Page, Financing, ListEmail, CompactLayout, MeetingType,
		AddPickListMeetingType, ActivityLayoutPage, SDGPage, Object5Page, AccountCustomFieldStatusPage,
		MEPageFromCalender, SharingSettingsPage, DashboardDeadDeals, AccountReferral, VisualForcePage, WarningPopUp,
		RecordTypePortfolioCompany, CustomNavigationPage, NavigationPickListPage, CallPopUp, MeetingPopUp,
		ConvertToPortfolioFrame, TaskPopUp, GlobalActtion_TaskPOpUp, AffiliationPage, Fundraising_ContactPage,
		Financial_Performance, Marketing_Initiative, FundDrawdown, Marketing_Prospect, Advisor, MarketingInitiatives,
		emailFundraisingContact, emailProspects, pastFundraisingAccountPopUp, EmailTargets, pastFundraisingContactPopUp,
		Send_Distribution_Notices, ManageTarget, ContactsPage, BulkEmail, emailCapitalCallNotice, BulkDownload,
		CapitalCall, FundDistribution, InvestorDistribution, AcuityDetails, Interaction, Deal_Team, ThemesPage,
		ClipsPage;
	...
	public static enum NavatarSetupSideMenuTab {
		DealCreation, IndividualInvestorCreation, CommitmentCreation, ContactTransfer, AccountAssociations,
		OfficeLocations, CoInvestmentSettings, PipelineStageLog, BulkEmail
	}
...
//*************************************************************** Pages Field Labels*********************************************//
	public static enum InstitutionPageFieldLabelText {
		Street, Referral_Source_Description, Legal_Name, Description, Phone, Shipping_State {
			@Override
			public String toString() {
	...
	public static enum LimitedPartnerPageFieldLabelText {
		Street, Referral_Source_Description, Legal_Name, Description, Total_CoInvestment_Commitments {
			@Override
			public String toString() {
	...
	public static enum ContactPageFieldLabelText {
		Legal_Name, Description, Mailing_Street, Other_Street, Candidate_Notes, First_Name, Last_Name,
		Contact_Referral_Source, Mobile, Mailing_State {
			@Override
			public String toString() {
	...
	public static enum CapitalCallPageFieldLabelText {
		CC_No, Fund_Drawdown, Commitment, Capital_Amount, Management_Fee, Other_Fee, Call_Amount, Call_Date, Due_Date,
		Call_Amount_Received, Received_Date, Amount_Due, Commitment_Called, Called_Due, Total_Commitment_Due
	}

	public static enum FundDrawdownPageFieldLabelText {
		DD_No, Fund_Name, Call_Amount, Call_Date, Due_Date, Amount_Due, Total_Call_Amount_Received, Capital_Amount,
		Management_Fee, Other_Fee
	}

	public static enum InvestorDistributionPageFieldLabelText {
		ID_No, Fund_Distribution, Commitment, Capital_Return, Dividends, Realized_Gain, Other_Proceeds,
		Total_Distributions, Capital_Recallable, Distribution_Date;
	}

	public static enum CommitmentPageFieldLabelText {
		Commitment_ID, Partner_Type, Limited_Partner, Final_Commitment_Date, Tax_Forms, Commitment_Amount,
		Total_Amount_Called, Total_Amount_Received, Total_Uncalled_Amount, Total_Commitment_Due, Partnership,
		Commitment_Called {
			@Override
			public String toString() {
	...
	public static enum FundPageFieldLabelText {
		Fund_Name, Fund_Type, Investment_Category, Vintage_Year, Frist_Closing_Date {
			@Override
			public String toString() {
				return "1st Closing Date";
			}
		...
		Final_Closing_Date, Termination_Date, Dissolution_Date, Step_Down_Date, Investment_Period_End_Date,
		Target_Commitments {
			@Override
			public String toString() {
	...
	public static enum SDGLabels {
		APIName, Override_Label, FieldOrder, Parent_Field_Name, URL, Actions, Name, Event, Action_Order, Event_Payload,
		Action_Type;
	}
	...
	public static enum ReportField {
		...
		Email, Phone, Contact_Full_Name, Fundraising_Name {
			@Override
			public String toString() {
	...
	public static enum NavatarSetupSideMenuTabLayoutSection {
		...
		CommitmentCreation_FundRaisingInformation, CommitmentCreation_AdditionalInformation,
		CommitmentCreation_FieldsForNewLimitedPartner, CommitmentCreation_FieldsForNewPartnership,
		CommitmentCreation_GeneralInformation, CommitmentCreation_CommitmentInformation, Contact_Information,
		Address_Information, Additional_Information;
	}
	...
	public static enum RelatedList {
		...
		Office_Locations, Open_Activities, Affiliations, Contacts, Activities, Activity_History, Commitments,
		Partnerships, Fundraisings, FundDistribution {
			@Override
			public String toString() {
	...
	public static enum DataLoader {
		Institutions, Contacts, Funds, Fundraisings, Commitments, Partnerships, Advisor, CorrespondanceList, Pipeline,
		MarketingInitiative, MarketingProspect, FundraisingContact;
	}
	...
	public static enum IndiviualInvestorFieldLabel{
		...
		Mailing_Country, Other_Street, Other_City, Other_Country, Fund_Preferences, Industry_Preferences, Website,
	...
	public static enum ActivityTimeLineItem {
		...
		Add, Log_a_Call_with_Multiple_Associations, New_Event, New_Task_with_Multiple_Associations, Expand_All, Refresh,
		Collapse_All, Filter, New_Task;
	}
	...
	public static enum ActivityPopupFields {
		Company_Name, Active, Institution_Owner, Legal_Name, Account_Name, Primary_Coverage_Officer, Email, Website,
		Title, Phone, Type, Firm, Entity_Owner;
	};
	...
	public static enum SDGCreationLabel {
		SDG_Name, SDG_Tag, sObjectName, Parent_Field_Name, Filter, Image_Field_API, Default_Sort {
			@Override
			public String toString() {
				return "Default Sort";
			}
	...
	public static enum ObjectName {
		...
		Funds, Fundraisings, Partnerships, Navigation, Fund_Team {
			@Override
			public String toString() {
				return "Fund Team";
			}
	...
	public static enum CSVLabel {
		...
		Activities_Button_API_Name, Navigation_Type;
	}
	...
	public static enum EditPageLabel {
		...
		Title_Highlight_Color, Filter, Onclick_Title, Calendar_Filter_1, Calendar_Filter_2, Calendar_Filter_3, Deal,
		Name, Fundraising, Phone, Stage, Source_Firm {
			@Override
			public String toString() {
				return "Source Firm";
			}
