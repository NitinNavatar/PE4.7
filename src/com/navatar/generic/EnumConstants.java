...
CompactLayout, MeetingType, AddPickListMeetingType,ActivityLayoutPage, SDGPage,Object5Page,AccountCustomFieldStatusPage,MEPageFromCalender,SharingSettingsPage,DashboardDeadDeals,AccountReferral,VisualForcePage, WarningPopUp, RecordTypePortfolioCompany,CustomNavigationPage,NavigationPickListPage,CallPopUp,MeetingPopUp,ConvertToPortfolioFrame,TaskPopUp,GlobalActtion_TaskPOpUp;
...
//*************************************************************** Pages Field Labels*********************************************//
	...
	public static enum ShowMoreActionDropDownList{
		 New_Task,New_Call,Edit, Delete, New_Meeting,LogCaLLWithMultiple{
			...
			}, Contact_Transfer,Change_Date,Change_Record_Type,Change_Priority,Change_Status,Edit_Comments,New_Attendee,New,New_Affiliation,New_Referral,New_Client,New_Financing,New_Contact
	...
	public static enum RelatedTab{
		Related,Details,Network,Tasks,Meetings,Activities,Documents,Box,Referrals,Clients,KPIs,Investment,Contacts,Financing,Consultants,Fundraising,Investors,
